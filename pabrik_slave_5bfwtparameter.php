...
switch ($method) {
    ...
    case 'insert':
        $str = "insert into " . $dbname . ".pabrik_5bfwtparameter (parameter,nama,updateby)
    ...
    case 'update':
        $str = "update " . $dbname . ".pabrik_5bfwtparameter set updateby='" . $_SESSION['standard']['userid'] . "',
    ...
    case'loadData':
        ...
        $ql2 = "select count(*) as jmlhrow from " . $dbname . ".pabrik_5bfwtparameter"; // echo $ql2;notran
		...
		//  limit " . $offset . "," . $limit . "
        $i = "select * from " . $dbname . ".pabrik_5bfwtparameter";
