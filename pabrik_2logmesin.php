...
require_once('master_mainMenu.php');
  ...
  OPEN_BOX('','<span class=judul>'.getMenu('pabrik_2logmesin').'</span><br>');
...
echo"<fieldset style='float:left;'>
        <legend>Data</legend>
            <table border=0 cellpadding=1 cellspacing=1>
                ...
                <tr>
                    <td><td><td>
                    <button onclick=zPreview('pabrik_slave_2logmesin','".$arr."','printContainer') class=mybutton name=preview id=preview>".$_SESSION['lang']['preview']."</button>
                    <button onclick=zExcel(event,'pabrik_slave_2logmesin.php','".$arr."') class=mybutton name=preview id=preview>".$_SESSION['lang']['excel']."</button>
                    </td>
                </tr>
            </table>
</fieldset>";
        ...
        <legend>Rekap</legend>
            <table border=0 cellpadding=1 cellspacing=1>
                <tr>
                    <td>".$_SESSION['lang']['unit']."</td>
                    <td>:</td>
                    <td><select id=unitoee style=\"width:150px;\">".$optOrg."</select></td>
                </tr>
                <tr>
                    <td>".$_SESSION['lang']['tanggal']."</td>
                    <td>:</td>
                    <td>
						<input type=text readonly class='myinputtext' id='tgloee' onmousemove='setCalendar(this.id)' onkeypress='return false;'  size='12' maxlength='10' />	
					</td>	
                </tr>
                <tr>
                    <td><td><td>
                    <button onclick=zPreview('pabrik_slave_2logmesin_oee','".$arr."','printContainer') class=mybutton name=preview id=preview>".$_SESSION['lang']['preview']."</button>
                    <button onclick=zExcel(event,'pabrik_slave_2logmesin_oee.php','".$arr."') class=mybutton name=preview id=preview>".$_SESSION['lang']['excel']."</button>
                    </td>
                </tr>
            </table>
</fieldset>";
