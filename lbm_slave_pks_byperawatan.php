...
$q_birealtbs=$owlPDO->query($s_birealtbs) or die(print " Gagal: ".PDOException::getMessage());
$q_birealtbs->setFetchMode(PDO::FETCH_ASSOC);
while($r_birealtbs=$q_birealtbs->fetch())
{
...
$q_bibudtbs=$owlPDO->query($s_bibudtbs) or die(print " Gagal: ".PDOException::getMessage());
$q_bibudtbs->setFetchMode(PDO::FETCH_ASSOC);
while($r_bibudtbs=$q_bibudtbs->fetch())
{
...
$q_sdbirealtbs=$owlPDO->query($s_sdbirealtbs) or die(print " Gagal: ".PDOException::getMessage());
$q_sdbirealtbs->setFetchMode(PDO::FETCH_ASSOC);
while($r_sdbirealtbs=$q_sdbirealtbs->fetch())
{
...
$s_sdbibudtbs="select sum(".$field5.") as budgettbs from ".$dbname.".bgt_produksi_pks_vw
               where millcode='".$kdOrg."' and tahunbudget='".substr($periode,0,4)."' ";
$q_sdbibudtbs=$owlPDO->query($s_sdbibudtbs) or die(print " Gagal: ".PDOException::getMessage());
$q_sdbibudtbs->setFetchMode(PDO::FETCH_ASSOC);
while($r_sdbibudtbs=$q_sdbibudtbs->fetch())
{
...
$s_birealcpo="select sum(oer) as realcpo from ".$dbname.".pabrik_produksi
       where kodeorg='".$kdOrg."' and tanggal like '".$periode."%' ";
$q_birealcpo=$owlPDO->query($s_birealcpo) or die(print " Gagal: ".PDOException::getMessage());
$q_birealcpo->setFetchMode(PDO::FETCH_ASSOC);
while($r_birealcpo=$q_birealcpo->fetch())
{
...
$s_bibudcpo="select sum(kgcpo".$bulan.") as budgetcpo from ".$dbname.".bgt_produksi_pks_vw
             where millcode='".$kdOrg."' and tahunbudget='".substr($periode,0,4)."' ";
$q_bibudcpo=$owlPDO->query($s_bibudcpo) or die(print " Gagal: ".PDOException::getMessage());
$q_bibudcpo->setFetchMode(PDO::FETCH_ASSOC);
while($r_bibudcpo=$q_bibudcpo->fetch())
{
...
$q_sdbirealcpo=$owlPDO->query($s_sdbirealcpo) or die(print " Gagal: ".PDOException::getMessage());
$q_sdbirealcpo->setFetchMode(PDO::FETCH_ASSOC);
while($r_sdbirealcpo=$q_sdbirealcpo->fetch())
{
...
$q_sdbibudcpo=$owlPDO->query($s_sdbibudcpo) or die(print " Gagal: ".PDOException::getMessage());
$q_sdbibudcpo->setFetchMode(PDO::FETCH_ASSOC);
while($r_sdbibudcpo=$q_sdbibudcpo->fetch())
{
...
$q_station=$owlPDO->query($s_station) or die(print " Gagal: ".PDOException::getMessage());
$q_station->setFetchMode(PDO::FETCH_ASSOC);
while($r_station=$q_station->fetch())
{
...
$q_realstbi=$owlPDO->query($s_realstbi) or die(print " Gagal: ".PDOException::getMessage());
$q_realstbi->setFetchMode(PDO::FETCH_ASSOC);
while($r_realstbi=$q_realstbi->fetch())
{
...
$q_budstbi=$owlPDO->query($s_budstbi) or die(print " Gagal: ".PDOException::getMessage());
$q_budstbi->setFetchMode(PDO::FETCH_ASSOC);
while($r_budstbi=$q_budstbi->fetch())
{
    $kode[]=$r_budstbi['kode'];
...
$q_realstsdbi=$owlPDO->query($s_realstsdbi) or die(print " Gagal: ".PDOException::getMessage());
$q_realstsdbi->setFetchMode(PDO::FETCH_ASSOC);
while($r_realstsdbi=$q_realstsdbi->fetch())
{
...
$q_budstsdbi=$owlPDO->query($s_budstsdbi) or die(print " Gagal: ".PDOException::getMessage());
$q_budstsdbi->setFetchMode(PDO::FETCH_ASSOC);
while($r_budstsdbi=$q_budstsdbi->fetch())
{
