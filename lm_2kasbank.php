...
?>
<script language=javascript src=js/lm_2kasbank.js?v=<?php echo time(); ?>></script>
<script language="javascript" src="js/zSelect2.js?v=<?php echo time(); ?>"></script>
<?php

include('master_mainMenu.php');
OPEN_BOX('', '<span class=judul>' . getMenu('lm_2kasbank') . '</span><br>');
...
# Option UNIT #
$optunit = $optperiode = $optnoakun = "<option value=''>" . $_SESSION['lang']['pilihdata'] . "</option>";
...
# TIPE LAPORAN #
$arrtipelaporan = array('1' => 'Default', '2' => 'Kebun');
...
<fieldset style="width: 450px;margin-right:25px;float:left;">
    ...
    <table cellspacing="1" border="0">
        ...
        <tr>
            ...
            <td>:</td>
            <td><select class='select2' id=kodeorg style='width:200px;' onchange=getAkun(this.options[this.selectedIndex].value)><?php echo $optunit; ?></select></td>
        </tr>
        <tr>
            <td><label><?php echo $_SESSION['lang']['noakun'] ?> Kas</label></td>
            <td>:</td>
            <td><select class='select2' id=noakun style='width:200px;'><?php echo $optnoakun; ?></select></td>
        </tr>
        <tr>
        ...
        <tr>
            <td><label><?php echo $_SESSION['lang']['tipe'] ?> Laporan</label></td>
            <td>:</td>
            <td><select class='select2' id=tipelaporan style='width:200px;'><?php echo $opttipelaporan; ?></select></td>
        </tr>
        <tr>
            <td>
            <td>
