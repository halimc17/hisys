...
<script language=javascript src="js/kebun_5premikutipbrondolansaja.js?v=<?php echo time(); ?>"></script>
...
OPEN_BOX('','<span class=judul>'.getMenu('kebun_5premikutipbrondolansaja').'</span><br>');
echo"<fieldset>
     <legend style='font-weight:bold'>".$_SESSION['lang']['form']."</legend>
		 ...
		 <table>
			...
			<tr>
				...
				<td>:</td>
                <td><input type='text' id='brondol' class='myinputtextnumber' onkeypress=\"return angka_doang(event);\" maxlength='10' style=width:145px value='0' onkeyup=\"z.numberFormat('basiskg',0);\" />
				</td>
            </tr>
			<!---
			<tr>
		...
		$arr="##afd##tahun##basiskg##brondol##method";
		echo"<button class=mybutton onclick=simpan('kebun_slave_5premikutipbrondolansaja','".$arr."')>".$_SESSION['lang']['save']."</button>
