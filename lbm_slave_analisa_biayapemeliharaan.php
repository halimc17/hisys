...
$qProdReal = $owlPDO->query($sProdReal) or die(print " Gagal: " . PDOException::getMessage());
$qProdReal->setFetchMode(PDO::FETCH_ASSOC);
$rProdReal = $qProdReal->fetch();
...
$qProdReal2 = $owlPDO->query($sProdReal2) or die(print " Gagal: " . PDOException::getMessage());
$qProdReal2->setFetchMode(PDO::FETCH_ASSOC);
$rProdReal2 = $qProdReal2->fetch();
