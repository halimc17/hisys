...
OPEN_BOX('','<span class=judul>'.getMenu('kebun_2perblockmainactivityv2').'</span><br>');
?>
<script language=javascript src=js/zTools.js></script>
<script language=javascript src='js/zReport.js'></script>
<script language=javascript src='js/option.js?v=<?php echo time(); ?>'></script>
<script language=javascript src='js/kebun_2perblockmainactivityv2.js?v=<?php echo time(); ?>'></script>
        ...
        <legend>Form</legend>
            <table border=0 cellpadding=1 cellspacing=1>
				...
				<tr>
                    ...
                    <td>:</td>
                    <td><select class=select2 id=jenis style=\"width:164px;\">" . $optjns . "</select></td>
                </tr>
                ...
                <tr>
                    <td colspan=2></td>
                    <td colspan=4>
                    <button onclick=zPreview('kebun_slave_2perblockmainactivityv2','" . $arr1 . "','printContainer');showdetail(); class=mybutton name=preview id=preview>" . $_SESSION['lang']['preview'] . "</button>
                    <button onclick=zExcel(event,'kebun_slave_2perblockmainactivityv2.php','" . $arr1 . "') class=mybutton name=preview id=preview>" . $_SESSION['lang']['excel'] . "</button>
                    </td>
                </tr>
...
echo"<div id='both_report'>
	...
	<div id='printContainer' style='height:380px'; ></div>
</div>
";
