...
OPEN_BOX('', '<span class=judul>'.getMenu('kebun_2rekappanenvsspb').'</span><br>');
} else {
OPEN_BOX('', '<span class=judul>'.getMenu('kebun_2rekappanenvsspb').'</span><br>');
}
?>
...
function lihatdetail(blok, tgl, tipe,proses, ev) {
	...
	tujuan = 'kebun_slave_2rekappanenvsspb_detail.php' + "?" + param;
	width = '700';
	height = '250';
        ...
        <legend>Form</legend>
            <table border=0 cellpadding=1 cellspacing=1>
                ...
                <tr>
                    <td colspan=2></td>
                    <td colspan=4>
                    <button onclick=zPreview('kebun_slave_2rekappanenvsspb','" . $arr . "','printContainer') class=mybutton name=preview id=preview>" . $_SESSION['lang']['preview'] . "</button>
                    <button onclick=zExcel(event,'kebun_slave_2rekappanenvsspb.php','" . $arr . "') class=mybutton name=preview id=preview>" . $_SESSION['lang']['excel'] . "</button>
                    </td>
                </tr>
            </table>
</fieldset>";
echo"
	...
	<li>SPB  => Kebun - Transaksi - Surat Perintah Buah</li>
