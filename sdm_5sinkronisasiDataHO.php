...
$limit = 0;
$limit = checkPostGet('limit',0);
OPEN_BOX('','<span class=judul>'.strtoupper($_SESSION['lang']['sinkronisasidatapy']).'</span>');
echo"<div>";
...
echo "<input type=checkbox onclick=checkAll(this," . $numrows . ")>" . $_SESSION['lang']['pilihsemua'];
echo " &nbsp &nbsp &nbsp &nbsp &nbsp 
		        <a href='?limit=" . ($limit - 500 > -1 ? $limit - 500 : 0) . "'>" . $_SESSION['lang']['pref'] . "</a> &nbsp <a href='?limit=" . ($limit + 500) . "'>" . $_SESSION['lang']['lanjut'] . "</a>";
