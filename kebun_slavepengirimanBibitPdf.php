...
class PDF extends FPDF {
    ...
    function Header() {
        ...
        $this->Image($path, $this->lMargin, $this->tMargin, 0, 40);
        ...
        $this->Cell($width, $height, strtoupper($_SESSION['lang']['pengirimanBibit']), 0, 1, 'C');
        $this->Ln(35);
    }
...
$pdf->Cell(3 / 100 * $width, $height, ":", 0, 0, 'L', 1);
if ($res['intex'] != 0) {
    $optPlngn = (isset($optNm[$res['pelanggan']]) ? $optNm[$res['pelanggan']] : "");
} else {
    $optPlngn = (isset($optSup[$res['pelanggan']]) ? $optSup[$res['pelanggan']] : "");
}
...
if ((isset($res['posting']) ? $res['posting'] : '') == 1) {
