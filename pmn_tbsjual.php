...
<script language=javascript src='js/pmn_tbsjual.js?v=<?php echo time(); ?>'></script>
...
echo"<div>";//buka div
OPEN_BOX('','<span class=judul>'.getMenu('pmn_tbsjual').'</span>');
echo"<table>
     <tr valign=middle>
...
<table cellspacing=1 border=0>
	<tr>
		...
		<td>:</td>		
		<td>
			<select id=kodecustomer  style=\"width:155px;\" onchange='getnokontrak()'>'".$optcustomer."'</select>
		</td>
		
		<td>".$_SESSION['lang']['persen']." ".$_SESSION['lang']['ppn']."</td>
		<td>:</td>
		<td><input type=text class=myinputtextnumber id=persenppn name=persenppn onkeypress='return angka_doang(event)' maxlength=5 style=width:150px;/></td>
		
		<td valign=top rowspan=4>".$_SESSION['lang']['keterangan']."</td> 
		<td valign=top rowspan=4>:</td>
		<td  rowspan=4 valign=top><textarea rows='2' id=keteranganht type=text onkeypress=\"return tanpa_kutip(event)\" style=\"width:200px;\"></textarea></td>
	...
	<tr>
		...
		<td>:</td>	
		<td><input type=text id=nokontrak size=20 disabled class=myinputtext style=\"width:150px;\"></td>		
		
		
		
		
		
			<td>".$_SESSION['lang']['persen']." ".$_SESSION['lang']['pph']."</td>
		<td>:</td>	
		<td>
			<input type=text class=myinputtextnumber id=persenpph name=persenpph onkeypress='return angka_doang(event)' maxlength=5 style=width:150px;/>
		</td>
...
echo "<div id=listdatadt class='table-scroll' style='width:1200px;height:180px;'></div>";
CLOSE_BOX();
echo"</div>";
