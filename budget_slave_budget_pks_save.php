...
if($tab=='0'){
    ...
    VALUES (
    '".$tipebudget."', '".$tahunbudget."', '".$mesin."', '".$kodebudget0."', '".$akun."', '".$jumlahpertahun0."', '".$_SESSION['standard']['userid']."',CURRENT_TIMESTAMP,'".$aruskas."')";
...
if($tab=='2'){
    ...
    $str="select * from ".$dbname.".bgt_kode  where kodebudget = 'PKSM'";
    $res=$owlPDO->query($str) or die(print " Gagal: ".PDOException::getMessage());
    $res->setFetchMode(PDO::FETCH_OBJ);
    $akun='';
    while($bar= $res->fetch())
...
if($tab=='3'){  
    ...
    VALUES (
    '".$tipebudget."', '".$tahunbudget."', '".$mesin."', '".$kodebudget3."', '".$kodevhc3."', '".$jumlahjam3."','".$jumlahjam3."', 
