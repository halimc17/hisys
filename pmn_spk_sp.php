...
<script language=javascript src='js/pmn_spk_sp.js?v=<?php echo time(); ?>'></script>
<script language=javascript src='js/pmn_spk_print.js?v=<?php echo time(); ?>'></script>

<?php

// OPEN_BOX('','<span class=judul>SURAT PEMBERITAHUAN PENGANGKUTAN ANTAR PULAU</span><br>');
...
$optbuyer = $optpelayaran = $optfranco1 = $optfranco2 = $optttd = $optsurveyor = $optbarang = $optkapal = $optponton = "<option value=''>" . $_SESSION['lang']['pilihdata'] . "</option>";
...
echo "<table border=0 cellpadding=1 cellspacing=1>
				...
				<tr>
					...
					<td>:</td>		
					<td>
						<select id=pelabuhanmuat style=\"width:155px;\">'" . $optfranco1 . "'</select>
					...
					<td>" . $_SESSION['lang']['pelabuhanbongkar'] . "</td>
					<td>:</td>		
					<td>
						<select id=pelabuhanbongkar style=\"width:155px;\">'" . $optfranco2 . "'</select>
						<img id='pelabuhanbongkar' onclick=z.elSearch('pelabuhanbongkar',event) class='resicon' src='images/skyblue/zoom.png' style='position:relative;top:3px;'></td>
					</td>
				...
				<tr>
					...
					<td><select style=\"width:155px;\" id=tandatangan>" . $optttd . "</select>
								<img id='tandatangan' onclick=z.elSearch('tandatangan',event) class='resicon' src='images/skyblue/zoom.png' style='position:relative;top:3px;'></td>
					...
					<td>:</td>		
					<td>
						<input type=text id=kota value='" . $kota . "' size=20 class=myinputtext style=\"width:150px;\">
					</td>
