...
<?
OPEN_BOX('','<span class=judul>'.getMenu('pmn_5klcustomer').'</span>');
?>
<br>
<fieldset style=float:left>
    ...
    <table cellpadding="2" cellspacing="2" border="0">
        <tr>
            ...
            <td>:</td>
            <td><input type="text" class="myinputtext" maxlength="10" id="kode_grp_cus" onkeypress="return tanpa_kutip(event);" /></td>
        </tr>
        <tr>
            <td><?php echo $_SESSION['lang']['kelompok_pem'] ?></td>
            <td>:</td>
            <td><input type="text" class="myinputtext" maxlength="20" id="klmpk_cust" onkeypress="return tanpa_kutip(event);"  /></td>
        </tr>
        <tr>
...
<?php OPEN_BOX(); ?>
<fieldset><legend><b><?php echo $_SESSION['lang']['printArea'] ?></b></legend>
     <!--<legend><b><?php //echo $_SESSION['lang']['pmn_4klcustomer'];  ?></b></legend>-->
    <table class=sortable cellspacing="1" border="0">
        <thead>
            <tr class=rowheader>
                <td align=center>No.</td>
                <td align=center><?php echo $_SESSION['lang']['kode'] ?></td>
                <td align=center><?php echo $_SESSION['lang']['kelompok_pem']; ?></td>
                <td align=center><?php echo $_SESSION['lang']['noakun']; ?></td>
                <td align=center><?php echo $_SESSION['lang']['findnoakun']; ?></td>
        ...
        <tbody id=containersatuan>
            ...
            $po = $owlPDO->query($srt) or die(print " Gagal: " . PDOException::getMessage());
