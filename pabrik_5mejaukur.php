...
<script language=javascript1.2 src='js/pabrik_5mejaukur.js'></script>
...
<?php
OPEN_BOX('','<span class=judul>'.getMenu('pabrik_5mejaukur').'</span>');
		...
		<legend>".$_SESSION['lang']['entryForm']."</legend> 
			<table border=0 cellpadding=1 cellspacing=1>
				<tr>
					...
					<td>:</td>
					<td><select id=pabrik style=\"width:150px;\" >".$optpks."</select></td>
				</tr>
				<tr>
					<td>".$_SESSION['lang']['tangki']."</td>
					<td>:</td>
					<td><select id=tangki style=\"width:150px;\" >".$opttangki."</select></td>
				</tr>
				<tr>
