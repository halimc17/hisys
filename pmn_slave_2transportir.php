...
while ($bar = $res->fetch()) {
    ...
    $opttransport[$bar['nokendaraan']] = isset($opttransport[$bar['nokendaraan']]) ? $opttransport[$bar['nokendaraan']] : '';
    $optnmtransport[$opttransport[$bar['nokendaraan']]] = isset($optnmtransport[$opttransport[$bar['nokendaraan']]]) ? $optnmtransport[$opttransport[$bar['nokendaraan']]] : '';
    ...
    <td  align=left>" . $optnmtransport[$kdsup] . "</td>
    <td align=left>" . $optnamacostumer[$bar['kodecustomer']] . "</td>    
    <td align=right>" . number_format($bar['beratbersih'], 2) . "</td>
    </tr>";
    #untuk total
    $tonetto+=$bar['transportir'];
}
