...
<script language=javascript src='js/kebun_2defisitair.js?v=<?php echo time(); ?>'></script>

<?php

OPEN_BOX('','<span class=judul>'.getMenu('kebun_2defisitair').'</span><br>');
...
<fieldset style=float:left>
	<table cellspacing=1 cellpadding=2>
		...
		<tr>
			...
			<td>:</td>
			<td>
				<select class=select2 id='periode' style='width:246px'>".$optPeriode2."</select>
			</td>
		</tr>
		<tr>
			<td colspan=2></td>
