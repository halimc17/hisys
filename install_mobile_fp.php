<?php
	//Connect to database
    $servername = "182.23.67.40/adminer.php";
    $username = "localuser";		//put your phpmyadmin username.(default is "root")
    $password = "#mariBerc1nta#";			//if your phpmyadmin has a password put it here.(default is "root")
    $dbname = "ksp";
    
	$conn = new mysqli($servername, $username, $password, $dbname);

	// Create database
	$sql = "CREATE DATABASE IF NOT EXISTS  ksp ";
