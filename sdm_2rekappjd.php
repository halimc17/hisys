...
<script language=javascript src='js/sdm_2rekappjd.js?v=<?php echo time(); ?>'></script>

<?php

OPEN_BOX('','<span class=judul>'.getMenu('sdm_2rekappjd').'</span><br>');
...
<fieldset style=float:left>
	<table cellspacing=1 cellpadding=2>
		...
		<tr>
			...
			<td>:</td>
			<td><input type='text' class=myinputtext id=tanggaldari onmousemove=setCalendar(this.id) onkeypress=return false; style='width:107px' readonly /> S/D
				<input type='text' class=myinputtext id=tanggalsampai onmousemove=setCalendar(this.id) onkeypress=return false; style='width:107px' readonly /></td>
		</tr>
		<tr>
			<td colspan=2></td>
			<td>
