...
<script type="text/javascript" src="js/pajak_suratkuasa.js?ver=2.2"></script>
...
OPEN_BOX('','<span class=judul>'.strtoupper($_SESSION['lang']['surat']).' KUASA PAJAK</span>');
  ...
  <tr>
  <td>Penerima Kuasa 1</td>
  <td>:</td>
  <td><select id=penerimakuasa1 style='width:175px'>".$optpenerimakuasa."</select></td>
  </tr>
   <tr>
  <td>Penerima Kuasa 2</td>
  <td>:</td>
  <td><select id=penerimakuasa2 style='width:175px'>".$optpenerimakuasa."</select></td>
  </tr>
  <tr>
  <td>Kota</td>
  <td>:</td>
  <td><input type=text id=kota style='width:170px' class=myinputtext></td>
  </tr>
  <tr>
  ...
  <tr>
    <td><input type=hidden id=id style='width:170px' class=myinputtext></td>
  </tr>
      <tr>
        <td colspan=2></td>
        <td>
    ...
    <table class=sortable cellspacing=1 cellpadding=1 border=0 width=100%>
      <thead>
        <tr class=rowheader>
          ...
          <td align=center>Penerima Kuasa1</td>
          <td align=center>".$_SESSION['lang']['npwp']."</td>
          <td align=center>Penerima Kuasa2</td>
          <td align=center>".$_SESSION['lang']['npwp']."</td>
