...
echo open_body();
?>
<script language=Javascript1.2 src=js/log_3selisihinv.js></script>
<?php
include('master_mainMenu.php');
OPEN_BOX('','<span class=judul>'.getMenu('log_3selisihinv').'</span>');
#organisasi
$optOrg = '';
...
//}
//else{
$str = "select kodeorganisasi,namaorganisasi from " . $dbname . ".organisasi where kodeorganisasi like '%" . $_SESSION['empl']['lokasitugas'] . "%' and tipe='GUDANG' order by namaorganisasi";
//}
