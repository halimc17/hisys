...
$optpil="<option value='Supplier'>Supplier</option>";
$optpil.="<option value='Barang'>Barang</option>";
$arr = "##kdUnit##periode##filter##jenis";
?>
<script language=javascript src=js/zTools.js></script>
<script language=javascript src=js/zReport.js></script>
<script language=javascript src=js/log_2frekuensipembelian.js></script>


<link rel=stylesheet type=text/css href=style/zTable.css>
<?
OPEN_BOX('','<span class=judul>'.strtoupper('Laporan Frekuensi Pembelian').'</span>');
?>
<div>
    <fieldset style="float: left;">
        ...
        <table cellspacing="1" border="0" >
            ...
            <tr><td><label>Jenis</label></td><td>:</td><td><select id="jenis" name="jenis" style="width:150px"><?php echo $optpil; ?></select></td></tr>
            ...
            <tr><td><td><td colspan="2"><button onclick="zPreview('log_2slave_frekuensipembelian', '<?php echo $arr ?>', 'printContainer')" class="mybutton" name="preview" id="preview">Preview</button><button onclick="zExcel(event, 'log_2slave_produktivitas.php', '<?php echo $arr ?>')" class="mybutton" name="preview" id="preview">Excel</button></td></tr>
