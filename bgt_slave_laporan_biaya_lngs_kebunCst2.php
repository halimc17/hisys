...
if($kodeOrg==''||$thnBudget=='')
{
    exit("Error:Field Tidak Boleh Kosong");
            ...
            $tab.="<th  rowspan=5 valign='middle' align=center ".$bg." >".$_SESSION['lang']['luas']."</th>";
            ...
            foreach($listNoakun as $barisNoakun)
            {
                 ...
                 $new=substr($barisNoakun,0,5);
                    ...
                    $tab.="<td align=right>".@numb_format($pembagi[$barisNoakun])."</td>";
                    $tab.="<td align=right>".@numb_format($totRupiahKegiatan[$thnBudget][$barisNoakun][$new])."</td>";
                    $tab.="<td align=right>".@numb_format($kegHa[$thnBudget][$barisNoakun][$new])."</td>";
                    $tab.="<td align=right>".@numb_format($dataKeg[$thnBudget][$barisNoakun][$new2]['sdm'])."</td>";
                    $tab.="<td align=right>".@numb_format($kegSdm[$thnBudget][$barisNoakun][$new])."</td>";
                    $tab.="<td align=right>".@numb_format($dataKeg[$thnBudget][$barisNoakun][$new2]['mat'])."</td>";
                    $tab.="<td align=right>".@numb_format($kegMat[$thnBudget][$barisNoakun][$new2])."</td>";
                    $tab.="<td align=right>".@numb_format($dataKeg[$thnBudget][$barisNoakun][$new2]['tool'])."</td>";
                    $tab.="<td align=right>".@numb_format($kegTool[$thnBudget][$barisNoakun][$new])."</td>";
                    $tab.="<td align=right>".@numb_format($dataKeg[$thnBudget][$barisNoakun][$new2]['vhc'])."</td>";
                    $tab.="<td align=right>".@numb_format($kegVhc[$thnBudget][$barisNoakun][$new])."</td>";
                    $tab.="<td align=right>".@numb_format($dataKeg[$thnBudget][$barisNoakun][$new2]['kntrk'])."</td>";
                    $tab.="<td align=right>".@numb_format($kegKntrak[$thnBudget][$barisNoakun][$new])."</td>";
                    $tab.="</tr>";
