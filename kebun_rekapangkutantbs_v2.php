...
?>
<script language=javascript1.2 src='js/kebun_rekapangkutantbs_v2.js?v=<?php echo time(); ?>'></script>
...
foreach($res as $key => $val){
    if(getindukPT($val['kodeorganisasi'])!='PPP'){
        if($_SESSION['empl']['lokasitugas']==$val['kodeorganisasi']){
            ...
            $optorg2.="<option value=".$val['kodeorganisasi'].">".$val['kodeorganisasi']." - ".$val['namaorganisasi']."</option>";
        }
    }
}
...
OPEN_BOX('','<span class=judul>'.getMenu('kebun_rekapangkutantbs_v2').'</span>');
...
echo "
	<div class='table-scroll'>";    
        ...
        echo"<table cellpadding=1 cellspacing=1 border=0 class=sortable>
            ...
            <th align=center rowspan='2'>Potongan<br>Brondolan<br>(Kg)</th></th>";
...
OPEN_BOX();
$res=array('1'=>'1 (Pertama) ', '2'=>'2 (Kedua) ','3'=>'3 (Ketiga) ','4'=>'4 (Keempat)','5'=>'5 (Kelima)','6'=>'6 (Keenam)');
