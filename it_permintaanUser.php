...
$q_jenis_layanan = $owlPDO->query($s_jenis_layanan) or die(print " Gagal: " . PDOException::getMessage());
$q_jenis_layanan->setFetchMode(PDO::FETCH_ASSOC);
while ($r_jenis_layanan = $q_jenis_layanan->fetch()) {
...
$q_karyawan=$owlPDO->query($s_karyawan) or die(print " Gagal: ".PDOException::getMessage());
$q_karyawan->setFetchMode(PDO::FETCH_ASSOC);
while ($r_karyawan = $q_karyawan->fetch()) {
    ...
    <fieldset style='float:left;'>
        ...
        <table cellspacing="1" border="0" style="width:100px;">
            ...
            <tr>
                ...
                <td><textarea rows="5" cols="50" id='deskripsi' onkeypress="return tanpa_kutip(event);" /></textarea></td>
            </tr>
            <tr>
