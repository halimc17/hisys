...
// preview excel pdf    
    ...
    $str = "SELECT noakun, namaakun FROM " . $dbname . ".keu_5akun
        WHERE length( noakun ) = 5 and noakun between '62101' and '62190' order by noakun";
    ...
    $str = "SELECT noakun, namaakun FROM " . $dbname . ".keu_5akun
        WHERE length( noakun ) = 7 and substr(noakun,1,5) between '62101' and '62190' order by noakun";
    ...
    if (!empty($akuntb))
        foreach ($akuntb as $akun) {
            $tab.="<tr  bgcolor=#ccccff>
        <td align=right colspan=2 " . $bg . ">" . $akun . "</td>
