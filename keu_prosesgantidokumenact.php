...
echo open_body();
?>
<script language=javascript src='js/keu_prosesgantidokumenact.js?v=<?php echo time(); ?>'></script>
<?
include('master_mainMenu.php');
OPEN_BOX("","<span class=judul>".getMenu('keu_prosesgantidokumenact')."<br></span>");
