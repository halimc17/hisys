...
array_multisort($optPeriod,SORT_ASC);
...
OPEN_BOX('','<span class=judul>'.getMenu('keu_2summaryJMemorial').'</span><br>');
echo genElTitle('Form',$els);
CLOSE_BOX();
OPEN_BOX();
echo "<fieldset style='clear:left'><legend><b>Print Area</b></legend>";
echo "<div id='".$container."' style='overflow:auto;height:400px'></div></fieldset>";
CLOSE_BOX();
