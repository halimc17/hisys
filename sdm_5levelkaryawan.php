...
<script language=javascript src='js/sdm_5levelkaryawan.js?v=<?php echo time(); ?>'></script>
<?php
...
OPEN_BOX('','<span class=judul>'.getMenu('sdm_5levelkaryawan').'<br></span>');
...
CLOSE_BOX();
OPEN_BOX();	 
// echo open_theme("Level Karyawan Tersedia");
