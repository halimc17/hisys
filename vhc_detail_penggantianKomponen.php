        ...
        case 'detail_add' :
                ...
                exit;
                        ...
                        if($res<1)
                        {
                                ...
                                $sins="insert into ".$dbname.".vhc_penggantianht (kodeorg`,`kodevhc`,`tanggal`,`updateby`,`notransaksi`,`downtime`, `kerusakan`,`createdtime`) values 
                                ('".$lokasi."','".$_POST['kd_jenis']."','".tanggalsystem($_POST['tgl'])."','".$entry_by."','".$_POST['notransaksi']."','','','".$createdtime."')";
								try{
									$owlPDO->exec($sins);
