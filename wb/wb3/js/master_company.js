function loaddata() {
    ...
    tujuan = 'master_company_slave.php';
...
function editdata(jenis,kodewilayah,kode,deskripsi,alamat,kota,stat){
	param  = '';
	param += '&jenis=' + jenis;	
...
function simpan(){
	...
	validate([
        ...
        ["kode","Kode Perusahaan harus diisi"],
        ["deskripsi","Nama Perusahaan harus diisi"],
