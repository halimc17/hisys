function loaddata() {
    ...
    tujuan = 'master_product_slave.php';
...
function editdata(jenis,kode,deskripsi,kriteria,satuan,inisial,stat){
	param  = '';
	param += '&jenis=' + jenis;
	param += '&kode=' + kode;
			...
			if (con.status == 200) {
				...
				if (!isSaveResponse(con.responseText)) {
					...
					if(kriteria=='Pengiriman'){
						document.getElementById('kriteria1').checked=true;
					}else{
						document.getElementById('kriteria2').checked=true;
					}
					setValue2('satuan',satuan);
					setValue2('inisial',inisial);
...
function simpan(){
	...
	if(document.getElementById('kriteria1').checked==true){
		kriteria='Pengiriman';
	}else{
		kriteria='Penerimaan';
	}
	...
	validate([
        ["kode","Kode Produk harus diisi"],
        ["deskripsi","Nama Produk harus diisi"],
        ["satuan","Satuan Produk harus diisi"],
        ["inisial","Inisial Produk harus diisi"],
