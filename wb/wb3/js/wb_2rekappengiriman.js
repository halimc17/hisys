...
function getso(){
	...
	param='method=getso'+'&product='+product;
    tujuan='wb_2rekappengiriman_slave.php';
        ...
        if(con.readyState==4){
            if (con.status == 200) {
                ...
                if (!isSaveResponse(con.responseText)) {
                    ...
                    document.getElementById('noso').innerHTML=con.responseText;
                }
            } else {
                busy_off();
...
function loaddata() {
    ...
    param = 'method=loaddata&noso='+noso;
    tujuan = 'wb_2rekappengiriman_slave.php';
    post_response_text(tujuan, param, respog);
