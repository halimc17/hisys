...
echo"<script type=text/javascript src=DataTables/js/dataTables.fixedColumns.js></script>";

#search builder
echo"<script type=text/javascript src=DataTables/js/dataTables.searchBuilder.min.js></script>";
echo"<script type=text/javascript src=DataTables/js/dataTables.dateTime.min.js></script>";

echo"<link rel=stylesheet type=text/css href=DataTables/css/searchBuilder.dataTables.min.css>";
echo"<link rel=stylesheet type=text/css href=DataTables/css/dataTables.dateTime.min.css>";
#search builder


echo"<script type=text/javascript src=DataTables/js/buttons.colVis.min.js></script>";
...
echo"<link rel=stylesheet type=text/css href=DataTables/css/fixedColumns.dataTables.css>";
// echo"<link rel=stylesheet type=text/css href=DataTables/css/fixedColumns.dataTables.min.css>";
// echo"<link rel=stylesheet type=text/css href=DataTables/css/fixedColumns.bootstrap.min.css>";
