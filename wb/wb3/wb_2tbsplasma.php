...
OPEN_BOX('','<span class=judul>'.getMenu('wb_2tbsplasma').'</span><br>');
...
$str="select unitcode,unitname from ".$dbname.".msunit where compcode='".$pt."' and tipeunit='PLASMA'";
$res=fetchdata($str);
foreach($res as $val){
...
?>
<script language=javascript src='js/wb_2tbsplasma.js?v=<?php echo time(); ?>'></script>
<script>
	getSelect2();
</script>
<?
