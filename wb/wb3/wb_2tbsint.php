...
OPEN_BOX('','<span class=judul>'.getMenu('wb_2tbsint').'</span><br>');
...
$str="select unitcode,unitname from ".$dbname.".msunit where compcode='".$pt."' and tipeunit='INTERNAL'";
$res=fetchdata($str);
foreach($res as $val){
...
?>
<script language=javascript src='js/wb_2tbsint.js?v=<?php echo time(); ?>'></script>
<script>
	getSelect2();
</script>
<?
