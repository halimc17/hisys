...
else
{
       ...
       echo"</tbody></table>
                <br>";
           if($max>1)
               echo"<input type=button class=mybutton value='Selesai' onclick=closeOrderEditor()> ";
           echo" <input type=button class=mybutton value='Tutup' onclick=closeOrderEditor()>";
        }
?>