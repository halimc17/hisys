	...
	case 'loaddata':
		...
		<thead>
			<tr class=rowheader>
				...
				<th style='text-align:center;'>Berat Kendaraan</th>
		...
		foreach($res as $val){
			...
			$tab.="<td style='text-align:left;'>".hidezerodecimal($val['beratkendaraan'],2)."</td>";
			...
			$tab.="<td style='text-align:center;width:25px'>
				<img src='images/application/application_edit.png' class='resicon' title='Edit' onclick=\"editdata('edit','".$val['vhccode']."','".$val['vendorcode']."','".hidezerodecimal($val['vhctarmin'],2)."','".hidezerodecimal($val['vhctarmax'],2)."','".$val['vhcstatus']."','".$val['nostnk']."','".hidezerodecimal($val['beratkendaraan'],2)."')\";>
			</td>";
			$tab.="</tr>";
		}
		...
		$tab.="
			 <table border=0 cellpadding=2 cellspacing=1>
				...
				<tr>
					...
					<td>
						<input type=text class=myinputtextnumber style='width:100px;height:30px;font-size:14px;' id='beratkendaraan' onkeypress=\"return angka_doang(event)\" onkeyup=\"z.numberFormat('beratkendaraan',2)\" ondrop=\"return false;\" onpaste=\"return false;\" placeholder='0'> KG
					</td>
				</tr>
				<tr>
					<td>Status</td>
	...
	case 'insert':
		try{
			...
			$data = array(
				...
				'beratkendaraan'		=> str_replace(',','',$param['beratkendaraan']),
