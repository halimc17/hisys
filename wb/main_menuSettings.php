...
OPEN_BOX('','<span class=judul>Pengaturan Menu</span>');
echo OPEN_THEME("Pengaturan Menu:");
//=================================================================================
//menuSettings
echo" <div id=menuSettingContainer>
     <input type=radio name=rad onclick=expandAll()>Rentangkan Semua
	 <input type=radio name=rad onclick=collapsAll() checked>Gulung Semua
	 <hr><b>Menu Settings:</b>
	";
//get max id of menu=================================
//default id 0
$max_id=0;
$strx=$owlPDO->query("select max(id) as mx from ".$dbname.".menu");
...
//====================================================
$str=$owlPDO->query("select * from ".$dbname.".menu 
	...
	$str1->setFetchMode(PDO::FETCH_OBJ);	
				...
				$str2->setFetchMode(PDO::FETCH_OBJ);	
							...
							$str3->setFetchMode(PDO::FETCH_OBJ);	
									...
									//=========================================================
												...
												//=========================================================
															...
															//=========================================================
															 ...
															 $str6->setFetchMode(PDO::FETCH_OBJ);	
																		 ...
																		 <li><div id=inputmenu".$bar5->id." class=menuinput  style='display:none;'>
																		  ...
																		  <input type=checkbox  title='Check to create this file' id=newFile".$bar5->id."><font color=white>Buat File</font>
																		  <input type=hidden id=master_menu".$bar5->id." value=".$bar5->id.">
																		  
																		  <input type=button class=mybutton value='Simpan' onclick=saveMenu('master_menu".$bar5->id."','newCaption".$bar5->id."','newAction".$bar5->id."','link".$bar5->id."','inputmenu".$bar5->id."','type".$bar5->id."','newFile".$bar5->id."');>
																		  <input type=button class=mybutton value='Tutup' onclick=showById('inputmenu".$bar5->id."','link".$bar5->id."')>
																	      </div>
																		  <a class=newMenu title='Create New Link' id=link".$bar5->id." onclick=\"javascript:hideObject(this);showObject(document.getElementById('inputmenu".$bar5->id."'));\">Buat Baru</a>
																		  </li>
																		 </ul>";
															...
															//========================================================																			
															 ...
															 echo"</div>
															  ...
															  <input type=checkbox  title='Check to create this file' id=newFile".$bar4->id."><font color=white>Buat File</font>
															  <input type=hidden id=master_menu".$bar4->id." value=".$bar4->id.">
															  
															  <input type=button class=mybutton value='Simpan' onclick=saveMenu('master_menu".$bar4->id."','newCaption".$bar4->id."','newAction".$bar4->id."','link".$bar4->id."','inputmenu".$bar4->id."','type".$bar4->id."','newFile".$bar4->id."');>
															  <input type=button class=mybutton value='Tutup' onclick=showById('inputmenu".$bar4->id."','link".$bar4->id."')>
														      </div>
															  <a class=newMenu title='Create New Link' id=link".$bar4->id." onclick=\"javascript:hideObject(this);showObject(document.getElementById('inputmenu".$bar4->id."'));\">Buat Baru</a>
															  </li></ul>";
												...
												//========================================================																
												 ...
												 echo"</div>
												  ...
												  <input type=checkbox  title='Check to create this file' id=newFile".$bar3->id."><font color=white>Buat File</font>
												  <input type=hidden id=master_menu".$bar3->id." value=".$bar3->id.">
												  
												  <input type=button class=mybutton value='Simpan' onclick=saveMenu('master_menu".$bar3->id."','newCaption".$bar3->id."','newAction".$bar3->id."','link".$bar3->id."','inputmenu".$bar3->id."','type".$bar3->id."','newFile".$bar3->id."');>
												  <input type=button class=mybutton value='Tutup' onclick=showById('inputmenu".$bar3->id."','link".$bar3->id."')>
											      </div>
												  <a class=newMenu title='Create New Link' id=link".$bar3->id." onclick=\"javascript:hideObject(this);showObject(document.getElementById('inputmenu".$bar3->id."'));\">Buat Baru</a></li>												 
													  </ul>";
									...
									//========================================================												
									 ...
									 echo"</div>
									  ...
									  <input type=checkbox  title='Check to create this file' id=newFile".$bar2->id."><font color=white>Buat File</font>
									  <input type=hidden id=master_menu".$bar2->id." value=".$bar2->id.">
									  
									  <input type=button class=mybutton value='Simpan' onclick=saveMenu('master_menu".$bar2->id."','newCaption".$bar2->id."','newAction".$bar2->id."','link".$bar2->id."','inputmenu".$bar2->id."','type".$bar2->id."','newFile".$bar2->id."');>
									  <input type=button class=mybutton value='Tutup' onclick=showById('inputmenu".$bar2->id."','link".$bar2->id."')>
								      </div>
									  <a class=newMenu title='Create New Link' id=link".$bar2->id." onclick=\"javascript:hideObject(this);showObject(document.getElementById('inputmenu".$bar2->id."'));\">Buat Baru</a></li>
									      </ul>";
						...
						//========================================================
						 ...
						 echo"</div>
							  ...
							  <input type=checkbox  title='Check to create this file' id=newFile".$bar1->id."><font color=white>Buat File</font>
							  <input type=hidden id=master_menu".$bar1->id." value=".$bar1->id.">
							  
							  <input type=button class=mybutton value='Simpan' onclick=saveMenu('master_menu".$bar1->id."','newCaption".$bar1->id."','newAction".$bar1->id."','link".$bar1->id."','inputmenu".$bar1->id."','type".$bar1->id."','newFile".$bar1->id."');>
							  <input type=button class=mybutton value='Tutup' onclick=showById('inputmenu".$bar1->id."','link".$bar1->id."')>
						      </div>
							  <a class=newMenu title='Create New Link' id=link".$bar1->id." onclick=\"javascript:hideObject(this);showObject(document.getElementById('inputmenu".$bar1->id."'));\">Buat Baru</a></li>
						      </ul>";
			...
			//========================================================
			 ...
			 echo"</div>			 
				  ...
				  <input type=checkbox  title='Check to create this file' id=newFile".$bar->id."><font color=white>Buat Baru</font>
				  <input type=hidden id=master_menu".$bar->id." value=".$bar->id.">
				  
				  <input type=button class=mybutton value='Simpan' onclick=saveMenu('master_menu".$bar->id."','newCaption".$bar->id."','newAction".$bar->id."','link".$bar->id."','inputmenu".$bar->id."','type".$bar->id."','newFile".$bar->id."');>
				  <input type=button class=mybutton value='Tutup' onclick=showById('inputmenu".$bar->id."','link".$bar->id."')>
			      </div>
				  <a class=newMenu title='Create New Link' id=link".$bar->id." onclick=\"javascript:hideObject(this);showObject(document.getElementById('inputmenu".$bar->id."'));\">Buat Baru</a></li>
			      </ul>";
...
echo "</div>
	  ...
	  <input type=checkbox  title='Check to create this file' id=newFile0 disabled><font color=white>Buat File</font>
	  <input type=hidden id=master_menu0 value=0>

	  <input type=button class=mybutton value='Simpan' onclick=saveMenu('master_menu0','newCaption0','newAction0','link0','inputmenu0','type0','newFile0');>
	  <input type=button class=mybutton value='Tutup' onclick=showById('inputmenu0','link0')>
      </div>
	  <a class=newMenu id=link0  title='Create New Link'  onclick=\"javascript:hideObject(this);showObject(document.getElementById('inputmenu0'));\">Buat Baru</a></li>";
echo"</ul></div>";
//end menuSettingss
...
//==================================================================================================================================================================
 echo"<div id=menuOrderContainer style='position:relative;display:none'>
     <input type=radio name=rad1 onclick=expandAllOrder()>Rentangkan Semua
	 <input type=radio name=rad1 onclick=collapsAllOrder() checked>Gulung Semua
	 <hr><b>Menu Arranger</b>:
	";
echo"<ul>
     <a  class=lab id=orderlab0 href=# onclick=showEditor('0','false',event) title='Click to arrange master menu (the top most menu)'>Menu Utama</a>
     <div id=ordergroup0>";
...
//end menuOrder
//==================================================================================================================================================================
echo "<hr><center><input type=button class=mybutton value='Shahkan' onclick=window.location.reload()><hr></center>
