...
echo"<table style=\"width:99.5%;border-collapse:collapse;margin-left:auto;margin-right:auto;\">
	<tr>
		<td>
			<strong>
				<font size=3 color=#191919 font-family: Verdana, Arial, Helvetica, sans-serif>Terima TBS Eksternal</font>
			</strong>
		</td>
...
$optso=$optsambungso="<option value=''>Silahkan pilih</option>";
...
echo"<table border=0 cellpadding=3 style=width:100%>
	...
	<td style=vertical-align:top;width:50%>
		...
		<tr>
			<td>
				<label class=label style='font-weight:bold'>Sisa Kontrak</label>
			...
			<td>
				<label class=label style='font-weight:bold'>Sambung Kontrak</label>
				<select tabindex=16 class='select2' style='width:86%;' id='sambungso' tabindex=10>".$optsambungso."</select>
			</td>
		</tr>
		...
		<tr>
			<td>
				...
				<select class='select2' style='width:86%;height:32px;' id='transportir' tabindex=5>".$opttransportir."</select>
			</td>
			<td>
	...
	<tr>
		...
		<td align='center' style='vertical-align:top'>
			...
			<table border=0 cellspacing=0>
				...
				<tr>
					<td valign='middle'>Potongan Wajib</td>
					<td>:</td>
					<td> 
						<input class=myinputtext type=text id=kgpotonganwajib onkeypress='return false;' style='width:85%;font-size:20px;text-align:right;'  disabled>
					</td>
				</tr>
				<tr>
...
<script language=javascript1.2 src='js/trx_intbseks.js?v=<?php echo time(); ?>'></script>
<script>
	getSelect2();
</script>
<?php
