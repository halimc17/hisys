...
echo"<table style=\"width:99.5%;border-collapse:collapse;margin-left:auto;margin-right:auto;\">
	<tr>
		<td>
			<strong>
				<font size=5 color=#191919 font-family: Verdana, Arial, Helvetica, sans-serif>Kirim CPO | PK</font>
			</strong>
		</td>
		<td style='vertical-align:top;padding:5px;font-weight:bold;text-align:center'>
			<table border=0>
				<tr>
					<td colspan=3 style='text-align:center'><u>Jumlah Kendaraan</u></td>
				</tr>
				<tr>
					<td>Masuk CPO<td>
					<td>:<td>
					<td style='text-align:right'><label id='jlhkendaraancpo0'></label><td>
					
					<td style='padding-left:10px;padding-right:10px'>|</td>
					
					<td>Masuk PK<td>
					<td>:<td>
					<td style='text-align:right'><label id='jlhkendaraanpk0'></label><td>
				</tr>
				<tr>
					<td>Keluar CPO<td>
					<td>:<td>
					<td style='text-align:right'><label id='jlhkendaraancpo1'></label><td>
					
					<td style='padding-left:10px;padding-right:10px'>|</td>
					
					<td>Keluar PK<td>
					<td>:<td>
					<td style='text-align:right'><label id='jlhkendaraanpk1'></label><td>
				</tr>
			</table>
		</td>
		<td align='right'>
	...
	<td style=vertical-align:top;width:50%>
		...
		<tr>
			...
			<td>
				...
				<input tabindex=5 class=myinputtext style='width:80%;height:32px;' id='nokendaraan'>
			</td>
		...
		<tr>
			<td>
				<label class=label style='font-size:12px;font-weight:bold'>No. Delivery Order</label><br>
		...
		<tr>
			<td>
				<label class=label style='font-weight:bold'>Sisa Delivery Order</label>
...
<script language=javascript1.2 src='js/trx_outcpopk.js?v=<?php echo time(); ?>'></script>
<script>
	getSelect2();
</script>
<?php
