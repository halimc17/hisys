	...
	case 'loaddata':
		...
		<thead>
			<tr class=rowheader>
				...
				<th style='text-align:center;display:none'>WB Condition</th>
				<th style='text-align:center;'>Tipe</th>
				<th style='text-align:center;'>Produk</th>
				<th style='text-align:center;'>Customer</th>
				<th style='text-align:center;'>Sales Order</th>
				<th style='text-align:center;display:none'>Qty Split</th>
		...
		foreach($res as $val){
			...
			$tab.="<td style='text-align:left;display:none'>".$val['wbcond']."</td>";
			...
			$tab.="<td style='text-align:right;;display:none'>".hidezerodecimal($val['nettosplit'])."</br>".hidezerodecimal($val['nettosplit2'])."</td>";
		...
		$tab.="<td style='text-align:center;' colspan=14>T O T A L</td>";
