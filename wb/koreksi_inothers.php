...
OPEN_BOX('','<span class=judul>Koreksi Data Terima Terima Lainnya</span><br>');
...
echo"<table border=0 cellpadding=3 style=width:100%>
	...
	<td style=vertical-align:top;width:50%>
		...
		<tr>
			<td style='width:50%;'>
				<label class=label style='font-size:12px;font-weight:bold'>No. Surat Pengiriman</label><br>
		...
		<tr>
			<td style='width:50%;'>
				...
				<select class='select2' style='width:85%;height:32px;' id='produk' tabindex=3 disabled>".$optproduk."</select>
			</td>
		...
		<tr>
			<td>
				<label class=label style='font-size:12px;font-weight:bold'>PO / STO / Kontrak</label><br>
		...
		<tr>
			<td>
				...
				<select class='select2' style='width:85%;height:32px;' id='pemilik' tabindex=5 disabled>".$optpemilik."</select>
			</td>
...
?>
<script language=javascript1.2 src='js/koreksi_inothers.js?v=<?php echo time(); ?>'></script>
<script>
	getSelect2();
</script>
<?php
