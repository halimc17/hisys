...
OPEN_BOX('','<span class=judul>'.getMenu('wb_2sortasitbseks').'</span><br>');
...
$str="select * from ".$dbname.".msvendor where vendorstatus='1' and supplier='1' and right(vendorcode,4) not in (".$arrunit.")";
$res=fetchdata($str);
foreach ($res as $val) {
...
?>
<script language=javascript src='js/wb_2sortasitbseks.js?v=<?php echo time(); ?>'></script>
<script>
	getSelect2();
</script>
<?
