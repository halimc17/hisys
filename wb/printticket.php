			...
			switch($kodebarang){
				case $kodeproduktbs:
					if ($tipeunit=='INTERNAL') {
						...
						{
							$tab.="<table width=100% cellspacing=0 cellpadding=5 border=0 style='font-family:arial' >
							<tr>
								...
								<td style='width:50%;font-weight:bold'>
									Kepada Yth : ".$optnmsupplier[$supplier]."
								</td>
							</tr>
							<tr>
								<td colspan='2' style='width:100%;text-align:center;padding-top:20px'>
						...
						<table width=100% cellspacing=0 cellpadding=5 border=1 style='font-family:arial' >
							<thead>
								<tr>
						...
						<br>
						<table width=100% cellspacing=0 cellpadding=5 border=0 style='font-family:arial' >
							<tr>
