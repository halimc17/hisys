...
echo"<table style=\"width:99.5%;border-collapse:collapse;margin-left:auto;margin-right:auto;\">
	<tr>
		<td>
			<strong>
				<font size=5 color=#191919 font-family: Verdana, Arial, Helvetica, sans-serif>Terima TBS</font>
			</strong>
		</td>
...
<script language=javascript1.2 src='js/trx_tbskebunx.js?v=<?php echo time(); ?>'></script>
<script>
	getSelect2();
	stopreminder();
</script>
