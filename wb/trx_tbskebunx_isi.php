...
echo"<table style=\"width:99.5%;border-collapse:collapse;margin-left:auto;margin-right:auto;\">
	<tr>
		<td>
			<strong>
				<font size=5 color=#191919 font-family: Verdana, Arial, Helvetica, sans-serif>TBS Kebun (Timbang Awal Isi)</font>
			</strong>
		</td>
	...
	<td style=vertical-align:top;width:50%>
		...
		<tr>
			...
			<td style='width:50%;'>
				...
				<input class=myinputtext style='width:80%;text-align:right' type=text id=tahuntanam onkeypress=\"return isNumberKey2(event);\" onkeydown='upperCaseF(this)' value='' maxlength='4'>
			</td>
		</tr>
		...
		<tr>
			...
			<td>
				...
				<input tabindex=14 class=myinputtext type='number' style='width:80%;text-align:right' type=text id=adj_brondol value='0'>
			</td>
		</tr>
		...
		<tr>
			...
			<td>
				...
				<input tabindex=14 class=myinputtext type='number' style='width:80%;text-align:right' type=text id=adj_jjg value='0'>
			</td>
		</tr>
		<tr>
		<td>
...
<script language=javascript1.2 src='js/trx_tbskebunx_isi.js?v=<?php echo time(); ?>'></script>
<script>
	getSelect2();
	stopreminder();
</script>
