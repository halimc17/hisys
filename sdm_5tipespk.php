...
?>
<script languange=javascript1.2 src='js/sdm_5tipespk.js'></script>

<?


OPEN_BOX('','<span class=judul>'.strtoupper("Tipe SPK").'</span>');




$query = selectQuery($dbname,"sdm_5tipespk");
$resTab = fetchData($query);
#== Prep List Header
$header = array("No. Urut","Tipe");
...
$els[] = array(
    makeElement('tipe','label','Tipe'),
    makeElement('tipe','text','',array('style'=>'width:145px','maxlength'=>'20',
