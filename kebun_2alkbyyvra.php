...
OPEN_BOX('','<span class=judul>'.getMenu('kebun_2alkbyyvra').'</span><br>');
?>
        ...
        <legend>Form</legend>
            <table border=0 cellpadding=1 cellspacing=1>
                ...
                <tr>
                    <td colspan=2></td>
                    <td colspan=4>
                    <button onclick=zPreview('kebun_slave_2alkbyyvra','" . $arr1 . "','printContainer') class=mybutton name=preview id=preview>" . $_SESSION['lang']['preview'] . "</button>
                    <button onclick=zExcel(event,'kebun_slave_2alkbyyvra.php','" . $arr1 . "') class=mybutton name=preview id=preview>" . $_SESSION['lang']['excel'] . "</button>
                    </td>
                </tr>
            </table>
</fieldset>";
