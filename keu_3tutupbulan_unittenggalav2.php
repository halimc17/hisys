...
<script language=javascript1.2 src=js/keu_3tutupbulan_unittenggalav2.js></script>
...
# Form
OPEN_BOX('','<span class=judul>'.strtoupper($_SESSION['lang']['tutupbulan'].' Extra').'</span><br>');
