...
OPEN_BOX('','<span class=judul>'.getMenu('kebun_2alkbyyspv').'</span><br>');
?>
...
echo"<fieldset style='float:left;'>
        <legend>Form</legend>
            <table border=0 cellpadding=1 cellspacing=1>
				...
				<tr>
                    <td id=idtgl>" . $_SESSION['lang']['periode'] . "</td>
                    <td>:</td>
                    <td>
				...
				<tr>
                    ...
                    <td>:</td>
                    <td><select id=sts style=\"width:164px;\">" . $optIP . "</select>
					</td>
                </tr>
				<tr hidden>
                ...
                <tr>
                    <td colspan=2></td>
                    <td colspan=4>
                    <button onclick=zPreview('kebun_slave_2alkbyyspv','" . $arr1 . "','printContainer') class=mybutton name=preview id=preview>" . $_SESSION['lang']['preview'] . "</button>
                    <button onclick=zExcel(event,'kebun_slave_2alkbyyspv.php','" . $arr1 . "') class=mybutton name=preview id=preview>" . $_SESSION['lang']['excel'] . "</button>
                    </td>
                </tr>
            </table>
</fieldset>";
