...
$jumlahkaryhist = 0;
$str = "select count(karyawanid) as jlh from " . $dbname . ".datakaryawan_hist where 5=5 and version_type='B' and lokasitugas='" . $kdorgx . "' and periodegaji='" . $prdgj . "' ";
$res = fetchdata($str);
$jumlahkaryhist = $res[0]['jlh'];
$tabel = 'datakaryawan';
$whhist = '';
if ($jumlahkaryhist > 0) {
	$whhist = "and b.version_type='B' and b.periodegaji='" . $prdgj . "' ";
...
try {
	...
	foreach ($dataX as $notranX => $valKegX) {
		...
		where a.notransaksi='" . $notranX . "' and b.kodekegiatan='" . $kegiatanX . "' and b.kodeorg='" . $blokX . "'";
				...
				$sDr = "select a.nik, lokasitugas,sum(a.umr) as uphtot,sum(a.insentif) as premi, sum(a.penalty) as penalty,kodeorganisasi as kodept from " . $dbname . ".kebun_kehadiran a left join " . $dbname . "." . $tabel . " b on a.nik=b.karyawanid left join " . $dbname . ".kebun_prestasi c on a.notransaksi=c.notransaksi and a.nourut=c.nourut where a.notransaksi='" . $notranX . "' and c.kodekegiatan='" . $kegiatanX . "' and c.kodeorg='" . $blokX . "' " . $whhist . " group by lokasitugas, a.nik";
				$rDr = fetchdata($sDr);
