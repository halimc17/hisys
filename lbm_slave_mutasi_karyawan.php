...
$qStaff = $owlPDO->query($sStaff) or die(print " Gagal: " . PDOException::getMessage());
$qStaff->setFetchMode(PDO::FETCH_ASSOC);
$rStaff = $qStaff->fetch();
...
$qStaffBln = $owlPDO->query($sStaffBln) or die(print " Gagal: " . PDOException::getMessage());
$qStaffBln->setFetchMode(PDO::FETCH_ASSOC);
$rStaffBln = $qStaffBln->fetch();
...
$qStaffBln = $owlPDO->query($sStaffBln) or die(print " Gagal: " . PDOException::getMessage());
$qStaffBln->setFetchMode(PDO::FETCH_ASSOC);
while ($rStaffBln = $qStaffBln->fetch()) {
    ...
    case'pdf':
        ...
        class PDF extends FPDF {
            ...
            function Header() {
                ...
                $this->SetY($tinggiAkr + 20);
                $this->SetX($ksamping);
                $optNmOrg[$afdId] = isset($optNmOrg[$afdId]) ? $optNmOrg[$afdId] : '';
