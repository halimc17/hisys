	...
	case'preview':
		...
		if(count($res) < 1){
			...
			$stream.="<tr class=rowheader>";	 
				...
				$stream.="<th align=center style='border: 0.5 px solid black;".$bgColor."'>".$_SESSION['lang']['nospk']."</th>";
				$stream.="<th align=center style='border: 0.5 px solid black;".$bgColor."'>".$_SESSION['lang']['blok']." On ".$_SESSION['lang']['kontrak']."</th>";
				$stream.="<th align=center style='border: 0.5 px solid black;".$bgColor."'>".$_SESSION['lang']['kontraktor']."</th>";
				$stream.="<th align=center style='border: 0.5 px solid black;".$bgColor."'>".$_SESSION['lang']['kegiatan']." on ".$_SESSION['lang']['kontrak']."</th>";
				$stream.="<th align=center style='border: 0.5 px solid black;".$bgColor."'>".$_SESSION['lang']['namakegiatan']." on ".$_SESSION['lang']['kontrak']."</th>";
				$stream.="<th align=center style='border: 0.5 px solid black;".$bgColor."'>".$_SESSION['lang']['jhk']." on ".$_SESSION['lang']['kontrak']."</th>";
				$stream.="<th align=center style='border: 0.5 px solid black;".$bgColor."'>".$_SESSION['lang']['hasilkerja2']." on ".$_SESSION['lang']['kontrak']."</th>";
				$stream.="<th align=center style='border: 0.5 px solid black;".$bgColor."'>".$_SESSION['lang']['satuan']."</th>";
				$stream.="<th align=center style='border: 0.5 px solid black;".$bgColor."'>".$_SESSION['lang']['jumlah']." on ".$_SESSION['lang']['kontrak']."</th>";
				$stream.="<th align=center style='border: 0.5 px solid black;".$bgColor."'>".$_SESSION['lang']['kegiatan']." on ".$_SESSION['lang']['realisasi']."</th>";
				$stream.="<th align=center style='border: 0.5 px solid black;".$bgColor."'>".$_SESSION['lang']['tanggal']."</th>";
				$stream.="<th align=center style='border: 0.5 px solid black;".$bgColor."'>".$_SESSION['lang']['hasilkerja2']." on ".$_SESSION['lang']['realisasi']."</th>";
				$stream.="<th align=center style='border: 0.5 px solid black;".$bgColor."'>".$_SESSION['lang']['jhk']." on ".$_SESSION['lang']['realisasi']."</th>";
				$stream.="<th align=center style='border: 0.5 px solid black;".$bgColor."'>".$_SESSION['lang']['jumlah']." on ".$_SESSION['lang']['realisasi']."</th>";
				$stream.="<th align=center style='border: 0.5 px solid black;".$bgColor."'>".$_SESSION['lang']['blok']." On ".$_SESSION['lang']['realisasi']."</th>";
			$stream.="</tr>";
			$stream.="</thead>";
			...
			foreach($res as $b){
				...
				$stream.="<tr class=rowcontent>";	
					...
					$stream.="<td style='border: 0.5 px solid black;' align=center>".$b['unit']."</td>";
					$stream.="<td style='border: 0.5 px solid black;' align=left>".getNamaSupplier($b['koderekanan'])."</td>";
					$stream.="<td style='border: 0.5 px solid black;' align=left></td>";
					$stream.="<td style='border: 0.5 px solid black;' align=center></td>";
					...
					$stream.="<td style='border: 0.5 px solid black;' align=right></td>";
					$stream.="<td style='border: 0.5 px solid black;' align=right></td>";
					$stream.="<td style='border: 0.5 px solid black;' align=right></td>";
					$stream.="<td style='border: 0.5 px solid black;' align=right>".number_format($ttlestimasi)."</td>";
