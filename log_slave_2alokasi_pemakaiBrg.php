...
switch ($proses) {
    ...
    case'preview':
        ...
        // <tr>
			...
			// <td align=center>" . $_SESSION['lang']['akun'] . "</td>
        ...
        while ($rData = $qData->fetch()) {
            ...
            $tab.="<tr class=rowcontent>
                ...
                <td style='width:200px;'>" . $rData['nojurnal'] . "</td>
                <td style='width:100px;'>" . tanggalnormal($rData['tanggal']) . "</td>
                <td style='width:200px;'>" . $rData['noreferensi'] . "</td>
                <td style='width:300px;'>" . $rData['keterangan'] . "</td>
                <td style='width:100px;'>" . $rData['noakun'] . "</td>
                <td style='width:100px;' align=center>" . $hslAkun[$rData['noakun']] . "</td>
                <td align=right style='width:100px;'>" . number_format($rData['debet']) . "</td>
                <td align=right style='width:100px;'>" . number_format($rData['kredit']) . "</td>
				<td style='width:100px;'>" . $nmorg[substr($rData['kodeblok'],0,6)] . "</td>
                <td style='width:100px;'>" . $nmorg[$rData['kodeblok']] . "</td>
                <td style='width:100px;'>" . $rData['kodevhc'] . "</td>

        </tr>";
            $totalDebet+=$rData['debet'];
            $totalKredit+=$rData['kredit'];
        }
        $tab.="<tr class=rowcontent ><td colspan='2' align=center bgcolor=#80FFFE>Total</td><td bgcolor=#80FFFE><td bgcolor=#80FFFE><td bgcolor=#80FFFE><td bgcolor=#80FFFE><td bgcolor=#80FFFE><td align=right bgcolor=#80FFFE>" . number_format($totalDebet, 2) . "</td><td align=right bgcolor=#80FFFE>" . number_format($totalDebet, 2) . "</td><td bgcolor=#80FFFE><td bgcolor=#80FFFE><td bgcolor=#80FFFE></tr>";
        $tab.="</tbody></table>";
        echo $tab;
        break;
    ...
    case'pdf':
        ...
        class PDF extends FPDF {
            ...
            function Header() {
                ...
                $this->Cell(7 / 100 * $width, $height, $_SESSION['lang']['mesin'], 1, 0, 'C', 1);
    ...
    case'excel':
        ...
        <tr>
				...
				<td bgcolor=#DEDEDE align=center>" . $_SESSION['lang']['station'] . "</td>
        ...
        $where = " tanggal like '%" . $periode . "%' and noreferensi like '%" . $kdGudang . "%' 
                and noreferensi in(select distinct notransaksi from " . $dbname . ".log_transaksi_vw where tipetransaksi=5 and kodegudang='" . $kdGudang . "' and kodeorg='" . substr($kdGudang, 0, 4) . "')";

        $sData = "select nojurnal,tanggal,noreferensi,keterangan,noakun,debet,kredit,kodeblok,kodevhc,kodekegiatan from " . $dbname . ".keu_jurnaldt_vw 
            where " . $where . "";
		$qData=$owlPDO->query($sData) or die(print " Gagal: ".PDOException::getMessage());
		$qData->setFetchMode(PDO::FETCH_ASSOC);
        $no = $totalDebet = $totalKredit = 0;
        while ($rData = $qData->fetch()) {
            ...
            $tab.="<tr class=rowcontent>
				...
				<td>" . $nmorg[substr($rData['kodeblok'],0,6)] . "</td>
                <td>" . $nmorg[$rData['kodeblok']] . "</td>
                <td>" . $rData['kodevhc'] . "</td>
