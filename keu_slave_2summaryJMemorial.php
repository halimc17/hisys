...
// $title2="Summary Memorial Journal<br>";
// $title2.="".$unit." - ".$nmorg[$unit]."<br>";
// $title2.="".$param['periode']."<br><br>";

$table ="Summary Memorial Journal<br>";
if(is_array($unit)){
	$unit 	= 'Seluruh Unit';
	$table.="".$unit."<br>";
}else{
	...
	$unit = $unit;
	$table.="".$unit." - ".$nmorg[$unit]."<br>";
}
$table.="".$param['periode']."<br><br>";
...
switch($proses) {
    ...
    case 'pdf':
        ...
        $pdf->SetFont('Arial','',9);
        // $pdf->Cell(20,10,'Laporan Ringkasan Jurnal Memorial',0,1,'L');
        // $pdf->Ln();
        // $pdf->Cell(20,10,$unit." - ".$nmorg[$unit],0,1,'L');
        // $pdf->Ln();
        // $pdf->Cell(20,10,$param['periode'],0,1,'L');
        // $pdf->Ln();
        foreach($data as $key=>$row) {    
            $i=0;
            foreach($row as $cont) {
