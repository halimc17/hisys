...
<script language=javascript src='js/sdm_2upahpremi_panenrawat.js?v=<?php echo time(); ?>'></script>

<?php

OPEN_BOX('','<span class=judul>'.getMenu('sdm_2upahpremi_panenrawat').'</span><br>');
