...
<script language=javascript1.2 src='js/pmn_spk_spp.js?v=<?php echo time(); ?>'></script>
...
$optbuyer = $optpelayaran = $optfranco = $optttd = $optsurveyor = $optbarang = $optkapal = $optponton = "<option value=''>" . $_SESSION['lang']['pilihdata'] . "</option>";
...
echo "<table border=0 cellpadding=1 cellspacing=1>
				...
				<tr>
					...
					<td>" . $_SESSION['lang']['tanggalpakai'] . "</td>
					<td>:</td>		
					<td>
						<input type=text class=myinputtext readonly id=tanggalberlaku size=12 onmousemove=setCalendar(this.id) maxlength=10 onkeypress=\"return false;\" style=\"width:150px;\">
					</td>
				...
				<tr>
					...
					<td>:</td>		
					<td><select id=namakapal style=\"width:154px;\">'" . $optkapal . "'</select>
				...
				<tr>
					...
					<td>:</td>		
					<td>
						<input type=text id=tarifkapal  onkeyup=\"z.numberFormat('tarifkapal');\" onkeypress=\"return_angka_doang(event)\"  class=myinputtextnumber style=\"width:150px;\">
					</td>
					...
					<td>:</td>		
					<td>
						<input type=text id=tarifponton onkeyup=\"z.numberFormat('tarifponton');\" onkeypress=\"return_angka_doang(event)\"  class=myinputtextnumber style=\"width:150px;\">
					</td>
