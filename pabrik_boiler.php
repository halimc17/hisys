...
<script language="javascript" src="js/pabrik_boiler.js?v=<?php echo time(); ?>"></script>
<?
OPEN_BOX('','<span class=judul>'.getMenu('pabrik_boiler').'</span>');
?>
...
<div id="action_list">
    ...
    $str="select jenis,nama from ".$dbname.".pabrik_5bfwtjenis";
  ...
  echo"
    <fieldset style=\"float:left\">
        ...
        <table cellspacing=\"1\" border=\"0\">
            ...
            <tr><td style=\"width:50px;\">".$_SESSION['lang']['jenis']."</td><td>:</td>
             <td><select id=\"jenis\" name=\"jenis\" style=\"width:150px;\" onchange=getTable() >".$optjns."</select></td></tr>";
