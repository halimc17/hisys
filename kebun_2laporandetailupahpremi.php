...
<script language=javascript src='js/kebun_2laporandetailupahpremi.js?v=<?php echo time(); ?>'></script>

<?php

OPEN_BOX('','<span class=judul>'.getMenu('kebun_2laporandetailupahpremi').'</span><br>');
...
<table  cellpadding=5 cellspacing=1 border=0 style='font-weight:bold'>
	<tr >
		...
		<td style='background-color:#d1e3fa !important; color:black;border:unset !important'>: Jumlah HK lebih dari 1</td>
	</tr>
	<tr>
		<td colspan=3 style='background-color:#d1e3fa !important; color:black;border:unset !important'><br> <i>* Rupiah dapat di klik untuk mengatahui sumber transaksi</i></td>
	</tr>
</table>
</div>
</fieldset> ";
