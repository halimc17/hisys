...
$str="select periode from ".$dbname.".sdm_5periodegaji where kodeorg='".$_SESSION['empl']['lokasitugas']."' and jenisgaji='H' and sudahproses=0
...
echo open_body();
?>
<script languange=javascript1.2 src='js/sdm_prosesgjharian.js?v=<?php echo time();?>'></script>
<link rel=stylesheet type=text/css href='style/zTable.css'>
<?php
include('master_mainMenu.php');

//OPEN_BOX('','<span class=judul>'.strtoupper($_SESSION['lang']['prosesgjharian']).'</span><br>');
OPEN_BOX('','<span class=judul>'.getMenu('sdm_3prosesgjharian').'</span><br>');
echo $form;
CLOSE_BOX();
