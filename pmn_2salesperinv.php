...
?>
<script language=javascript src=js/pmn_2salesperinv.js?v=<?php echo time(); ?>></script>
<script language="javascript" src="js/zSelect2.js?v=<?php echo time(); ?>"></script>
<?

include('master_mainMenu.php'); 
OPEN_BOX('','<span class=judul>'.getMenu('pmn_2salesperinv').'</span><br>');
...
OPEN_BOX('','');
echo"<fieldset> 
	 <div id=container style='width:100%;height:800px;overflow:auto;'>
</div>";
CLOSE_BOX();
close_body();
