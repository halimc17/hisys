...
$qKbnLr = $owlPDO->query($sKbnLr) or die(print " Gagal: " . PDOException::getMessage());
$qKbnLr->setFetchMode(PDO::FETCH_ASSOC);
while ($rKbnLr = $qKbnLr->fetch()) {
...
$qKbnLr2 = $owlPDO->query($sKbnLr2) or die(print " Gagal: " . PDOException::getMessage());
$qKbnLr2->setFetchMode(PDO::FETCH_ASSOC);
while ($rKbnLr2 = $qKbnLr2->fetch()) {
...
$qSisip = $owlPDO->query($sSisip) or die(print " Gagal: " . PDOException::getMessage());
$qSisip->setFetchMode(PDO::FETCH_ASSOC);
while ($rSisip = $qSisip->fetch()) {
