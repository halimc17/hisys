...
if($_SESSION['empl']['tipelokasitugas']=='HOLDING')
{
  $str1="select * from ".$dbname.".datakaryawan
      where ((tanggalkeluar='0000-00-00') or tanggalkeluar>='".date('Y')."-01-01"."')
          and tipekaryawan!=0 and statuskaryawan != 'Keluar' and lokasitugas='".$_SESSION['empl']['lokasitugas']."'
...
else
{
   $str1="select * from ".$dbname.".datakaryawan
      where ((tanggalkeluar='0000-00-00') or tanggalkeluar>='".date('Y')."-01-01"."')
          and tipekaryawan!=0 and statuskaryawan != 'Keluar' and LEFT(lokasitugas,4)='".substr($_SESSION['empl']['lokasitugas'],0,4)."'
          order by namakaryawan";	
}
