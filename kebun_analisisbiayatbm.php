...
OPEN_BOX('', '<span class=judul>' . getMenu('kebun_analisisbiayatbm') . '</span><br>');
...
<script language=javascript src=js/kebun_analisisbiayatbm.js></script>
...
<button onclick=\"if(getValue('kodeorg')==''){alert('Unit harus dipilih');}else if(getValue('periode')==''){alert('Periode harus dipilih');}else{zPreview('kebun_slave_analisisbiayatbm','".$arr."','printContainer2');showheader();}\" class=\"mybutton\" name=\"preview\" id=\"preview\">".$_SESSION['lang']['preview']."</button>

<button onclick=\"if(getValue('kodeorg')==''){alert('Unit harus dipilih');}else if(getValue('periode')==''){alert('Periode harus dipilih');}else{zExcel(event,'kebun_slave_analisisbiayatbm.php','".$arr."')}\" class=\"mybutton\" name=\"excel2\" id=\"excel2\">".$_SESSION['lang']['excel']."</button>
...
function getDivisi() {
    ...
    var tujuan = 'kebun_slave_analisisbiayatbm.php';
