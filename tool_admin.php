	...
	<tr>
		<td valign=top>
			...
			<table>
				...
				<tr>
					<td></td>
					<td><button class=mybutton id=tmblDt onclick=saveFranco('tool_slave_admin','" . $arr . "')>" . $_SESSION['lang']['proses'] . "</button></td>
				</tr>
			</table>
...
$frm[0] .= "<fieldset hidden><legend>Unposting Pengakuan Penjualan</legend>
	<table>
	<tr>
...
if ($_SESSION['empl']['bagian'] == "IT") {
	$frm[0] .= "<fieldset style=width:350px;float:left; hidden>
...
// OPEN_BOX('','<span class=judul>'.strtoupper('Admin Tool').'</span>');
OPEN_BOX('', '<span class=judul>' . getMenu('tool_admin') . '</span>');
$frm[0] .= "<fieldset style=float:left;><legend>" . $_SESSION['lang']['list'] . "</legend><div id=container>";
