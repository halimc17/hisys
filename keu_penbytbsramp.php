...
<script language=javascript1.2 src='js/keu_penbytbsramp.js'></script>
...
<table cellspacing=1 border=0>
    <tr>
        <td>".$_SESSION['lang']['tanggal']."</td>
        <td>:</td>
        <td><input style=\"width:145px;\" type='text' class='myinputtext' id='tgl' readonly onmousemove='setCalendar(this.id)' onkeypress='return false;' onchange='gethargarata()' size='10' maxlength='10' style=width:70px; /></td>
    </tr>
     <tr>
    ...
    <tr>
        ...
        <td>:</td>
        <td><select id=suppId style=\"width:150px;\" onchange='gethargarata()'>'".$optunit."'</select></td>
    </tr>
	<tr>
        <td>".$_SESSION['lang']['harga']."/".$_SESSION['lang']['kg']." </td>
        <td>:</td>
        <td><input type=text class=myinputtextnumber onkeypress='return angka_doang(event)'  style=\"width:150px;\" id=hrgkgAll value=0 disabled></td>
    </tr>
