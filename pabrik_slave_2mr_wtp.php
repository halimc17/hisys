...
$str="select * from ".$dbname.".pabrik_5mr_wtp";
...
$str="select * from ".$dbname.".pabrik_mr_wtp where 
...
$str="select * from ".$dbname.".log_transaksi_vw where untukunit='".$unit."' and 
		kodeblok like '".$unit."15%' and tanggal between '".$tgl1."' and '".$tgl2."' 
...
$stream.="<tr>";
	...
	$stream.="<td align=center rowspan=2 align=center>".$_SESSION['lang']['tanggal']."</td>";
	$stream.="<td align=center colspan='".$spanbrg."' align=center>CHEMICAL USAGE (Kg)---EXTERNAL TREATMENT</td>";
	$stream.="<td align=center rowspan=2 align=center>Volume Air<br>(m3)</td>";
$stream.="</tr>";
