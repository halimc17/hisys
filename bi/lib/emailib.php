...
$urlerpweb = "";
// remove baris Surya/Dipa 20220103
// $urlerpweb = "<i style='font-size:10pt'><a href='http://10.1.1.57/owl/'>OWL Plantation System</a> from office network
// 	<br>
// 	Or
// 	<br>
// 	<a href='http://owl.ksp-agro.com/'>OWL Plantation System</a> from public network.</i>";

function onlynotifemailpr($nopp,$status,$user_id){
	global $dbname;
	global $owlPDO;
	global $urlerpweb;
	...
	switch($status){
		case'1':
			$msgdt = $tipepp." dengan No ".$nopp." dalam proses approval";
			createnotif($nopp,'APR',$msgdt,$user_id,date('Y-m-d H:i:s'));
					
			$subject="[Notifikasi] Pemberitahuan ".$tipepp." a/n ".$dibuat;
			$body="Dear Bapak/Ibu,
				<br>
				<br>
				Dengan email ini diberitahukan bahwa terdapat ".$tipepp." yang sedang dalam proses approval. Berikut adalah daftar dari ".$tipepp." tersebut:
				<br>
				<br>
				...
				<br>
				<br>
				Email ini hanya bersifat pemberitahuan / notifikasi, tidak ada tindakan yang perlu anda lakukan.
				<br>
				<br>
				...
				OWL System<br><br>
				Notes :<br>
				1. Email ini dikirim secara otomatis oleh<br>
	...
	switch($status){
		...
		case'2':
			...
			$body="Dear Bapak/Ibu,
				...
				// remove baris ini Surya/Dipa 20220103
				// <br>
				// <br>
				// Untuk menindaklanjuti silahkan klik link berikut:
				// <br>
