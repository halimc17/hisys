...
if($_SESSION['language']=='EN'){
    OPEN_BOX('','<span class=judul>'.strtoupper('ADDITIONAL BUDGET REQUEST:').'</span>');
}else{
     OPEN_BOX('','<span class=judul>'.strtoupper('PERMINTAAN TAMBAHAN ANGGARAN:').'</span>');
}
...
$sAkun="select distinct  noakun,".$dd." from ".$dbname.".keu_5akun where detail=1 and left(noakun,3) in ('631','611','621','126') order by noakun asc";
