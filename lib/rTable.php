...
class rTable {
	...
	$theTable .= "<table id='".$this->_id."' class='sortable' cellspacing='1' cellpadding='5' ".
	    "style='width:100%' border='0'>";
	
	# Header
	$theTable .= "<thead><tr class='rowheader'>";
	foreach($this->_headers as $key=>$head) {
	    $theTable .= "<th align='center' style='width:".$this->_width[$key]."%'>".$head."</th>";
	}
	if(!empty($this->_actions)) {
	    $theTable .= "<th align='center' style='width:10%' colspan='".count($this->_actions)."'>".$_SESSION['lang']['action']."</th>";
	}
	$theTable .= "</tr></thead>";
	...
	if(empty($this->_content)) {
		...
		foreach($this->_actions as $act) {
			...
			$theTable .= "<td align='center'><img src='".$act->_altImg."' class='zImgOffBtn'";
		    } elseif(isset($row['noAction'])) {
			$theTable .= "<td align='center'><";
		    } elseif($mytest==false) {
			$theTable .= "<td align='center'><";
		    }else {
			$theTable .= "<td align='center'><img src='".$act->_img."' class='zImgBtn'".
