...
switch ($method) {
	...
	case'printpdf':
		...
		$tab.="<table width=100% style='font-size:12px' cellpadding=".$cellpadding.">";
			...
			$tab.="</tr>";
			$tab.="<tr>";
				$tab.="<td>Perusahaan Pelayaran ".$transportirnama[$transportirdarat]."</td>"; 
			$tab.="</tr>";
			$tab.="<tr>";
				$tab.="<td>di</td>"; 
			$tab.="</tr>";
		...
		$tab.="<table width=100% style='font-size:12px' cellpadding=".$cellpadding.">";
			$tab.="<tr>";
				$tab.="<td>Dengan ini kami meminta kepada Bapak agar dapat mengirimkan truck untuk pemuatan kargo seperti tercantum dibawah ini :</td>"; 
			$tab.="</tr>";
		$tab.="</table>";
		...
		$tab.="<table cellpadding=".$cellpadding." cellspacing=0 style='font-size:12px;' width=100% border=0>";
			...
			$no++;
			$tab.="<tr>";
				$tab.="<td style='width:25px;border-top:0.5px solid #000000;border-left:0.5px solid #000000;border-bottom:0.5px solid #000000;' align=center>".$no.".</td>"; 
				$tab.="<td style='width:100px;border-top:0.5px solid #000000;border-bottom:0.5px solid #000000;'>Nama Pengirim</td>"; 
				$tab.="<td style='width:25px;border-top:0.5px solid #000000;border-bottom:0.5px solid #000000;' align=center>:</td>"; 
				$tab.="<td style='width:350px;border:1px solid #000000;'>".$nmpt[$kodept]."</td>"; 
			$tab.="</tr>";
		...
		$tab.="<table width=100% style='font-size:12px' cellpadding=".$cellpadding.">";
			$tab.="<tr>";
				$tab.="<td colspan=3>Demikianlah pemberitahuan ini kami buat agar diperginakan sebagaimana layaknya.</td>"; 
			$tab.="</tr>";
	...
	case 'insert':
		...
		$str = "insert into  ".$dbname.".".$table." 
				...
				`transportirdarat`, `harga`, `lain`,`debet`,`rpkg`,`toleransi`,`kgtoleransi`,`noakundebet`,
				...
				'".$pelabuhanmuat."','".$pelabuhantujuan."','".$tanggalmuat1."','".$tanggalmuat2."','".$namakapal."','".$namaponton."',
				'".$tandatangan1."','".$tandatangan2."','".$rupiah."','".$kota."',
				'".$transportirdarat."','".$harga."','".$lain."','".$debet."','".$rpkg."','".$toleransi."','".$kgtoleransi."','".$noakun."',
   ...
   case'loaddata':
        ...
        while ($bar = $res->fetch()){
			...
			$tab.="<tr class=rowcontent style=vertical-align:top>";
				...
				$tab.="<td valign=top>".number_format($bar['rupiah'],2)."<br><br>".$bar['harga']."</td>";
	...
	case'getEditData':
		...
		echo $bar['kodept']."###".tanggalnormal($bar['tanggalkontrak'])."###".$bar['kodecustomer']."###".$bar['kodebarang']."###".$bar['nospk']."###".
			...
			$bar['harga']."###".$bar['lain']."###".$bar['tandatangan2']."###".$bar['debet']."###".$bar['rpkg']."###".$bar['toleransi']."###".$bar['kgtoleransi']."###".$bar['noakundebet'];
	break;
