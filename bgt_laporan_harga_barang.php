...
OPEN_BOX('','<span class=judul>'.getMenu('bgt_laporan_harga_barang').'</span><br>');
//tab0
$frm[0]="<fieldset id=tab0><legend>Per ".$_SESSION['lang']['kelompokbarang']."</legend>";
$frm[0].="<table cellspacing=1 border=0>
    <tr><td>".$_SESSION['lang']['budgetyear']."</td><td>:</td><td>
        <select class=select2 id=tahunbudget0 name=tahunbudget0 style='width:175px;'><option value=''>".$_SESSION['lang']['pilihdata']."</option>".$opttahunbudget0."</select></td></tr>
    <tr><td>".$_SESSION['lang']['regional']." </td><td>:</td><td>
        <select class=select2 id=regional0 name=regional0 style='width:175px;'><option value=''>".$_SESSION['lang']['pilihdata']."</option>".$optregional0."</select></td></tr>
    <tr><td>".$_SESSION['lang']['kelompokbarang']." </td><td>:</td><td>
        <select class=select2 id=kelompokbarang0 name=kelompokbarang0 style='width:175px;'><option value=''>".$_SESSION['lang']['all']."</option>".$optkelompokbarang0."</select></td></tr>
    <tr>
		<td></td>
		<td></td>
		<td colspan=3>
        <button class=mybutton id=proses0 name=proses0 onclick=proses0()>".$_SESSION['lang']['preview']."</button>
...
$frm[1].="<table cellspacing=1 border=0>
    <tr><td>".$_SESSION['lang']['budgetyear']."</td><td>:</td><td>
        <select class=select2 id=tahunbudget1 name=tahunbudget1 style='width:175px;'><option value=''>".$_SESSION['lang']['pilihdata']."</option>".$opttahunbudget0."</select></td></tr>
    <tr><td>".$_SESSION['lang']['regional']." </td><td>:</td><td>
        <select class=select2 id=regional1 name=regional1 style='width:175px;'><option value=''>".$_SESSION['lang']['pilihdata']."</option>".$optregional0."</select></td></tr>
    <tr><td>".$_SESSION['lang']['namabarang']." </td><td>:</td><td>
        <input type=text class=myinputtext id=namabarang1 name=namabarang1 maxlength=10 style=width:170px;/>
    <tr><td></td>
		<td></td>
		<td colspan=3>
        <button class=mybutton id=proses1 name=proses1 onclick=proses1()>".$_SESSION['lang']['preview']."</button>
