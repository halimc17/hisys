...
<script language=javascript1.2 src='js/sdm_5tahunpensiun.js'></script>

<?php
OPEN_BOX('','<span class=judul>'.getMenu('sdm_5tahunpensiun').'</span>');
    ...
    echo"<legend>".$_SESSION['lang']['form']."</legend>";
        echo"<table border=0 cellpadding=1 cellspacing=1>
                <tr>
                    ...
                    <td>:</td>
                   <td><input type=text  id=tahun onkeypress=\"return angka_doang(event)\"  class=myinputtextnumber maxlength=4 style=\"width:150px;\"></td>
                </tr>
                <tr>
                    <td>".$_SESSION['lang']['usiapensiun']."</td> 
                    <td>:</td>
                    <td><input type=text  id=usiapensiun onkeypress=\"return angka_doang(event)\"  class=myinputtextnumber maxlength=2 style=\"width:150px;\"></td>
                </tr>
                <tr>
                    <td colspan=2></td>
                    <td>
...
echo"<td align=center>".$_SESSION['lang']['nourut']."</td>
     ...
     <td align=center>".$_SESSION['lang']['usiapensiun']."</td>
