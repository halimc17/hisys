...
<script language=javascript src='js/sdm_2estimasigaji_v2.js?v=<?php echo time(); ?>'></script>

<?php


OPEN_BOX('', '<span class=judul>' . getMenu('sdm_2estimasigaji_v2') . '</span><br>');
...
<fieldset style=float:left>
	<table cellspacing=1 cellpadding=2>
		...
		<tr>
			<td id=idtgl>Dari " . $_SESSION['lang']['tanggal'] . "</td>
                    <td>:</td>
                    <td>
						...
						Sampai
						<input type='text' class='myinputtext' id='tglakhir' onmousemove='setCalendar(this.id)' onkeypress='return false;'  maxlength='10' style='width:77px;' value='" . date('d-m-Y') . "'  readonly/>
					</td>
		</tr>
		<tr>
			<td colspan=2></td>
