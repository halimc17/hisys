...
$str=$owlPDO->query("select karyawanid,namakaryawan, lokasitugas,nik from ".$dbname.".datakaryawan 
...
echo"<fieldset>
     <legend><img src='images/user.png' height=40px style='vertical-align:middle;'><b>".$_SESSION['lang']['addnewuser'].":</b></legend> 
