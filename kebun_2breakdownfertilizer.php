...
OPEN_BOX('','<span class=judul>'.getMenu('kebun_2breakdownfertilizer').'</span><br>');
?>
<script language=javascript src=js/zTools.js></script>
<script language=javascript src='js/zReport.js'></script>
<script language=javascript src='js/option.js?v=<?php echo time(); ?>'></script>
<script language=javascript src='js/kebun_2breakdownfertilizer.js?v=<?php echo time(); ?>'></script>
...
$optsts="<option value=''>".$_SESSION['lang']['all']."</option>";
foreach($arrs as $res => $bar){
	@$optsts.="<option value=".$res.">".$bar."</option>";
}


$arr1 = "##pt##kdorg##prd##divisi##tt##ip##kolomhide##barishide##jenis##status";
        ...
        <legend>Form</legend>
            <table border=0 cellpadding=1 cellspacing=1>
				...
				<tr>
                    ...
                    <td>:</td>
                    <td><select id=status style=\"width:164px;\">" . $optsts . "</select></td>
                </tr>
                ...
                <tr>
                    <td colspan=2></td>
                    <td colspan=4>
                    <button onclick=zPreview('kebun_slave_2breakdownfertilizer','" . $arr1 . "','printContainer');showdetail(); class=mybutton name=preview id=preview>" . $_SESSION['lang']['preview'] . "</button>
                    <button onclick=zExcel(event,'kebun_slave_2breakdownfertilizer.php','" . $arr1 . "') class=mybutton name=preview id=preview>" . $_SESSION['lang']['excel'] . "</button>
                    </td>
                </tr>
