...
// kamus akun
$sakun=$owlPDO->query("select noakun, namaakun from ".$dbname.".keu_5akun where noakun like '12%'");
...
$ssumber=$owlPDO->query("select a.nojurnal, substr(a.tanggal,1,7) as periode, a.noakun, a.noreferensi, a.jumlah, a.kodebarang, b.tipetransaksi, b.notransaksireferensi, b.kodegudang, b.gudangx from ".$dbname.".keu_jurnaldt a
