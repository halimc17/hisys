...
<script language=javascript1.2 src='js/kebun_2biayadetail.js'></script>
...
$optDiv="";
$optorg=$optper="";
$optorg=$optDiv=$optTt="<option value=''>".$_SESSION['lang']['pilihdata']."</option>";
...
OPEN_BOX('','<span class=judul>'.getMenu('kebun_2biayadetail').'</span><br>');
        ...
        <legend>Form</legend>
            <table border=0 cellpadding=1 cellspacing=1>
                ...
                <tr>
                    ...
                    <td>:</td>
                    <td>
                        <select id=per2 style=\"width:159px;\">" . $optper . "</select>
                    </td>
                </tr> 
                <tr>
				<td colspan=2></td>
