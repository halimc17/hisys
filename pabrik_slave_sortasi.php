...
if($_SESSION['language']=='EN'){
    ...
    $zz='keterangan';
        ...
        //echo "warning:".$sTim;exit();
                ...
                $qNotiket=$owlPDO->query($ql2) or die(print " Gagal: ".PDOException::getMessage());
                ...
                foreach ($kdFraksi as $rt =>$isi)
                {
                    ...
                    if($rCek<1)
                    {
                            ...
                            try{
                                ...
                                $qCek=$owlPDO->query($sCekDt) or die(print " Gagal: ".PDOException::getMessage());
                                $qCek->setFetchMode(PDO::FETCH_ASSOC);
                                $rCekDt=$qCekDt->fetch();
        ...
        //echo "warning:".$sTim;exit();
               ...
               // $brs=count($rHead);
                ...
                $table .="<td align=right id=fraksi_".$a." value=".$isi2['kode'].">
                    <input type=text class=myinputtextnumber style='width:65px;' id=inputan_".$a." name=frak".$isi2['kode']." onkeypress=\"return angka_doang(event)\" size=\"10\" maxlength=\"4\" value=0 onblur=hitungPotongan(this.value,'".$isi2['kode']."',".owlBaris($zd).")></td>";
                }
                $table.="<td><input type=text class=myinputtextnumber style='width:65px;' id=persenBrnd  onkeypress=\"return angka_doang(event)\" size=\"10\" maxlength=\"4\" value=0  onblur=hitungPotongan(this.value,'BRD',".owlBaris($zd).")></td>";
               ...
               // echo "warning:".$sTim."__".$tgl;exit();
                ...
                foreach($rHead as $row2 =>$isi2)
                {
                   ...
                   $table .="<td align=right id=fraksi_".$a." value=".$isi2['kode'].">
                    <input type=text class=myinputtextnumber style='width:65px;' id=inputan_".$a." onkeypress=\"return angka_doang(event)\" size=\"10\" maxlength=\"4\" value=".$listData[$isi2['kode']]." onblur=hitungPotongan(this.value,'".$isi2['kode']."',".owlBaris($zd).")></td>";
                }
                $table.="<td><input type=text class=myinputtextnumber style='width:65px;' id=persenBrnd  onkeypress=\"return angka_doang(event)\" size=\"10\" maxlength=\"4\" value='".$rJjg['persenBrondolan']."'  onblur=hitungPotongan(this.value,'BRD',".owlBaris($zd).")></td>";
