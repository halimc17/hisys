...
OPEN_BOX('','<span class=judul>'.strtoupper('MEETING ROOM RESERVATION').'</span>');
...
if($_SESSION['language']=='EN'){
   $note="If there is a more important purpose in the use of meeting rooms, and a meeting room had already been booked by someone else,
        please negotiate with PIC concerned to do the 'Cancelation'";
}else{
  $note="Jika ada keperluan yang lebih penting dalam penggunaan ruang rapat, dan ruang rapat sudah dipesan oleh orang lain, 
silahkan negosiasi dengan PIC bersangkutan untuk melakukan 'Cancel'";
}
