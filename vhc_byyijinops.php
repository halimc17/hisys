...
<script language=javascript1.2 src='js/vhc_byyijinops.js'></script>
...
$sql = "SELECT distinct(kodeorg) as kodeorganisasi FROM " . $dbname . ".vhc_byyijinops";
...
OPEN_BOX('','<span class=judul>'.getMenu('vhc_byyijinops').'</span>');
		...
		<fieldset><legend>" . $_SESSION['lang']['find'] . "</legend> 
         <table>
			<tr>
				...
				<td>:</td>
				<td><select id=tglsch  style=\"width:100px;\">" . $optper . "</select>
				</td>
            </tr>";
...
<table cellspacing=1 border=0>
    ...
    <tr>
            ...
            <td>:</td>
            <td>
			<select id=tgl onchange=getnotransaksi() style='width:150px;'/>".$optper."</select>
			</td>
    </tr>
	<tr>
            ...
            <td>:</td>
            <td>
			<input id=notransaksi style='width:145px;' class='myinputtext' disabled/>
			</td>
    </tr>
	<tr>
            <td colspan=2></td>
