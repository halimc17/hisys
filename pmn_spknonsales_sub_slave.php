	...
	case'printpdf':
		...
		$tab.="<table cellpadding=".$cellpadding." cellspacing=0 style='font-size:12px;' width=100% border=0>";
			...
			$tab.="<tr>";
				...
				$tab.="<td align=center style='width:10px' valign=top>:</td>"; 
				$tab.="<td style='width:400px' valign=top>".nl2br($pengalihan)."</td>"; 
			$tab.="</tr>";
			
			$tab.="<tr>";
				$no++;
				$tab.="<td style='width:10px' align=center valign=top><b><b>".$no.".</td>"; 
				$tab.="<td><b>".$_SESSION['lang']['alamattibamuatan']."</td>";
