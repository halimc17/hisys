...
if($kdBudget!="")
{
        $where.=" and substr(kodebarang,1,3)='".$kdBudget."'";
}
$brdr=0;
...
if($proses=='excel')
{
    ...
    $tab.="
    <table>
    <tr><td colspan=17 align=cen><b><font size=5>".$_SESSION['lang']['bgtMaterial']."</font></b></td></tr>
...
if($pilMode=='0')
{
$sListData="select distinct tahunbudget,substr(kodeorg,1,4) as kodeorg,substr(kodebarang,1,3) as kelompokbarang,kodebarang,sum(fis01) as fis1,sum(fis02) as fis2,
            ...
            sum(fis10) as fis10,sum(fis11) as fis11,sum(fis12) as fis12,sum(jumlah) as jmlhStaon,satuanj from ".$dbname.".bgt_budget_detail where kodebarang!='' ".$where."
            group by kodebarang";
}
else
{
    $sListData="select distinct tahunbudget,substr(kodeorg,1,4) as kodeorg,substr(kodebarang,1,3) as kelompokbarang,kodebarang,sum(rp01) as fis1,sum(rp02) as fis2,
            sum(rp03) as fis3,sum(rp04) as fis4,sum(rp05) as fis5,sum(rp06) as fis6,sum(rp07) as fis7,sum(rp08) as fis8,sum(rp09) as fis9,
            sum(rp10) as fis10,sum(rp11) as fis11,sum(rp12) as fis12,sum(rupiah) as jmlhStaon,satuanj from ".$dbname.".bgt_budget_detail where kodebarang!='' ".$where."
            group by kodebarang";
}
...
if($cekData==0)
{
	...
	<tr>
		...
		<th ".$bgcoloraja.">".$_SESSION['lang']['jumlahsetahun']."</th>";
	foreach($arrBln as $listBulan)	
        {
            $tab.="<th ".$bgcoloraja.">".$listBulan."</th>";
        }
	$tab.="</tr>
	</thead>
	<tbody>";
