...
<script language=javascript1.2 src='js/keu_3hppolah.js'></script>
...
$els[] = array(
  ...
  makeElement('tanggal','tanggal','',array('style'=>'width:200px'))
);
...
# Form
OPEN_BOX('','<span class=judul>'.strtoupper(getMenu('keu_3hppolah')).'</span><br>');
echo genElTitle(strtoupper(getMenu('keu_3hppolah')),$els);
CLOSE_BOX();
