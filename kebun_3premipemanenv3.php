...
<script language=javascript src='js/kebun_3premipemanenv3.js?v=<?php echo time(); ?>'></script>
<?
...
OPEN_BOX('','<span class=judul>'.getMenu('kebun_3premipemanenv3').'</span><br>');
		...
		<fieldset><legend>" . $_SESSION['lang']['find'] . "</legend> 
         <table>
			<tr>
				...
				<td>:</td>
				<td><select id=unitlist onchange=loaddata(0) style='width:153px;'>".$optunit2."</select></td>
...
echo"<div class='table-scroll' id=contloaddata>    
		...
		<thead>
			...
			<th align=center rowspan=2>".$_SESSION['lang']['basic']." Kg</th>
			<th align=center colspan=2>".$_SESSION['lang']['premi']."</th>
			<th align=center colspan=2>".$_SESSION['lang']['brondol']."</th>
			<th align=center rowspan=2>Kehadiran</th>
			<th align=center rowspan=2>tambahan</th>
...
echo"<tr>
		...
		<button onclick=zExcel(event,'kebun_slave_3premipemanenv2.php','".$arr."') class=mybutton name=preview id=preview>".$_SESSION['lang']['excel']."</button>
...
echo"<br><table border=0 class=sortable cellspacing=1>
	<tr class=rowheader>
