...
$pt = checkPostGet('pt5', '');
$kdorg = checkPostGet('kdorg5', '');
$tahun  = checkPostGet('tahun50', '');
$tahun1 = checkPostGet('tahun51', '');
$tahun2 = checkPostGet('tahun52', '');
$tahun3 = checkPostGet('tahun53', '');
$bulan  = checkPostGet('bulan50', '');
$bulan1 = checkPostGet('bulan51', '');
$bulan2 = checkPostGet('bulan52', '');
$bulan3 = checkPostGet('bulan53', '');


$tahunsd1 = checkPostGet('tahunsd51', '');
$tahunsd2 = checkPostGet('tahunsd52', '');
$tahunsd3 = checkPostGet('tahunsd53', '');
$bulansd1 = checkPostGet('bulansd51', '');
$bulansd2 = checkPostGet('bulansd52', '');
$bulansd3 = checkPostGet('bulansd53', '');

$tahun4 = checkPostGet('tahun54', '');
$tahunsd4 = checkPostGet('tahunsd54', '');
$bulan4 = checkPostGet('bulan54', '');
$bulansd4 = checkPostGet('bulansd54', '');

$tahunytd = checkPostGet('tahunytd5', '');
$tahunsdytd = checkPostGet('tahunsdytd5', '');
$bulanytd = checkPostGet('bulanytd5', '');
$bulansdytd = checkPostGet('bulansdytd5', '');
...
if(!empty($dataArray))foreach($dataArray as $data){
    if($data['tipe']=='Header'){
		...
		$stream.="
		<tr class=rowcontent style=cursor:pointer title='Click untuk melihat detail' onclick=\"viewdetail('".$data['nourut']."','".$pt."','".$kdorg."','".$periode1."','".$periode2."','".$periode3."','".$periodesd1."','".$periodesd2."','".$periodesd3."','html','ga','".$periode4."','".$periodesd4."','".$periodeytd."','".$periodesdytd."');\">
			<td colspan=".strlen($data['nourut']).">&nbsp;</td>
		...
		$stream.="    
			...
			<td align=right width='150px;'>".@number_format($data['dataperiodeytd']+$data['sawalperiodeytd'],2)."</td>    
		</tr>";      		
	}
}
...
######PREVIEW
	...
	case'pdf':
		...
		$dompdf->render();
		$dompdf->stream("GA",array("Attachment"=>0));
	break;
######EXCEL	
    case 'excel':
        $tglSkrg = date("Ymd");
