...
$iPer="select distinct substr(tanggal,1,7) as periode from ".$dbname.".kebun_spbht
      where substr(tanggal,1,7)!='0000-00' order by substr(tanggal,1,7) desc limit 12";
...
echo"<ol>
    <li>Pastikan semua SPB sudah melakukan pengambilan kg pabrik</li>
    <li>Jika pada tanggal tidak ada angka / kosong, maka hari itu tidak ada pengiriman SPB atau belum diinputkan SPB-nya</li>
    <li>Jika pada tanggal muncul angka <b>0</b>, maka ada SPB belum dilakukan proses ambil Kg timbangan</li>
    ";
echo"</ol></fieldset>";
