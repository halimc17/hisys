...
switch($method){
	...
	case 'loaddata':
		...
		$str= "select * from ".$dbname.".sdm_5corevalues where jenis='man management' order by id asc";
		$res= fetchdata($str);
		foreach($res as $bar){
			@$no+=1;
					...
					<tr>
						...
						<td>
							<select class='select2' style='width:570px;' id=kriteria>
								...
								<option value='1'>Menyusun Activity Plan (Rencana Kerja)</option>
								<option value='2'>Mendelegasikan Pekerjaan</option>
								<option value='3'>Melakukan Monitoring dan Evaluasi</option>
								<option value='4'>Melakukan Coaching dan Counseling</option>
								<option value='5'>Melakukan Reward dan Development</option>
							</select>
						</td>
					</tr>
					<tr>
						...
						<td>
							<select class='select2' style='width:570px;' id=penilaian>
								<option value=''>".$_SESSION['lang']['pilihdata']."</option>
								<option value='100'>Istimewa (100)</option>
								<option value='80'>Baik Sekali (80)</option>
								<option value='60'>Baik (60)</option>
								<option value='40'>Cukup (40)</option>
								<option value='20'>Kurang (20)</option>
							</select>
						</td>
					</tr>
					<tr>
