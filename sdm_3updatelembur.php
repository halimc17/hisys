...
OPEN_BOX('','<span class=judul>'.getMenu('sdm_3updatelembur').'</span>');
?>
...
<tr><td><label>".$_SESSION['lang']['kodeorg']."</label></td><td>:</td><td><select id=\"kdOrg\" name=\"kdOrg\" style=\"width:150px\">".$optOrg."</select></td></tr>
    <td><label>".$_SESSION['lang']['tanggal']." Dari</label></td><td>:</td>
    <td><input type=\"text\" class=\"myinputtext\" id=\"tanggal1\" name=\"tanggal1\" onmousemove=\"setCalendar(this.id)\" onkeypress=\"return false;\"  maxlength=\"10\" style=\"width:145px;\" readonly/></td>
</tr>
<tr>
    <td><label>".$_SESSION['lang']['tanggal']." Sampai</label></td><td>:</td>
    <td><input type=\"text\" class=\"myinputtext\" id=\"tanggal2\" name=\"tanggal2\" onmousemove=\"setCalendar(this.id)\" onkeypress=\"return false;\"  maxlength=\"10\" style=\"width:145px;\" readonly/></td>
</tr>

<tr><td colspan=2></td><td colspan=\"2\"><button onclick=\"zPreview('sdm_slave_3updatelembur','".$arr."','printContainer')\" class=\"mybutton\" name=\"preview\" id=\"preview\">Preview</button></td></tr>
</table>
</fieldset>
</div>";
CLOSE_BOX();
