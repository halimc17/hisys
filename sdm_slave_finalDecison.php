...
switch($param['proses'])
{
	...
	echo"</tr></thead><tbody id=listData>"; 
        ...
        while($rdt=  $qdt->fetch()){
            ...
            $qdt2=$owlPDO2->query($sdt2) or die(print " Gagal: ".PDOException::getMessage());
            ...
            $qdt3=$owlPDO2->query($sdt3) or die(print " Gagal: ".PDOException::getMessage());
	...
	break;
        ...
        $qdert=$owlPDO->query($dert) or die(print " Gagal: ".PDOException::getMessage());
        $qdert->setFetchMode(PDO::FETCH_ASSOC);
        $rdert=$qdert->fetch();
...
class PDF extends FPDF
{
    ...
    $qdrTest=$owlPDO->query($sdrTest) or die(print " Gagal: ".PDOException::getMessage());
    $qdrTest->setFetchMode(PDO::FETCH_ASSOC);
    $rdrTest=$qdrTest->fetch();
