...
echo"<fieldset style='width:500px;'><table>
                <tr><td>".$_SESSION['lang']['kodeorg']."</td><td><select id=kodeorg style='width:200px;'><option value='".substr($_SESSION['empl']['lokasitugas'],0,4)."'>".substr($_SESSION['empl']['lokasitugas'],0,4)."</option></select></td></tr>
                <tr><td>".$_SESSION['lang']['tahun']."</td><td><input type=text style='width:200px;' id=tahun size=4 onkeypress=\"return angka_doang(event);\" class=myinputtextnumber maxlength=4 value=".date('Y')."></td></tr>
                <tr><td>".$_SESSION['lang']['kodekelompok']."</td><td><select style='width:200px;' id=kode>".$st."</option></select></td></tr>
                 <tr><td>".$_SESSION['lang']['jumlah']."</td><td><input type=text id=jumlah style='width:200px;' size=4 onkeypress=\"return angka_doang(event);\" class=myinputtextnumber maxlength=4 value=0>Kg</td></tr>
