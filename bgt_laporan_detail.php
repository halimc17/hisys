...
<?
OPEN_BOX('','<span class=judul>'.getMenu('bgt_laporan_detail').'</span><br>');
?>
<div>
...
<tr><td><label><?php echo $_SESSION['lang']['kodeorg']?></label></td><td><select class=select2 id='kdWS'  style="width:150px;"><?php echo $optOrg?></select></td></tr>
