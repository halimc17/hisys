...
<script language=javascript src='js/pmn_kontrakjual_v2.js?v=<?php echo time(); ?>'></script>
...
$sCust = "select kodecustomer,namacustomer  from " . $dbname . ".pmn_4customer WHERE 1=1 order by namacustomer";
...
echo "<div>"; //buka div
OPEN_BOX('', '<span class=judul>' . getMenu('pmn_kontrakjual_v2') . '</span>');
echo "<table>
     <tr valign=middle>
	 ...
	 <td><fieldset><legend>" . $_SESSION['lang']['find'] . " Data  . .</legend>";
echo "<table>";
echo "
