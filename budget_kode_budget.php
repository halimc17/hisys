...
OPEN_BOX('','<span class=judul>'.strtoupper('BUDGET: '.$_SESSION['lang']['kodeanggaran']).'</span>');
...
echo"<fieldset style='width:500px;'><table>
     <tr><td>".$_SESSION['lang']['kodeanggaran']."</td><td><input type='text' id='kode' style='width:150px' class=myinputtext onkeypress=\"return tanpa_kutip(event);\" maxlength=30 style='width:150px' /></td></tr>
