...
$qBi = $owlPDO->query($sBi) or die(print " Gagal: " . PDOException::getMessage());
$qBi->setFetchMode(PDO::FETCH_ASSOC);
while ($rBi = $qBi->fetch()) {
...
$qSBi = $owlPDO->query($sSBi) or die(print " Gagal: " . PDOException::getMessage());
$qSBi->setFetchMode(PDO::FETCH_ASSOC);
while ($rSBi = $qSBi->fetch()) {
