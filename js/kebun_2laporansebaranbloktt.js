...
function getunit() {
	...
	tujuan = 'kebun_2laporansebaranbloktt_slave.php';
...
function preview(tipe){
	...
	if(tipe=='excel'){
		...
		alertify.popuppdf("title","<iframe frameborder=0 style='width:100%;height:90%;overflow:none' src='kebun_2laporansebaranbloktt_slave.php?"+param+"'></iframe>").set({'resizable':true, 'overflow':false}).resizeTo('90%','80%');		
	} else{
