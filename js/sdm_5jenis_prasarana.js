...
function simpanJabatan() {
  idKlmpk =
    document.getElementById("idKlmpk").options[
      document.getElementById("idKlmpk").selectedIndex
    ].value;
  kodejabatan = document.getElementById("kodejabatan").value;
  namajabatan = document.getElementById("namajabatan").value;
  satuan = document.getElementById("satuan").value;
  statusbangunan = document.getElementById("statusbangunan").value;
...
function fillField(idklmk, kode, sat, nama, statusbangunan) {
  ...
  document.getElementById("statusbangunan").value = statusbangunan;
...
function cancelJabatan() {
  ...
  document.getElementById("statusbangunan").value = "";
