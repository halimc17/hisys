function lihatDetailNeraca(noakuna, noakuns, periode, tipe, pt, unit, ev, codeurut, kodelaporan) {
	...
	alertify.popup(title,"<iframe frameborder=0 style='width:100%;height:100%;overflow:none' src='keu_slave_2neraca_detail_v2.php?"+param+"'></iframe>").set({'resizable':true, 'overflow':false}).resizeTo('80%','70%');
}
...
function getLaporanBukuBesar(tipelaporan) {
	...
	param += '&regional=' + regional + '&tampilanId=' + tampilanId+ '&tipelaporan=' + tipelaporan;
...
function getLaporanJurnal(tipelaporan) {
	...
	param += '&kdKel=' + kdKel + '&ref=' + ref + '&ket=' + ket + '&nojurnal=' + nojurnal+ '&nik=' + nik+ '&tipelaporan=' + tipelaporan;
...
function getLaporanBukuBesar(tipelaporan) {
	...
	param = 'pt=' + ptV + '&gudang=' + gudangV + '&periode=' + periodeV + '&periode1=' + periodeV1 + '&revisi=' + revisi;
	param += '&regional=' + regional + '&tampilanId=' + tampilanId+ '&tipelaporan=' + tipelaporan+ '&tampilkan=' + tampilkan;
	...
	if(tampilkan=='1') {
		// tujuan = 'keu_slave_2bukubesar.php';
		tujuan = 'keu_2bukubesarnew_slave.php';
	} else {
		tujuan = 'keu_slave_2bukubesarrekap.php';
	}
	if (ptV == '') {
		alertify.alert("Informasi",'Field PT empty');
		return;
...
function getLaporanArusKas() {
	...
	param = 'pt=' + pt + '&gudang=' + gudang + '&periode=' + periode + '&proses=preview' + '&tanggal=' + tanggal;
...
function Excelaruskas(ev, tujuan) {
	...
	judul = 'Report Ms.Excel';
	param = 'pt=' + pt + '&gudang=' + gudang + '&periode=' + periode + '&proses=excel' + '&tanggal=' + tanggal;
...
function fisikKeExcel(ev, tujuan) {
	...
	judul = 'Report Ms.Excel';
	param = 'pt=' + pt + '&gudang=' + gudang + '&periode=' + periode + '&periode1=' + periode1 + '&revisi=' + revisi; //'&tampilanId='+tampilanId;
...
function lihatDetail(noakun, periode, periode1, lmperiode, pt, regional, gudang, revisi, ev) {
	...
	alertify.popup('Detail Jurnal',"<iframe frameborder=0 style='width:100%;height:100%;overflow:none' src='"+tujuan+"'></iframe>").set({'resizable':true, 'overflow':false}).resizeTo('80%','70%');
}
...
function lihatDetailHutang(kodesupplier, noakun, mulai, sampai, kodeorg, tipe, ev) {
	...
	alertify.popuppdf("PDF","<iframe frameborder=0 style='width:100%;height:90%;overflow:none' src='keu_slave_laporan_HutangPiutang.php?"+param+"'></iframe>").set({'resizable':true, 'overflow':false}).resizeTo('80%','70%');

}

function getPeriodeAkuntansi(tipe) {
...
// alert(tipe);
	param = 'kodept=' + kodeptV + '&kodeunit=' + kodeunitV+ '&tipe=' + tipe;
...
function getLaporanKeuanganLabaRugiv1_lg1() {
	pt = document.getElementById('pt');
	unit = document.getElementById('gudang');
	periode = document.getElementById('periode');
	pt = pt.options[pt.selectedIndex].value;
	...
	periode = periode.options[periode.selectedIndex].value;
	param = 'pt=' + pt + '&unit=' + unit + '&periode=' + periode;
	tujuan = 'keu_slave_2laporankeuanganLabaRugiv1_lg1.php';
	post_response_text(tujuan, param, respog);
...
function getLaporanKeuanganDetailv2_lg1(nourut, tipe, periode, darimana='lg1') {
	no_nourut='no_'+nourut;
	...
	param = 'pt=' + pt + '&unit=' + unit + '&periode=' + periode + '&nourut=' + nourut + '&tipe=' + tipe + '&darimana=' + darimana;
	tujuan = 'keu_slave_2laporankeuangan_detailv2.php';
