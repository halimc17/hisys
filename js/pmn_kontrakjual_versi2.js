...
function pdfpanjang(nokontrak) {
    ...
    alertify.popuppdf("title", "<iframe frameborder=0 style='width:100%;height:90%;overflow:none' src='pmn_kontrakjual_slave_versi2.php?" + param + "'></iframe>").set({ 'resizable': true, 'overflow': false }).resizeTo('90%', '80%');
}


function viewlistfile(nokontrak) {
    param = 'method=viewlistfile&nokontrak=' + trim(nokontrak);
    tujuan = 'pmn_kontrakjual_slave_versi2.php';
...
function submitfile() {
    ...
    con.open("POST", "pmn_kontrakjual_slave_versi2.php?method=submitfile", true);
...
function saveKP() {
    ...
    tpkontrak = document.getElementById('tpkontrak').value;
    /*detail barang*/
    ...
    param = 'noKntrk=' + noKntrk + '&noKtrk_M=' + noKtrk_M + '&custId=' + custid + '&tlgKntrk=' + tglkntr + '&tglberlaku=' + tglberlaku + '&tpkontrak=' + tpkontrak + '&kdBrg=' + kdbrg + '&noext=' + noext + '&millcode=' + millcode;
...
function form_ajukan(notransaksi) {
    ...
    let tujuan = "pmn_kontrakjual_slave_versi2.php";
