...
function tampilkanCatu(){
	...
	tkar=document.getElementById('tkar').value;
	
	if(tkar==''){
		alert('Lengkapi pengisian');return;
	}
	
    param='kodeorg='+kodeorg+'&periode='+periode+'&harga='+harga+'&tkar='+tkar+'&aksi=display';
...
function simpanCatu(){
    ...
    param='kodeorg='+kodeorg+'&periode='+periode+'&tkar='+tkar+'&harga='+harga+'&aksi=simpan';
    tujuan='sdm_slave_pembagianCatu.php';
    if(harga=='' || harga==0)
        {
            alert('Price can not be 0');
...
function replaceCatu(){
    ...
    param='kodeorg='+kodeorg+'&periode='+periode+'&tkar='+tkar+'&harga='+harga+'&aksi=replace';
    tujuan='sdm_slave_pembagianCatu.php';
    if(harga=='' || harga==0)
        {
            alert('Price can not be 0');
...
function getrp()
{
    ...
    param='kodeorg='+kodeorg+'&periode='+periode+'&aksi=getrp';
    tujuan='sdm_slave_pembagianCatu.php';    
