...
function html(tahun,kodeorg,namabarang) {
	...
	tujuan = 'budget_slave_5hargatbs_parameter.php';
...
function insertdetail() {
	...
	validate([
        ...
        ["jenisbudget","Jenis tidak boleh kosong."],
...
function editdetail(tahunbudget,kodebarang,kodeorg,tahuntanam,jumlah,jenisbudget){
	...
	setValue2('kodeorg',kodeorg);
	setValue2('namabarang',kodebarang);
	setValue2('jenisbudget',jenisbudget);
