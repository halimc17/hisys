...
function previewPJD(nosk,ev)
{
	...
	//tujuan = 'sdm_slave_printPJD_lpj_pdf.php?'+param;	
...
function saveApprvPJD(jenisby,notransaksi,tanggal,jumlah,no,detail)
{
	...
	{
			param ='notransaksi='+notransaksi+'&jenisby='+jenisby+'&detail='+detail; 
