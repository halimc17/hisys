...
function previewtr(ev, notransaksi, tipe) {
    ...
    param += '&tipe=' + tipe;
    tujuan = 'sdm_slave_uploadabsensihov2v2.php';
    if (tipe == 'html') {
...
function getsatuan() {
    ...
    tujuan = 'sdm_slave_uploadabsensihov2.php';
    post_response_text(tujuan, param, respog);
...
function simpan() {
    ...
    con.open("POST", "sdm_slave_uploadabsensihov2.php?method=" + method, true);
...
function edit(id) {
    param = "method=edit&notransaksi=" + id;
    tujuan = 'sdm_slave_uploadabsensihov2.php';
...
function deletedata(id) {
    param = "method=deletedata&notransaksi=" + id;
    tujuan = 'sdm_slave_uploadabsensihov2.php';
...
function postingdata(id) {
    param = "method=postingdata&notransaksi=" + id;
    tujuan = 'sdm_slave_uploadabsensihov2.php';
...
function ajukantr(notransaksi, ev) {
    ...
    post_response_text('sdm_slave_uploadabsensihov2.php', param, respon);
...
function submitfile(notransaksi) {
    ...
    busy_on();
    con.open("POST", "sdm_slave_uploadabsensihov2.php?method=submitfile", true);
    con.onreadystatechange = eval(respon);
    con.send(formdata);
    function respon() {
        if (con.readyState == 4) {
