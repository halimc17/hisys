...
function viewDetail(ev,kodevhc,unit,periode,periode1,tanggalmulai,tanggalsampai,noakunawal,noakunakhir)
{
   //event,'SKLE-BG01','','2017-04','2017-05','4110201','4110209','2017-04-01','2017-05-31')
   param='kodevhc='+kodevhc+'&unit='+unit+'&periode='+periode+'&periode1='+periode1+'&tanggalmulai='+tanggalmulai+'&tanggalsampai='+tanggalsampai;
   param+='&noakunawal='+noakunawal+'&noakunakhir='+noakunakhir;
   tujuan='vhc_slave_2biayarinciperkendaraandetail.php'+"?"+param;  
   width='800';
   height='400';
