...
function clearForm(){
    ...
    document.getElementById('nobaCr').value='';
}
...
function loadData(num){
    ...
    noba=document.getElementById('nobaCr').value;
    param = 'proses=loadNewData&page=' + num;
    param+='&jenis='+pilJns+'&notransaksi='+notransaksi;
    param+='&tgl='+tgl+'&nokontrak='+nokontrak+'&noba='+noba;
    tujuan = 'pabrik_slave_kirimkomoditi.php';
...
function excel(ev,kodeorg,periodegaji,tipepotongan)
{
        ...
        //alert(param);
        tujuan='pabrik_slave_kirimkomoditiExcel.php';
        judul='Print Excel';		
