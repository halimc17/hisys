function preview(tipe){
	...
	tipepph=document.getElementById('tipepph').value;
    istjpph21=0;
    ...
    param='proses=preview'+'&unit='+unit + '&per=' + per+ '&tipe=' + tipe+ '&istjpph21=' + istjpph21+ '&nilaitjpph21=' + nilaitjpph21+ '&tipepph=' + tipepph; 
    tujuan = 'sdm_slave_3prosespph21thrbonus.php';
...
function looppph(currRow,maxRow){
    ...
    param='per='+per+'&karyawanid='+karyawanid+'&unit='+unit+'&pph21x='+pph21x+'&baris='+currRow+'&tipepph='+tipepph;
