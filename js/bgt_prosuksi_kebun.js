...
function jumlahkan(e) {
	if(e=='a'){
		// jika yang di input bjr dan ton per ha
		...
		// jika yang di input adalah jjg dan kg
		jjg = document.getElementById('total').value;
		kg = document.getElementById('totalKg').value;
		luas = document.getElementById('luas').value;
		
		bjr = parseFloat(kg)/parseFloat(jjg);
		tonha = parseFloat(kg)/parseFloat(luas)/1000;
		if (isNaN(tonha)){tonha = 0;}
		if (isNaN(bjr)){bjr = 0;}
		
		document.getElementById('bjr').value = bjr;
		document.getElementById('jjg').value = tonha;
