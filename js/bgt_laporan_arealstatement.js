...
//   alert(what+tahun+kebun+tt);
   ...
   height='400';
	...
	alertify.popuppdf("PDF","<iframe frameborder=0 style='width:100%;height:90%;overflow:none' src='bgt_slave_laporan_arealstatement_detail.php?"+param+"'></iframe>").set({'resizable':true, 'overflow':false}).resizeTo('70%','70%');
