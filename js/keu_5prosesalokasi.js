...
function batalrincian(){
    document.getElementById('tipeDt').value='';   
    document.getElementById('nourut').value='';    
    document.getElementById('ketdata').value='';    
    document.getElementById('noakundt').value='';    
    document.getElementById('datadt').value='';    
    // document.getElementById('listdata').innerHTML=''; 
    // alert('masuk');
}
function batalviewdetailbaru(){
...
function saveData(){
    ...
    param  +='&kdHo='+unit+'&method='+method;
    param  +='&nmLaporan='+nmLaporan;
    tujuan  ='keu_slave_5prosesalokasi.php';
...
function detail(kodept,isinmLaporan){
...
// function detail1(isinmLaporan){
//     param='nmLaporan='+isinmLaporan+'&method=detail1';
//     tujuan='keu_slave_5prosesalokasi.php';
//     post_response_text(tujuan, param, respog);
//     function respog()
//     {
...
//                     document.getElementById('detail1').innerHTML = con.responseText;
//                     //loaddatadetail(nmLaporan);
//                 }
//             } else {
//                 busy_off();
...
function saveDetHead(){
    ...
    ketdata=trim(document.getElementById('ketdata').value);
    ...
    param='method=saveDetHead'+'&namaLaporanDt='+nmlap+'&nourut='+nourut+'&kdOrg='+kdOrg+'&tipeDt='+tipeDt+'&datadt='+datadt;
    param+='&ketdata='+ketdata+'&noakundt='+noakundt +'&colspandt='+colspandt+'&oldNourut='+oldNourut;
...
function editdet(nourut,ketDt,colspan,tipeDt,datadt,noakun){
    document.getElementById('nourut').disabled=true;
    // document.getElementById('noakundt').disabled=true;
    // document.getElementById('noakundt').disabled=true;
        ...
        if (con.readyState == 4)
        {
            if (con.status == 200)
            {
                ...
                if (!isSaveResponse(con.responseText))
                {
                    ...
                    detail(kdOrg,nmLaporan);
                    detail1(kdOrg,nmLaporan);
                }
            } else {
                busy_off();
                error_catch(con.status);
...
// function viewdetail1(kdOrg,nourut,nmLaporan){
//     titl="Detail Induk :"+nourut+",Nama Laporan :"+nmLaporan;
//     form(titl);
//     param='method=viewdetail1'+'&namaLaporanDt='+nmLaporan+'&nourut='+nourut+'&kdOrg='+kdOrg;
//     tujuan = 'keu_slave_5prosesalokasi.php';
//     post_response_text(tujuan, param, respog);
//     function respog()
//     {
