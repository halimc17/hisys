...
function editPJD(notran)
{
    param='notransaksi='+notran+'&method=getdata';
    tujuan = 'sdm_slave_pjdinastamu.php';
    post_response_text(tujuan, param, respog);		
...
{       
	...
	param='&page='+num+'&method=loadList';
    if(tex!='')
        param+='&tex='+tex;
	tujuan = 'sdm_slave_pjdinastamu.php';
	post_response_text(tujuan, param, respog);
...
function delPJD(nosk)
{
    param='notransaksi='+nosk+'&method=delete';
    tujuan='sdm_slave_pjdinastamu.php';
