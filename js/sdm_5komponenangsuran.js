function loaddata() {
    ...
    tujuan = 'sdm_slave_5komponenangsuran.php';
...
function editdata(jenis,kodeorg,kodeangsuran,jenisangsuran,komponen,stat){
	param  = '';
	param += '&mode=update';
	param += '&method=addnew';
		...
		if (con.readyState == 4) {
			if (con.status == 200) {
				...
				if (!isSaveResponse(con.responseText)) {
					...
					setValue2('komponen',komponen);
					setValue2('kodeangsuran',kodeangsuran);
					setValue2('jenisangsuran',jenisangsuran);
					setValue2('status',stat);
					setValue2('method','update');
					document.getElementById('kodeorg').disabled=true;
					document.getElementById('komponen').disabled=true;
					document.getElementById('kodeangsuran').disabled=true;
...
function simpan(){
	...
	kodeangsuran=document.getElementById('kodeangsuran').value;
	...
	validate([
        ["kodeorg",bahasa.kodeorg+" "+bahasa.kodeorg],
        ["kodeangsuran",bahasa.kodeangsuran+" "+bahasa.kodeangsuran],
        ["jenisangsuran",bahasa.jenisangsuran+" "+bahasa.jenisangsuran],
        ["komponen",bahasa.komponen+" "+bahasa.komponen]
	]);
	
	param  = '';
	param += '&kodeorg=' + kodeorg;
	param += '&kodeangsuran=' + kodeangsuran;
	param += '&jenisangsuran=' + jenisangsuran;
	param += '&komponen=' + komponen;
	param += '&status=' + stat;
	param += '&method=' + method;
