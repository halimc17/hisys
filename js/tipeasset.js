...
function simpanTipeAset()
{
        ...
        kodetipelama=document.getElementById('kodetipelama').value;
        ...
        {
                alertify.alert("Informasi",'Data inconsistent');
        ...
        else
        {
                ...
                param='kodetipe='+kodetipe+'&kodetipelama='+kodetipelama+'&namatipe='+namatipe+'&method='+met+'&tppenyusutan='+tpasset;
...
function fillField(kode,nama,nama1,noakun,noakunak,metodedep,kodetipelama)
{
        document.getElementById('kodetipe').value=kode;
        document.getElementById('kodetipe').disabled=true;
        document.getElementById('kodetipelama').value=kodetipelama;
