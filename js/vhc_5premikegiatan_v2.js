...
function loaddata() {
	...
	tujuan='vhc_slave_5premikegiatan_v2.php';
...
function editdata(jenis,pt,keg,basis,premilebihbasis,vhc,jenishari,jenisbasis,posisi,unit,statuspremi){
    param  = '';
	param += '&jenis=' + jenis;
	param += '&method=addnew';
...
function simpan(){
    ...
    param='pt='+pt+'&keg='+keg+'&vhc='+vhc;
	param+='&basis='+basis+'&premilebihbasis='+premilebihbasis+'&jenishari='+jenishari+'&jenisbasis='+jenisbasis+'&posisi='+posisi+'&unit='+unit;
    param+='&method='+method;
	if(statuspremi == true){
		statuspremi = 1;
	}else{
