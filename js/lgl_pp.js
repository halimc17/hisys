...
function edit(kodeorg, tanggal, notransaksi, kategori, namapemesan, lokasipemesan, tujuan, rekening,tipebayar,atasnama) {
...
function deletedetail(notransaksi, kodeorg, kategori, tujuan, deskripsi, tanggal) {
	param = 'method=deletedetail' + '&notransaksi=' + notransaksi + '&kodeorg=' + kodeorg + '&kategori=' + kategori + '&tujuan=' + tujuan + '&deskripsi=' + deskripsi + '&tanggal=' + tanggal;
	tujuan = 'lgl_slave_pp.php';
...
function detail() {
	...
	if (tanggal == '' || kodeorg == '' || notransaksi == '' || kategori == '' || namapemesan == '' || lokasipemesan == '' || tujuan == '') {
...
function submitfile() {
	...
	con.open("POST", "lgl_slave_pp.php?method=submitfile", true);
