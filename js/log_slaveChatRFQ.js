...
function loadTimer()
{
        t=setInterval('periksaChat()',10000);//15 second
}	
x=0;
function periksaChat()
{
	...
	param='nomor='+nomor;
	tujuan='log_slave_saveChatRFQ.php';
	if (sta==0) {
