...
function gettotal(currRow) {
  ...
  rp_muat2 = remove_comma_var(rp_muat2);
  if (rp_muat2 == "") {
    rp_muat2 = 0;
  }
  rp_muat3 = remove_comma_var(rp_muat3);
  if (rp_muat3 == "") {
    rp_muat3 = 0;
  }
  rp_muat4 = remove_comma_var(rp_muat4);
  if (rp_muat4 == "") {
    rp_muat4 = 0;
  }
  rp_muat5 = remove_comma_var(rp_muat5);
  if (rp_muat5 == "") {
    rp_muat5 = 0;
  }
  rp_muat6 = remove_comma_var(rp_muat6);
  if (rp_muat6 == "") {
    rp_muat6 = 0;
  }
  rp_muat7 = remove_comma_var(rp_muat7);
  if (rp_muat7 == "") {
    rp_muat7 = 0;
  }
  addrp_muat = remove_comma_var(addrp_muat);
  if (addrp_muat == "") {
    addrp_muat = 0;
  }
  ...
  rp_angkut2 = remove_comma_var(rp_angkut2);
  if (rp_angkut2 == "") {
    rp_angkut2 = 0;
  }
  rp_angkut3 = remove_comma_var(rp_angkut3);
  if (rp_angkut3 == "") {
    rp_angkut3 = 0;
  }
  rp_angkut4 = remove_comma_var(rp_angkut4);
  if (rp_angkut4 == "") {
    rp_angkut4 = 0;
  }
  rp_angkut5 = remove_comma_var(rp_angkut5);
  if (rp_angkut5 == "") {
    rp_angkut5 = 0;
  }
  rp_angkut6 = remove_comma_var(rp_angkut6);
  if (rp_angkut6 == "") {
    rp_angkut6 = 0;
  }
  rp_angkut7 = remove_comma_var(rp_angkut7);
  if (rp_angkut7 == "") {
    rp_angkut7 = 0;
  }
  addrp_angkut = remove_comma_var(addrp_angkut);
  if (addrp_angkut == "") {
    addrp_angkut = 0;
  }
  ...
  netto =
    ...
    parseFloat(rp_muat6) +
    parseFloat(rp_muat7) +
    parseFloat(addrp_muat) +
    parseFloat(rp_angkut) +
    parseFloat(rp_angkut2) +
    parseFloat(rp_angkut3) +
    parseFloat(rp_angkut4) +
    parseFloat(rp_angkut5) +
    parseFloat(rp_angkut6) +
    parseFloat(rp_angkut7) +
    parseFloat(addrp_angkut) -
    parseFloat(potonganrp);
  document.getElementById("ttlrp_" + currRow).value = numberFormat(netto, 2);
}

function deletedetail(kodeorg, periode, nospb, spk, periodebyr, blok, kgwb) {
  param =
    "method=deletedetail" +
    "&kodeorg=" +
    kodeorg +
...
function getdetailspb(no) {
  ...
  j = document.getElementsByName("jnskendcr[]");
  b = document.getElementsByName("blokbesar[]");
  ...
  for (i = 0; i < e.length; i++) {
    ...
    //   param += "&tiket[" + i + "]=" + t[i].innerHTML;
      param += "&nospb[" + i + "]=" + n[i].value;
      param += "&blokbesar[" + i + "]=" + b[i].innerHTML;
...
function hitungrupiah(tipe, i) {
  kgwbpks = document.getElementById("kgwbpks_" + i).value;
  kgbrd = document.getElementById("kgbrd_" + i).value;
  kgwbpks = remove_comma_var(kgwbpks);
  kgbrd = remove_comma_var(kgbrd);
  if (kgbrd == "") {
    kgbrd = 0;
  }
  ...
  if (tipe == "kg") {
    ...
    kgwb = parseFloat(kgwbpks) - parseFloat(kgbrd);
    document.getElementById("kgwb_" + i).value = kgwb;
  }
  if (parseFloat(kgwb) > parseFloat(kgwbpks)) {
    alertify.alert("Kg tidak boleh lebih besar dari KG PKS.");
    document.getElementById("kgwb_" + i).value = kgwbpks;
    document.getElementById("kgbrd_" + i).value = "0";
  }

  rpmuat = document.getElementById("harga_muat_" + i).value;
  rpmuat2 = document.getElementById("harga_muat2_" + i).value;
  rpmuat3 = document.getElementById("harga_muat3_" + i).value;
  rpmuat4 = document.getElementById("harga_muat4_" + i).value;
  rpmuat5 = document.getElementById("harga_muat5_" + i).value;
  rpmuat6 = document.getElementById("harga_muat6_" + i).value;
  rpmuat7 = document.getElementById("harga_muat7_" + i).value;
  rpangkut = document.getElementById("harga_angkut_" + i).value;
  rpangkut2 = document.getElementById("harga_angkut2_" + i).value;
  rpangkut3 = document.getElementById("harga_angkut3_" + i).value;
  rpangkut4 = document.getElementById("harga_angkut4_" + i).value;
  rpangkut5 = document.getElementById("harga_angkut5_" + i).value;
  rpangkut6 = document.getElementById("harga_angkut6_" + i).value;
  rpangkut7 = document.getElementById("harga_angkut7_" + i).value;

  rpmuat = remove_comma_var(rpmuat);
  rpmuat2 = remove_comma_var(rpmuat2);
  rpmuat3 = remove_comma_var(rpmuat3);
  rpmuat4 = remove_comma_var(rpmuat4);
  rpmuat5 = remove_comma_var(rpmuat5);
  rpmuat6 = remove_comma_var(rpmuat6);
  rpmuat7 = remove_comma_var(rpmuat7);
  rpangkut = remove_comma_var(rpangkut);
  rpangkut2 = remove_comma_var(rpangkut2);
  rpangkut3 = remove_comma_var(rpangkut3);
  rpangkut4 = remove_comma_var(rpangkut4);
  rpangkut5 = remove_comma_var(rpangkut5);
  rpangkut6 = remove_comma_var(rpangkut6);
  rpangkut7 = remove_comma_var(rpangkut7);

  totrpmuat = parseFloat(rpmuat) * parseFloat(kgwb);
  totrpmuat2 = parseFloat(rpmuat2) * parseFloat(kgwb);
  totrpmuat3 = parseFloat(rpmuat3) * parseFloat(kgwb);
  totrpmuat4 = parseFloat(rpmuat4) * parseFloat(kgwb);
  totrpmuat5 = parseFloat(rpmuat5) * parseFloat(kgwb);
  totrpmuat6 = parseFloat(rpmuat6) * parseFloat(kgwb);
  totrpmuat7 = parseFloat(rpmuat7) * parseFloat(kgwb);
  totrpangkut = parseFloat(rpangkut) * parseFloat(kgwb);
  totrpangkut2 = parseFloat(rpangkut2) * parseFloat(kgwb);
  totrpangkut3 = parseFloat(rpangkut3) * parseFloat(kgwb);
  totrpangkut4 = parseFloat(rpangkut4) * parseFloat(kgwb);
  totrpangkut5 = parseFloat(rpangkut5) * parseFloat(kgwb);
  totrpangkut6 = parseFloat(rpangkut6) * parseFloat(kgwb);
  totrpangkut7 = parseFloat(rpangkut7) * parseFloat(kgwb);
  ...
  if (isNaN(totrpangkut2)) {
    totrpangkut2 = 0;
  }
  if (isNaN(totrpangkut3)) {
    totrpangkut3 = 0;
  }
  if (isNaN(totrpangkut4)) {
    totrpangkut4 = 0;
  }
  if (isNaN(totrpangkut5)) {
    totrpangkut5 = 0;
  }
  if (isNaN(totrpangkut6)) {
    totrpangkut6 = 0;
  }
  if (isNaN(totrpangkut7)) {
    totrpangkut7 = 0;
  }
  ...
  document.getElementById("ttlrp_" + i).value =
    totrpmuat +
    totrpmuat2 +
    totrpmuat3 +
    totrpmuat4 +
...
function getharga(no, maxrow, nospbold) {
  ...
  if (n <= ttlrow) {
    ...
    //   }ini kalau 1 spb di klik semua yg ada dispb itu ngikut
    // }    
  }
    ...
    if (con.readyState == 4) {
      if (con.status == 200) {
        ...
        if (!isSaveResponse(con.responseText)) {
          ...
          addrpmuat = value = trim(isi[4]);
          addrpangkut = value = trim(isi[5]);

        //   if (nospb == nospbold) {command biar input lebih cepet bukan per nospb 
            if (tujuanx == "tphpks1") {
              ...
              kgwb = document.getElementById("kgwb_" + no).value;
              kgwb = remove_comma_var(kgwb);
...
function viewdetailx(kodeorg, periode, nospb, tipenya, spk) {
  param =
    "method=viewdetailx" +
    "&kodeorg=" +
    kodeorg +
...
function popupdeletedetail(kodeorg, periode, nospb, spk, periodebyr) {
  param =
    "method=popupviewdetailx" +
    "&kodeorg=" +
    kodeorg +
    "&periode=" +
    periode +
...
function previewexcel(kodeorg, periode, spk, periodebyr, jenis) {
  param =
    ...
    "&jenis=" +
    jenis;
  tujuan = "kebun_slave_rekapangkutantbs_v2.php" + "?" + param;
  width = "";
  height = "";
  ev = "event";
  title = "Preview";
