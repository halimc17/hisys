function posting(id){
	...
	tujuan='setup_slave_5barang_statusblok.php';
...
function simpan(){
	...
	if(getValue('kodeorg') == '' || getValue('kodebarang') == '' || getValue('status') == ''){
...
//   con.open("POST", "setup_slave_5barang_statusblok.php?method="+method+"", true);
...
function editdata(jenis,id,kodeorg,kodebarang,status){
	param  = '';
	param += '&jenis=' + jenis;	
	param += '&mode=update';
	param += '&method=addnew';
