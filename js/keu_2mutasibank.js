...
function detail(kodeurut, periode, kodept, regional, kodeunit, tipe, ev, digit) {
	...
	tujuan = 'keu_2mutasibank_slave_detail.php';
...
function getlaporan(tipe) {
	...
	tampildata0 = document.getElementById('tampilData0').value
	param = 'kodept=' + kodept + '&kodeunit=' + kodeunit + '&periode=' + periode + '&digit=' + digit + '&tipe=' + tipe + '&tipelaporan=' + tipelaporan + '&tampilData0=' + tampildata0;
	if (tipelaporan == 'default') {
		tujuan = 'keu_slave_2mutasibank.php';
	} else {
		tujuan = 'keu_2mutasibank_rinciakun_slave.php';
	}
	if (tipe != 'html') {
		judul = tipe;
		ev = 'event';
