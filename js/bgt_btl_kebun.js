...
function tampilkanBLPks() {
    kodeorg = getValue('kodeunit');
    thnbudget = getValue('thnbudget');
    kelompokbiaya = getValue('kelompokbiaya');
    if (kodeorg == '' || thnbudget == '') {
        alert('Tahun budget dan kodeorganisasi tidak boleh kosong');
    } else {
        param = 'kodeorg=' + kodeorg + '&thnbudget=' + thnbudget + '&kelompokbiaya=' + kelompokbiaya;
...
function tampilkanBLPksExcel() {
    ...
    if (kodeorg == '' || thnbudget == '') {
        ...
        param = 'kodeorg=' + kodeorg + '&thnbudget=' + thnbudget + '&kelompokbiaya=' + kelompokbiaya+ '&jenis=excel';
...
function showDt(station,kdbudget,tahun,ev){
   ...
   alertify.popuppdf("PDF","<iframe frameborder=0 style='width:100%;height:90%;overflow:none' src='bgt_slave_laporan_pks_detail.php?"+param+"'></iframe>").set({'resizable':true, 'overflow':false}).resizeTo('80%','70%');
}

function showDt2(station,kdbudget,tahun,bln,ev){
   param='station='+station+'&kdbudget='+kdbudget+'&tahun='+tahun+'&bln='+bln;
   tujuan='bgt_slave_laporan_pks_detail2.php'+"?"+param;  
   width='1000';
   height='150';
   ...
   alertify.popuppdf("PDF","<iframe frameborder=0 style='width:100%;height:90%;overflow:none' src='bgt_slave_laporan_pks_detail2.php?"+param+"'></iframe>").set({'resizable':true, 'overflow':false}).resizeTo('80%','70%');
}
