...
function simpanDep() {
    ...
    subregional = document.getElementById('subregional').value;
    ...
    if (trim(organisasi) == '') {
        ...
        if (trim(regional) == '') {
            ...
            subregional = trim(subregional);
            param = 'organisasi=' + organisasi + '&regional=' + regional + '&method=' + met+ '&subregional=' + subregional;
            tujuan = 'budget_slave_regional_assignment.php';
            paramcek = 'organisasi=' + organisasi + '&regional=' + regional+ '&subregional=' + subregional;
...
function deleteDep(kode, nama,subregional) {
    met = 'delete';{
        param = 'organisasi=' + kode + '&regional=' + nama + '&method=' + met+ '&subregional=' + subregional;
        tujuan = 'budget_slave_regional_assignment.php';
        if (confirm('Delete?'))
            post_response_text(tujuan, param, respog);
    }
...
function cancelDep() {
    ...
    document.getElementById('subregional').value = '';
}