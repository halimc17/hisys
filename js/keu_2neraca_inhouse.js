...
function lihatDetailNeraca(noakuna,noakuns,periode,tipe,pt,unit,ev,codeurut,kodelaporan,periodepembanding){
    gudang=document.getElementById('gudang');
    gudang=gudang.options[gudang.selectedIndex].value;
    param = 'method=html' + '&noakuna=' + noakuna + '&noakuns=' + noakuns + '&periode=' + periode + '&tipe=' + tipe+ '&pt=' + pt+ '&unit=' + gudang+ '&codeurut=' + codeurut+ '&kodelaporan=' + kodelaporan+ '&periodepembanding=' + periodepembanding;
    title="Data Detail";
...
function lihatDetaillaporanlr(noakuna,noakuns,periode,tipe,pt,unit,ev,codeurut,kodelaporan,periodepembanding,regional){
    gudang=document.getElementById('gudang');
    gudang=gudang.options[gudang.selectedIndex].value;
    param = 'method=html' + '&noakuna=' + noakuna + '&noakuns=' + noakuns + '&periode=' + periode + '&tipe=' + tipe+ '&pt=' + pt+ '&unit=' + unit+ '&codeurut=' + codeurut+ '&kodelaporan=' + kodelaporan;
   param+='&regional='+regional+'&periodepembanding='+periodepembanding; 
   title="Data Detail";
     showDialog1(title,"<iframe frameborder=0 style='width:845px;height:395px'"+
...
function getLaporanNeraca(tipe){
    ...
    param='pt='+pt+'&periode='+periode+'&tipe='+tipe;
    tujuan='keu_2neraca_inhouse_slave.php';
    if(tipe!='html'){
        judul=tipe;
        ev='event';
...
/*function getLaporanNeraca(tipe){
		...
		periodepembanding=document.getElementById('periodepembanding').value;     
		param='pt='+pt+'&unit='+unit+'&periode='+periode+'&periode1='+periode1+'&revisi='+revisi+'&tipe='+tipe+'&periodepembanding='+periodepembanding;
		if(tipelaporan=='detail'){
			 tujuan='keu_2neraca_inhouse_rincianakun.php';
		}else{
			 tujuan='keu_2neraca_inhouse_slave.php';
		}
		if(tipe!='html'){
