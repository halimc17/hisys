...
function loopingdata(row, rows) {
	// kdOrg = document.getElementById('kdOrg2').options[document.getElementById('kdOrg2').selectedIndex].value;
	kdOrg = document.getElementById('tdlokasi_' + row).innerHTML;
	tglAbsen = document.getElementById('tdtanggal_' + row).innerHTML;
	// tglAbsen = trim(document.getElementById('tglAbsen2').value);
	updfr = document.getElementById('tdabsen_' + row).innerHTML;
	selisih = document.getElementById('selisih_' + row).innerHTML;
	...
	param = 'kdOrg=' + kdOrg + '&tglAbsen=' + tglAbsen + '&updfr=' + updfr + '&selisih=' + selisih + '&jammasuk=' + jammasuk + '&jamkeluar=' + jamkeluar + '&method=uploaddata';
	tujuan = 'sdm_slave_uploadabsensiho.php';
	post_response_text(tujuan, param, respog);
