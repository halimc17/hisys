...
function popupsumber(){
	...
	tujuan = 'sdm_slave_2detailpayroll.php';
...
function pdf(val, ev) {
	...
	alertify.popuppdf("PDF","<iframe frameborder=0 style='width:100%;height:90%;overflow:none' src='sdm_slave_2detailpayroll.php?"+param+"'></iframe>").set({'resizable':true, 'overflow':false}).resizeTo('80%','70%');
}
...
function lihatDetail(karyawanid, tanggal) {
    param = 'proses=lihatDetail&karyawanid=' + karyawanid + '&tanggal=' + tanggal;
	width = '';
	height = '';
	content = "<fieldset><div id=containerd style=\"max-height:350px;overflow:auto;\"></div></fieldset>";
	ev = 'event';
	title = "Detail HTML";
	showDialog1(title, content, width, height, ev);
