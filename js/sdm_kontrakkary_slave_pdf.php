	...
	case'pdf':
		...
		$tab.="<table width=100% border=0>";
				...
				if($a>0 or $b>0 or $c>0) {
						...
						if($a>0){
						$tab.="<tr><td style=vertical-align:top></td><td style=vertical-align:top><b>".$a.")	Uang Konsumsi</b> adalah tunjangan yang diberikan sesuai dengan kehadiran kerja (proporsional per-jam kerja).
									</td></tr><tr><td></td></tr>
									<tr><td style=vertical-align:top></td><td style=vertical-align:top><b>Konsumsi: Rp. ".number_format($bar['konsumsi'])."</b>/ Hari Kerja
								</td></tr><tr><td></td></tr>";}
						if($b>0){
						$tab.="<tr><td style=vertical-align:top></td><td style=vertical-align:top><b>".$b.")	Uang Transportasi</b> adalah tunjangan yang diberikan sesuai dengan kehadiran kerja (proporsional per-jam kerja). 
									</td></tr><tr><td></td></tr>
									<tr><td style=vertical-align:top></td><td style=vertical-align:top><b>Transportasi: Rp. ".number_format($bar['transport'])."</b>/ Hari Kerja
								</td></tr><tr><td></td></tr>";}
						if($c>0){
						$tab.="<tr><td style=vertical-align:top></td><td style=vertical-align:top><b>".$c.")	Uang Daerah</b> adalah insentif yang diberikan kepada Karyawan saat dipindah ke lokasi kerja (Di Luar Propinsi) yang lain dari lokasi kerja (Propinsi Asal) yang ditentukan di <b>Pasal I</b>.   
								</td></tr><tr><td></td></tr>
						...
						if($a>0){
						$tab.="
									<tr><td style=vertical-align:top></td><td style=vertical-align:top><b>".$a.")	Consumption Allowance</b> is an allowance that is given based on the Employee’s daily attendance (proportional per work hours). 
								</td></tr><tr><td></td></tr>
									<tr><td style=vertical-align:top></td><td style=vertical-align:top><b>Consumption: Rp. ".number_format($bar['konsumsi'])."</b>/ work day
								</td></tr><tr><td></td></tr>";}
						if($b>0){
						$tab.="<tr><td style=vertical-align:top></td><td style=vertical-align:top><b>".$b.")	Tranportation Allowance</b> is an allowance that is given based on the Employee’s daily attendance (proportional per work hours).  
								</td></tr><tr><td></td></tr>
									<tr><td style=vertical-align:top></td><td style=vertical-align:top><b>Transportation: Rp. ".number_format($bar['transport'])."</b>/ work day
								</td></tr><tr><td></td></tr>";}
						if($c>0){
						$tab.="<tr><td style=vertical-align:top></td><td style=vertical-align:top><b>".$c.")	Hardship Allowance</b> is an incentive that is given to Employee when he/ she is required  to work in another location (Outside Province) that is different from the work location (Province of Origin) stated in <b>Article I<b>.   
								</td></tr><tr><td></td></tr>
				...
				if($a>0 or $b>0) 
				{
					$tab.="<tr><td align=center colspan=2 style=vertical-align:top>
							...
							if($a>0){
							$tab.="
									<tr><td style=vertical-align:top></td><td style=vertical-align:top><b>".$a.")	Perumahan dan Utilitas </b></td></tr>
									<tr><td></td></tr>
							...
							if($b>0){
							$tab.="
									<tr><td style=vertical-align:top></td><td style=vertical-align:top><b>".$b.")	Telekomunikasi</b></td></tr>
									<tr><td></td></tr>
					...
					<td align=center colspan=2 style=vertical-align:top>
							...
							if($a>0){
							$tab.="
								<tr><td style=vertical-align:top></td><td style=vertical-align:top><b>".$a.")	Housing and Utilities</b></td></tr>
								<tr><td></td></tr>
							...
							if($b>0){
							$tab.="
								<tr><td style=vertical-align:top></td><td style=vertical-align:top><b>".$b.")	Phone Allowance</b></td></tr>
								<tr><td></td></tr>
				...
				if($c>0){
						$tab.="<tr><td align=center colspan=2 style=vertical-align:top>
									<table>
										<tr><td></td></tr>
										<tr><td style=vertical-align:top><font color=white>9.1</font></td><td style=vertical-align:top><b>".$c.")	Tiket Transportasi untuk Cuti</b></td></tr>
										<tr><td></td></tr>
						...
						<td align=center colspan=2 style=vertical-align:top>
								<table>
									<tr><td></td></tr>
									<tr><td style=vertical-align:top><font color=white>9.1</font></td><td style=vertical-align:top><b>".$c.")	Transportation ticket for annual leave</b></td></tr>
									<tr><td></td></tr>
