...
function getunit(kodepabrik)
{
	pt=document.getElementById('pt');
	pt=pt.options[pt.selectedIndex].value;
	
	param='proses=getunit&pt='+pt+'&kodepabrik='+kodepabrik;
	tujuan='pmn_slave_penerimaantbsmanual.php';
	...
	function respog()
	{
		if(con.readyState==4)
		{
			if (con.status == 200) 
			{
				...
				{
					document.getElementById('kodepabrik').innerHTML=con.responseText;
				}
			}
			else 
			{
...
function getunit2(kodepabrik)
{
	tmplpt=document.getElementById('tmplpt');
	pt=tmplpt.options[tmplpt.selectedIndex].value;
	...
	function respog()
	{
		if(con.readyState==4)
		{
			if (con.status == 200) 
			{
				...
				{
					document.getElementById('tmplkodepabrik').innerHTML=con.responseText;
				}
			}
			else 
			{
...
function download() 
{
	...
	tmplsupplierid=document.getElementById('tmplsupplierid');
	tmplsupplierid=tmplsupplierid.options[tmplsupplierid.selectedIndex].value;
	
	tmpltanggal=document.getElementById('tmpltanggal').value;
	
	param='proses=download&tmplkodepabrik='+tmplkodepabrik+'&tmplpt='+tmplpt+'&tmplsupplierid='+tmplsupplierid+'&tmpltanggal='+tmpltanggal;
	tujuan='pmn_slave_penerimaantbsmanual.php';
	
	if (tmplpt == '' || tmplkodepabrik == '' || tmplsupplierid=='') 
	{
			alert('Data inconsistent');
	}
	else
	{
		window.location.href = "pmn_slave_penerimaantbsmanual.php?"+param; 
	}
}
...
function loadData(page){
	...
	carisupplierid=document.getElementById('carisupplierid');
	carisupplierid=carisupplierid.options[carisupplierid.selectedIndex].value;
	...
	if(carisupplierid!=''){
		param+='&carisupplierid='+carisupplierid;
	}
...
function del(notiket){
	param='notiket='+notiket+'&proses=delData';
	tujuan='pmn_slave_penerimaantbsmanual.php';  
...
function posting(notiket,tanggal,supplierid){
	param='notiket='+notiket+'&proses=posting&tanggalmasuk='+tanggal+'&supplierid='+supplierid;
	tujuan='pmn_slave_penerimaantbsmanual.php';  
...
function edit(notiket,pt,millcode,supplierid,nokendaraan,beratmasuk,beratkeluar,potongan,netto,tanggal,jammasuk,menitmasuk,jamkeluar,menitkeluar)
{
    document.getElementById('listData').style.display = 'none';
    document.getElementById('formInput').style.display = 'block';
    document.getElementById('formUpload').style.display = 'none';
	...
	document.getElementById('kodepabrik').disabled = true;
	...
	document.getElementById('tanggalmasuk').value = tanggal;
	...
	document.getElementById('tanggalkeluar').value = tanggal;
