...
karyawanidsch  = document.getElementById('karyawanidsch').value;

  param   ='method=loadData&page=' + num;     
  param  +='&notransaksisch=' + notransaksisch;
  param  +='&karyawanidsch=' + karyawanidsch;
  tujuan  ='sdm_slave_cutinonstaff.php';
...
function hapus(){
  ...
  document.getElementById('periodecuti').innerHTML='';
...
function submitfile() {
	...
	con.open("POST","sdm_slave_cutinonstaff.php?method=submitfile", true);
...
function saveForm(){
  ...
  // else if(ket == '')
  // {
  //     alert('Harap pilih Keterangan');return;
  // }
  // else if(alamatcuti == '')
  // {
  //     alert('Harap pilih Alamat');return;
  // }
  else if(cb==1)
  {
          ...
          if (con.status == 200){
              ...
              if (!isSaveResponse(con.responseText)){
                ...
                //   setValue2('karyawanid',trim(karyawanid));
                  ...
                  document.getElementById('karyawanid').value=trim(karyawanid);
                ...
                //   document.getElementById('idjenis').innerHTML=data[5];

                  setValue('idjenis',data[5]);
