function preview2(type)
{
	...
	tglawal1=document.getElementById('tglawal1').value;
	tglawal2=document.getElementById('tglawal2').value;
	
	param='kdpabrik='+kdpabrik+'&tglawal1='+tglawal1+'&tglawal2='+tglawal2+'&proses=preview2&type='+type;
	tujuan='pabrik_slave_2tbserpvtimbang.php';
...
function printexcel2(ev)
{
	...
	param='kdpabrik='+kdpabrik+'&tglawal1='+tglawal1+'&tglawal2='+tglawal2+'&proses=preview2&type=excel';
	tujuan='pabrik_slave_2tbserpvtimbang.php';
