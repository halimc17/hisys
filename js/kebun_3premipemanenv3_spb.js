...
function loaddataexcel(ev,tujuan,passParam,pros = 'loaddataexcel')
{
	judul='Report Excel';
	//alert(param);	
...
function previewexceldetail(notransaksi, prd, unit,divisi,tipe){
	...
	tujuan = 'kebun_slave_save_3premipemanenv3_spb.php' + "?" + param;
	width = '';
	height = '';
	ev = 'event';
	title = "Preview";
...
function loopsave(currRow, maxRow) {
	...
	tgl1          = document.getElementById('tgl1').value;
	tgl2          = document.getElementById('tgl2').value;
	notransaksi   = document.getElementById('notransaksi_' + currRow).value;
	...
	hapanen        = document.getElementById('hapanen_' + currRow).innerHTML;
	rowjjgbesar        = document.getElementById('rowjjgbesar_' + currRow).innerHTML;
	rowkgnettobesar        = document.getElementById('rowkgnettobesar_' + currRow).innerHTML;
	rowkgbssbesar        = document.getElementById('rowkgbssbesar_' + currRow).innerHTML;
	HKbesar        = document.getElementById('HKbesar_' + currRow).innerHTML;
	rpHKbesar        = document.getElementById('rpHKbesar_' + currRow).innerHTML;
	HKbesarpot        = document.getElementById('HKbesarpot_' + currRow).innerHTML;
	rpHKbesarpot        = document.getElementById('rpHKbesarpot_' + currRow).innerHTML;
	rowkglb1besar        = document.getElementById('rowkglb1besar_' + currRow).innerHTML;
	rowhargarplb1besar        = document.getElementById('rowhargarplb1besar_' + currRow).innerHTML;
	rowjjgkecil        = document.getElementById('rowjjgkecil_' + currRow).innerHTML;
	bjrjjgbesar        = document.getElementById('bjrjjgbesar_' + currRow).innerHTML;
	bjrjjgkecil        = document.getElementById('bjrjjgkecil_' + currRow).innerHTML;
	rowkgnettokecil        = document.getElementById('rowkgnettokecil_' + currRow).innerHTML;
	rowkgbsskecil        = document.getElementById('rowkgbsskecil_' + currRow).innerHTML;
	HKkecil        = document.getElementById('HKkecil_' + currRow).innerHTML;
	rpHKkecil        = document.getElementById('rpHKkecil_' + currRow).innerHTML;
	HKkecilpot        = document.getElementById('HKkecilpot_' + currRow).innerHTML;
	rpHKkecilpot        = document.getElementById('rpHKkecilpot_' + currRow).innerHTML;
	rowkglb1kecil        = document.getElementById('rowkglb1kecil_' + currRow).innerHTML;
	rowhargarplb1kecil        = document.getElementById('rowhargarplb1kecil_' + currRow).innerHTML;
	brondolankg        = document.getElementById('brondolankg_' + currRow).innerHTML;
	rpbrondolan        = document.getElementById('rpbrondolan_' + currRow).innerHTML;
	dendapanen        = document.getElementById('dendapanen_' + currRow).innerHTML;
	total        = document.getElementById('total_' + currRow).innerHTML;
	...
	if (prd == '' || unit == '' || afd == '') {
		...
		param   +='&rowblok=' + rowblok;
		param   +='&hapanen=' + hapanen;
		param   +='&rowjjgbesar=' + rowjjgbesar;
		param   +='&rowkgnettobesar=' + rowkgnettobesar;
		param   +='&rowkgbssbesar=' + rowkgbssbesar;
		param   +='&HKbesar=' + HKbesar;
		param   +='&rpHKbesar=' + rpHKbesar;
		param   +='&HKbesarpot=' + HKbesarpot;
		param   +='&rpHKbesarpot=' + rpHKbesarpot;
		param   +='&rowkglb1besar=' + rowkglb1besar;
		param   +='&rowhargarplb1besar=' + rowhargarplb1besar;
		param   +='&rowjjgkecil=' + rowjjgkecil;
		param   +='&bjrjjgbesar=' + bjrjjgbesar;
		param   +='&bjrjjgkecil=' + bjrjjgkecil;
		param   +='&rowkgnettokecil=' + rowkgnettokecil;
		param   +='&rowkgbsskecil=' + rowkgbsskecil;
		param   +='&HKkecil=' + HKkecil;
		param   +='&rpHKkecil=' + rpHKkecil;
		param   +='&HKkecilpot=' + HKkecilpot;
		param   +='&rpHKkecilpot=' + rpHKkecilpot;
		param   +='&rowkglb1kecil=' + rowkglb1kecil;
		param   +='&rowhargarplb1kecil=' + rowhargarplb1kecil;
		param   +='&brondolankg=' + brondolankg;
		param   +='&rpbrondolan=' + rpbrondolan;
		param   +='&dendapanen=' + dendapanen;
		param   +='&total=' + total;
		param   += "&proses=savedata";
		tujuan = 'kebun_slave_save_3premipemanenv3_spb.php';
		post_response_text(tujuan, param, respog);
...
function zpreviewdata(val,recal) {
	...
	tujuan='kebun_slave_3premipemanenv3_spb.php';
