...
function pdfpanjang(nokontrak) {
    ...
    alertify.popuppdf("title", "<iframe frameborder=0 style='width:100%;height:90%;overflow:none' src='pmn_kontrakjual_slave.php?" + param + "'></iframe>").set({ 'resizable': true, 'overflow': false }).resizeTo('90%', '80%');
}
...
function submitfile() {
    ...
    con.open("POST", "pmn_kontrakjual_slave.php?method=submitfile", true);
...
function displaylist() {
    ...
    setValue2('kodeptsch', ''); setValue2('produksch', '');
    loaddata(0);
    setTimeout(() => {
        cancelht();
    }, 500);
...
function loaddata(num) {
    ...
    param += '&tanggalmulaisch=' + tanggalmulaisch + '&tanggalselesaisch=' + tanggalselesaisch + '&produksch=' + produksch;
    tujuan = 'pmn_kontrakjual_slave.php';
    post_response_text(tujuan, param, respog);
    function respog() {
        if (con.readyState == 4) {
...
function cancelht() {
    ...
    document.getElementById('ketbyr').checked = false;
    ...
    setValue2('byrKe', '');
    setValue2('tndtng', '');
    setValue2('tppenjualan', '');
    document.getElementById('cttnLain').value = '';

    document.getElementById('md_1').value = '';
    document.getElementById('ffa_1').value = '';
    document.getElementById('dobi_1').value = '';

    document.getElementById('md_2').value = '';
    document.getElementById('ffa_2').value = '';
    document.getElementById('dobi_2').value = '';

    document.getElementById('md_3').value = '';
    document.getElementById('ffa_3').value = '';
    document.getElementById('dobi_3').value = '';

    document.getElementById('md_4').value = '';
    document.getElementById('ffa_4').value = '';
    document.getElementById('dobi_4').value = '';
...
function saveKP() {
    ...
    // helper untuk encode value dari input
    function enc(id) {
    ...
    hrgspot = remove_comma_var(document.getElementById('hrgspot').value);
    ...
    param = 'noKntrk=' + noKntrk + '&custId=' + custid + '&tlgKntrk=' + tglkntr + '&kdBrg=' + kdbrg + '&noext=' + noext + '&millcode=' + millcode;
    param += '&satuan=' + satuan + '&tBlg=' + tBlg + '&qty=' + qty + '&HrgStn=' + HrgStn + '&hrgspot=' + hrgspot + '&ppnId=' + ppn + '&posisictr=' + posisictr + '&daerahctr=' + daerahctr;
    ...
    md_1 = document.getElementById('md_1').value;
    md_2 = document.getElementById('md_2').value;
    md_3 = document.getElementById('md_3').value;
    md_4 = document.getElementById('md_4').value;

    ffa_1 = document.getElementById('ffa_1').value;
    ffa_2 = document.getElementById('ffa_2').value;
    ffa_3 = document.getElementById('ffa_3').value;
    ffa_4 = document.getElementById('ffa_4').value;

    dobi_1 = document.getElementById('dobi_1').value;
    dobi_2 = document.getElementById('dobi_2').value;
    dobi_3 = document.getElementById('dobi_3').value;
    dobi_4 = document.getElementById('dobi_4').value;
    ...
    ketbyr = document.getElementById('ketbyr');
    if (ketbyr.checked == true)
        ketbyr = 1;
    else
        ketbyr = 0;
    ...
    // ffa_x
    param += '&ffa_1=' + enc('ffa_1')
        + '&ffa_2=' + enc('ffa_2')
        + '&ffa_3=' + enc('ffa_3')
        + '&ffa_4=' + enc('ffa_4');

    // dobi_x
    param += '&dobi_1=' + enc('dobi_1')
        + '&dobi_2=' + enc('dobi_2')
        + '&dobi_3=' + enc('dobi_3')
        + '&dobi_4=' + enc('dobi_4');
    ...
    param += '&berikat=' + berikat + '&forcemajuere=' + forcemajuere + '&perselisihan=' + perselisihan + '&termbyr=' + termbyr + '&tppenjualan=' + tppenjualan + '&ketbyr=' + ketbyr;
        ...
        if (con.readyState == 4) {
            if (con.status == 200) {
                ...
                if (!isSaveResponse(con.responseText)) {
                    ...
                    /*syart,term pembayaran*/
                    setValue2('syrtByr', ar[26]);
                    document.getElementById('byrKe').innerHTML = ar[27];
                    setValue2('tndtng', ar[28]);
                    ...
                    setValue2('termbyr', ar[50]);
                    setValue2('millcode', ar[51]);
                    setValue2('tppenjualan', ar[52]);
                    document.getElementById('persenppn').value = ar[53];
                    document.getElementById('hrgspot').value = ar[54];

                    document.getElementById('md_1').value = ar[55];
                    document.getElementById('md_2').value = ar[56];
                    document.getElementById('md_3').value = ar[57];
                    document.getElementById('md_4').value = ar[58];

                    document.getElementById('ffa_1').value = ar[59];
                    document.getElementById('ffa_2').value = ar[60];
                    document.getElementById('ffa_3').value = ar[61];
                    document.getElementById('ffa_4').value = ar[62];

                    document.getElementById('dobi_1').value = ar[63];
                    document.getElementById('dobi_2').value = ar[64];
                    document.getElementById('dobi_3').value = ar[65];
                    document.getElementById('dobi_4').value = ar[66];

                    if (ar[67] == '1') {
                        document.getElementById('ketbyr').checked = true;
                    } else {
                        document.getElementById('ketbyr').checked = false;
                    }
...
function hitungHarga() {
    ...
    container.value = Math.round(parseFloat(hargasatuan) * parseFloat(kuantitas));
...
function form_ajukan(nokontrak) {
    param = "method=form_ajukan" + "&nokontrak=" + nokontrak;
    tujuan = "pmn_kontrakjual_slave.php";
    post_response_text(tujuan, param, respog);
    function respog() {
        if (con.readyState == 4) {
...
function ajukan() {
    ...
    nokontrak = document.getElementById("notran_aju").innerHTML;
