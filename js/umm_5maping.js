...
function bataldet()
{
	...
	document.getElementById('vertagihan').checked = false;
	document.getElementById('verkasbank').checked = false;
...
function simpandet()
{
    ...
    aktifvertagihan = document.getElementById('vertagihan');
    aktifverkasbank = document.getElementById('verkasbank');
    aktifdet = document.getElementById('statusdet');
    if(aktifvertagihan.checked==true){
		aktifvertagihan=1;
	}else{
		aktifvertagihan=0;
	}
	if(aktifverkasbank.checked==true){
		aktifverkasbank=1;
	}else{
		aktifverkasbank=0;
	}
	...
	param='iddt='+iddt+'&id='+idht+'&subkriteria='+subkriteria+'&vertagihan='+aktifvertagihan+'&verkasbank='+aktifverkasbank+'&statusdet='+aktifdet+'&method='+methoddet;
    tujuan='umm_slave_5maping.php';
    post_response_text(tujuan, param, respog);      
...
function editdet(iddt,subkriteria,vertagihan,verkasbank,aktif)
{
	document.getElementById('iddt').value=iddt;
	document.getElementById('subkriteria').value=subkriteria;
    if(vertagihan=='1'){
		document.getElementById('vertagihan').checked=true;
	}else{
		document.getElementById('vertagihan').checked=false;
	}
	if(verkasbank=='1'){
		document.getElementById('verkasbank').checked=true;
	}else{
		document.getElementById('verkasbank').checked=false;
	}
	if(aktif=='1'){
