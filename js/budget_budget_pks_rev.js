function editsdm(kunci,mesin,kodebudget,aruskas,namaaruskas,rupiah){
	document.getElementById('kodebudget0').value=kodebudget;
	document.getElementById('aruskassdm').innerHTML="<option value='"+ aruskas +"'>"+ aruskas +" - "+ namaaruskas +"</option>"
	document.getElementById('jumlahpertahun0').value=rupiah;
	document.getElementById('nokunci').value=kunci;
	document.getElementById('nomesin').value=mesin;
}
function editmat(kunci,kodeorg,kodebudget,aruskas,nmaruskas,noakun,rupiah,kodebarang,namabarang,keterangan,jumlah,satuan){
	document.getElementById('anggaranKd').value=noakun;
	document.getElementById('aruskasmat').innerHTML="<option value='"+ aruskas +"'>"+ aruskas +" - "+ nmaruskas +"</option>"
	...
	document.getElementById('jenis1').value=keterangan;
	...
	document.getElementById('nokunci').value=kunci;
	document.getElementById('nomesin').value=kodeorg;
}

function editmain(kunci,kodeorg,kodebudget,aruskas,nmaruskas,jumlah,rupiah){
	document.getElementById('kodebudget2').value=kodebudget;
	document.getElementById('aruskasmain').innerHTML="<option value='"+ aruskas +"'>"+ aruskas +" - "+ nmaruskas +"</option>"
	document.getElementById('jamws').value=jumlah;
	document.getElementById('jumlahpertahun2').value=rupiah;
	document.getElementById('nokunci').value=kunci;
	document.getElementById('nomesin').value=kodeorg;
	...
	if(kodebudget=='PKSM'){
		...
		document.getElementById('jumlahpertahun2').disabled = false;
	}else{
		document.getElementById('kodews').disabled = false;
		document.getElementById('jumlahpertahun2').disabled = true;
		document.getElementById('jamws').disabled = false;
	}
	getkodews('kodebudget2','kodews','edit')
}
function editvhc(kunci,kodeorg,kodebudget,kodevhc,jumlah,rupiah){
	document.getElementById('kodebudget3').value=kodebudget;
	document.getElementById('kodevhc3').value=kodevhc;
	document.getElementById('jumlahjam3').value=jumlah;
	document.getElementById('totalbiaya3').value=rupiah;
	document.getElementById('nokunci').value=kunci;
	document.getElementById('nomesin').value=kodeorg;
}

function load_mesin(find) {
	if (find == 'sebaran') {
		stationV = document.getElementById('AfdSebaran').value;
	} else {
	...
	tujuan = 'budget_slave_budget_pks_rev.php';
			...
			if (con.status == 200) {
				...
				if (!isSaveResponse(con.responseText)) {
					...
					if (con.responseText == '') {
						...
						if (find == 'sebaran') {
							document.getElementById('kdblokSebaran').innerHTML = con.responseText;
						} else {
...
function prosesSimpan() {
	...
	mesinV = document.getElementById('mesin').value;
	if (tahunbudgetV == '') {
	...
	document.getElementById('AfdSebaran').value = station;
	document.getElementById('kdblokSebaran').value = mesinV;
...
function prosesTutup() {
	...
	if (confirm('Closing budet, are you sure ?'))
		post_response_text(tujuan, param, respon);
	function respon() {
		if (con.readyState == 4) {
			if (con.status == 200) {
...
function simpan0() {
	...
	//param = 'tab=0&tahunbudget=' + tahunbudgetV + '&tipebudget=' + tipebudgetV + '&mesin=' + mesinV + '&kodebudget0=' + kodebudget0V + '&jumlahpertahun0=' + jumlahpertahun0V+ '&station=' + station;
	param = 'tab=0&tahunbudget=' + tahunbudgetV + '&tipebudget=' + tipebudgetV + '&kodebudget0=' + kodebudget0V + '&jumlahpertahun0=' + jumlahpertahun0V+ '&station=' + station;
	
	kunci = getValue('nokunci');
	aruskas = getValue('aruskassdm');
	mesin = getValue('nomesin');
	param += '&aruskas='+aruskas;
	param += '&kunci='+kunci;
	param += '&mesin='+mesin;
	
	tujuan = 'budget_slave_budget_pks_save_rev.php';
		...
		if (con.readyState == 4) {
			if (con.status == 200) {
				...
				if (!isSaveResponse(con.responseText)) {
					...
					if (con.responseText == '') {
						alert('Done');
						document.getElementById('nokunci').value = '';
...
function updateTab0(apa) {
	...
	tahunbudget = document.getElementById('tahunbudget');
	tahunbudgetV = tahunbudget.value;
	mesinV = document.getElementById('station').value;
...
function jumlahkan1() {
	...
	mesin = document.getElementById('station');
	mesinV = mesin.options[mesin.selectedIndex].value;
	tahunbudget = document.getElementById('tahunbudget');
	tahunbudgetV = tahunbudget.value;
            ...
            if (con.status == 200) {
                ...
                if (!isSaveResponse(con.responseText)) {
					...
					if(kodebgt=='PKSM'){
						...
						document.getElementById('jumlahpertahun2').disabled = false;
						if(sumber!='edit'){
							document.getElementById('jumlahpertahun2').value=0;
        ...
        if (con.readyState == 4) {
            if (con.status == 200) {
                ...
                if (!isSaveResponse(con.responseText)) {
                    ...
                    document.getElementById('jumlahpertahun2').value = con.responseText;
                }
            } else {
                busy_off();
                error_catch(con.status);
...
function jumlahkan(x) {
	kodebgt = document.getElementById('kodebudget0').value;
	jmlh = document.getElementById('jmlh_0').value;
	thnBudget = document.getElementById('tahunbudget').value;
	param = 'thnBudget=' + thnBudget + '&jmlh=' + jmlh + '&kodebgt=' + kodebgt;
	param += '&proses=jumlahkanhk';
	tujuan = 'budget_slave_budget_pks_rev.php';
	post_response_text(tujuan, param, respog);
	function respog() {
		if (con.readyState == 4) {
			if (con.status == 200) {
				...
				if (!isSaveResponse(con.responseText)) {
					...
					data=con.responseText.split("###");
                    document.getElementById('jumlahpertahun0').value = data[0];
                    document.getElementById('aruskassdm').innerHTML = data[1];
				}
			} else {
				busy_off();
				error_catch(con.status);
...
function simpan1() {
	...
	param = 'tab=1&tahunbudget=' + tahunbudgetV + '&tipebudget=' + tipebudgetV + '&mesin=' + mesinV + '&kodebudget1=' + kodebudget1V + '&jenis1=' + jenis1V + '&totalharga1=' + totalharga1V+ '&station=' + station;
	param += '&kodebarang1=' + kodebarang1V + '&regional1=' + regional1V + '&jumlah1=' + jumlah1V + '&satuan1=' + satuan1V + '&anggaranKd=' + anggaranKd+ '&station=' + station;
	aruskas = getValue('aruskasmat');
	param += '&aruskas='+aruskas;
	param += '&kunci='+getValue('nokunci');
	param += '&nomesin='+getValue('nomesin');
	
	tujuan = 'budget_slave_budget_pks_save_rev.php';
	param2 = 'tab=cekclose&tahunbudget=' + tahunbudgetV + '&tipebudget=' + tipebudgetV+ '&station=' + station;
	post_response_text(tujuan, param2, respon2);
	function respon2() {
		if (con.readyState == 4) {
			if (con.status == 200) {
			...
			if (con.status == 200) {
				...
				if (!isSaveResponse(con.responseText)) {
					...
					if (con.responseText == '') {
						...
						document.getElementById('jumlah1').value = '';
						document.getElementById('namabarang1').innerHTML = '';
						document.getElementById('kodebarang1').value = kodebudget1V.substr(2, 9);
...
function simpan2() {
	...
	param = 'tab=2&tahunbudget=' + tahunbudgetV + '&tipebudget=' + tipebudgetV + '&mesin=' + mesinV + '&kodebudget2=' + kodebudget2V + '&jumlahpertahun2=' + jumlahpertahun2V + '&station=' + station;
	aruskas = getValue('aruskasmain');
	param += '&aruskas='+aruskas;
	param += '&kunci='+getValue('nokunci');
	param += '&nomesin='+getValue('nomesin');
	param += '&kodews='+kodews;
...
function simpan3() {
	...
	param = 'tab=3&tahunbudget=' + tahunbudgetV + '&tipebudget=' + tipebudgetV + '&mesin=' + mesinV + '&kodebudget3=' + kodebudget3V + '&kodevhc3=' + kodevhc3V + '&jumlahjam3=' + jumlahjam3V + '&satuan3=' + satuan3V + '&totalbiaya3=' + totalbiaya3V+ '&station=' + station;
	param += '&aruskas='+aruskas;
	param += '&kunci='+getValue('nokunci');
	param += '&nomesin='+getValue('nomesin');
	tujuan = 'budget_slave_budget_pks_save_rev.php';
...
function updateTab4(page) {
	...
	stationsrc = document.getElementById('AfdSebaran').value;
	mesinsrc = document.getElementById('kdblokSebaran').value;
	sebarsrc = document.getElementById('kdsebaranData').value;
	limit = document.getElementById('limit').value;

	param = 'cekapa=tab4&tipebudget=' + tipebudgetV + '&tahunbudget=' + tahunbudgetV + '&mesin=' + mesinV + '&stationsrc=' + stationsrc + '&mesinsrc=' + mesinsrc + '&sebarsrc=' + sebarsrc;
	param += '&limit=' + limit;
	if (page != '') {
		param += '&page=' + page;
	}
...
function angka_doangsamaminus(e) {
