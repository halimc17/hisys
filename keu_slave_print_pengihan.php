...
//=============
		...
		$tab.="<table width=100% cellpadding=".$cellpadding." cellspacing=0 border='".$border."'>";
			...
			$tab.="<tr>";
				...
				$tab.="<td style='font-weight;text-align:center;font-size:12px;valign:center;border:0.5px solid #000000' colspan=2>DESCRIPTION</td>"; 
				$tab.="<td style='font-weight;text-align:center;font-size:12px;valign:center;border:0.5px solid #000000'>UNIT<br>PRICE<br>(RP)</td>"; 
			...
			$tab.="<tr>";
				...
				$tab.="<td style='border-top:0.5px solid #000000;border-left:0.5px solid #000000;border-right:0.5px solid #000000;'></td>"; 
				$tab.="<td style='border-top:0.5px solid #000000;border-left:0.5px solid #000000;border-right:0.5px solid #000000;' colspan=2></td>";  
				$tab.="<td style='border-top:0.5px solid #000000;border-left:0.5px solid #000000;border-right:0.5px solid #000000;'></td>"; 
				$tab.="<td style='border-top:0.5px solid #000000;border-left:0.5px solid #000000;border-right:0.5px solid #000000;'></td>"; 
			$tab.="</tr>";
			...
			if($kodebarang=='40000003'){
				...
				$tab.="<tr>";
						$tab.="<td style='font-weight;text-align:center;font-size:12px;vertical-align:top;border-left:0.5px solid #000000;border-right:0.5px solid #000000;'></td>"; 
						$tab.="<td style='width:75px;height:20px;font-weight;text-align:right;font-size:12px;vertical-align:top;border-left:0.5px solid #000000;border-right:0.5px solid #000000;'>".$_SESSION['lang']['grnd_total']." ".number_format($gtotalkgnetto)."</td>"; 
						$tab.="<td style='width:300px;font-weight;text-align:right;font-size:12px;vertical-align:top;border-left:0.5px solid #000000;border-right:0.5px solid #000000;' colspan=2></td>"; 
						$tab.="<td style='width:75px;font-weight;text-align:center;font-size:12px;vertical-align:top;border-left:0.5px solid #000000;border-right:0.5px solid #000000;'></td>"; 
						$tab.="<td style='width:100px;font-weight;text-align:right;font-size:12px;vertical-align:top;border-left:0.5px solid #000000;border-right:0.5px solid #000000;'>".number_format($gtotalrpdt)."</td>"; 
					$tab.="</tr>";
			...
			if($berikat==1){
				// $nilaippn=floor(0.1*$nilaiinvoice)+floor(0.1*$totalpinalti);
				// $nilaippn=floor($persentasedua*$nilaiinvoice);
				$nilaippn=$persentasedua*$nilaiinvoice;
				
			} else {
				// $nilaippn=$nilaippn+floor(0.1*$totalpinalti);
				if($nilaippn>0){
					// $nilaippn=$nilaippn+floor($persentasedua*$totalpinalti);
					$nilaippn=$nilaippn+$persentasedua*$totalpinalti;
				}else{
					$nilaippn=$persentasedua*$nilaiinvoice;
				}
			}
			
			$nilaippn=floor($nilaippn);
			$totalnilaiinvoice=$nilaiinvoice+$nilaippn;
			...
			$tab.="<tr>";
				$tab.="<td rowspan=2  colspan=3 style='vertical-align:top;font-size:12px;border-top:0.5px solid #000000;border-left:0.5px solid #000000;border-right:0.5px solid #000000;'>";
					...
					$tab.="<tr>";
						...
						$apa=str_replace(',','',number_format($totalnilaiinvoice)); 
						$tab.="<td align=left><i># ".terbilang($apa,2)." rupiah #</i></td>";
					$tab.="</tr>";
					$tab.="</table>";
