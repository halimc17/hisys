...
$empty=checkPostGet('empty','');
$tableName=checkPostGet('tableName','');
$opt=checkPostGet('opt','');
...
$idVal = $_POST['idVal'];
$data = $_POST;
$opt = json_decode(str_replace('##','"',$opt),true);
...
try {
    ...
    $fieldStr=isset($fieldStr)?$fieldStr:'';
    $primaryStr=isset($primaryStr)?$primaryStr:'';
