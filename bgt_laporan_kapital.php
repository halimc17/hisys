...
OPEN_BOX('','<span class=judul>'.getMenu('bgt_laporan_kapital').'</span><br>');
?>
<?php
...
<script language="javascript" src="js/option.js?ver=1"></script>
<script>
function summForm()
{
	//closeDialog();
...
<tr><td><label><?php echo $_SESSION['lang']['budgetyear']?></label></td><td><select id='thnBudget' class=select2 style="width:230px;"><?php echo $optThn?></select></td></tr>
<tr><td><label><?php echo $_SESSION['lang']['pt']?></label></td><td><select id='pt' class=select2 onchange="getdataunit('kdUnit',this.value);"  style="width:230px;"><?php echo $optpt?></select></td></tr>
<tr><td><label><?php echo $_SESSION['lang']['namaorganisasi']?></label></td><td><select class=select2 id='kdUnit'  style="width:230px;"><?php echo $optOrg?></select></td></tr>
<tr><td></td><td colspan="2"><button onclick="zPreview('bgt_slave_laporan_kapital','<?php echo $arr?>','printContainer')" class="mybutton" name="preview" id="preview"><?php echo $_SESSION['lang']['preview']?></button>
...
<div id='printContainer' class='table-scroll' style='overflow:auto;height:450px;'></div>
