...
<script language=javascript src='js/kebun_tbsafiliasi.js?v=<?php echo time(); ?>'></script>
...
echo"<div>";//buka div
OPEN_BOX('','<span class=judul>'.getMenu('kebun_tbsafiliasi').'</span>');
echo"<table>
     <tr valign=middle>
    ...
    echo "
            ...
            <thead>
                <tr class=rowheader>
                    ...
                    <th  align=center>".$_SESSION['lang']['supplier']."<br>Referensi</th>   
...
<table cellspacing=1 border=0>
	<tr>
		<td>".$_SESSION['lang']['notransaksi']."</td>
		<td>:</td>		
		<td><input type=text id=notransaksi disabled class=myinputtext style=\"width:150px;\"></td>		
