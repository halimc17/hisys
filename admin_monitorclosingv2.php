...
OPEN_BOX('', '<span class=judul>' . getMenu('admin_monitorclosingv2') . '</span><br>');
?>
<script>
        ...
        <legend>Form</legend>
            <table border=0 cellpadding=1 cellspacing=1>
                ...
                <tr>
                    <td colspan=2></td>
                    <td colspan=4>
                    <button onclick=zPreview('admin_slave_monitorclosingv2','" . $arr1 . "','printContainer'); class=mybutton name=preview id=preview>" . $_SESSION['lang']['preview'] . "</button>
                    <button onclick=zExcel(event,'admin_slave_monitorclosingv2.php','" . $arr1 . "') class=mybutton name=preview id=preview>" . $_SESSION['lang']['excel'] . "</button>
                    </td>
                </tr>
