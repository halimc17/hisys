...
OPEN_BOX('','<span class=judul>'.strtoupper($_SESSION['lang']['langconf']).'</span>');
...
$tabcont[0]="
      ...
      <fieldset style='height:360px;width:890px;'>
      <legend>".$_SESSION['lang']['detailconfigfor']." [<span id=defaultfind1></span>]</legend>
	  <div  style='height:320px;width:870px;overflow:scroll;'>
