...
OPEN_BOX('','<span class=judul>'.getMenu('bgt_budget_kebun').'</span>');
echo"<br/><fieldset style='float:left;'><legend>".$_SESSION['lang']['entryForm']."</legend> <table border=0 cellpadding=1 cellspacing=1>";
...
echo"<tr><td>".$_SESSION['lang']['kodeblok']."</td><td><select style='width:155px;' id='kdBlok' onchange=isiLuas(this)>".$optBlok."</select>
<img id='kdBlok' onclick=z.elSearch('kdBlok',event) class='resicon' src='images/skyblue/zoom.png' style='position:relative;top:2px;'>
</td></tr>";
echo"<tr><td>".$_SESSION['lang']['kegiatan']."</td><td><select style='width:155px;' id='kegId' onchange='getSatuan()'>".$optKeg."</select>
...
echo"<tr><td>".$_SESSION['lang']['satuan']."</td><td><input type='text' disabled class='myinputtext' id='satKeg' style='width:150px;' onkeypress='return tanpa_kutip(event)' /></td></tr>";
...
echo"<tr><td></td><td colspan='2'><button class=\"mybutton\"  id=\"saveData\" onclick='saveData()'>".$_SESSION['lang']['save']."</button><button  class=\"mybutton\"  id=\"newData\" onclick='newData()'>".$_SESSION['lang']['baru']."</button><button  class=\"mybutton\"  id=\"reload\" onclick='reloadframe()'>Refresh</button></td></tr>";
echo"</table></fieldset>";
...
<tr>
	...
	<td><select id='kdBudget' style='width:155px;' onchange='jumlahkan(1)'>".$optKdbdgt."</select>
	</td>
</tr>
<tr>
...
<tr>
	<td>".$_SESSION['lang']['jhk']."</td><td>:</td><td><input type='text' class='myinputtextnumber' style='width:150px;' id='jmlh_1' onkeyup='jumlahkan(1)' onkeypress='return angka_doang(event)' value='0' /></td>
</tr>
<tr>
...
<select id='kdBudgetM' style='width:153px;' onchange='getKlmpkbrg()'>".$optKdbdgtM."</select>&nbsp;<img id='kdBudgetM' onclick=z.elSearch('kdBudgetM',event) class='resicon' src='images/skyblue/zoom.png' style='position:relative;top:2px;'></td></tr>
<tr><td>".$_SESSION['lang']['kodebarang']."</td><td>:</td><td><input type='text' class='myinputtext' id='kdBarang' style='width:150px;' onkeypress='return angka_doang(event)' />&nbsp;<img src='images/skyblue/zoom.png' style='position:relative;top:2px;' class=\"resicon\" title='".$_SESSION['lang']['find']." ".$_SESSION['lang']['namabarang']."' onclick=\"searchBrg('".$_SESSION['lang']['find']." ".$_SESSION['lang']['namabarang']."','<fieldset><legend>".$_SESSION['lang']['find']." ".$_SESSION['lang']['namabarang']."</legend>".$_SESSION['lang']['find']."&nbsp;<input type=text class=myinputtext id=nmBrg><button class=mybutton onclick=findBrg()>".$_SESSION['lang']['find']."</button></fieldset><div id=containerBarang style=overflow=auto;height=380;width=485></div>',event);\">
    ...
    <tr><td>".$_SESSION['lang']['jumlah']." ".$_SESSION['lang']['setahun']."</td><td>:</td><td><input type='text' class='myinputtextnumber' id='jmlh_2' style='width:150px;' onkeypress='return angka_doang(event)' onkeyup='jumlahkan(2)' />&nbsp;<span id='satuan'></span></td></tr>
...
<tr><td>".$_SESSION['lang']['kodeanggaran']."</td><td>:</td><td>
<select id='kdBudgetL' style='width:155px;' disabled>".$optKdbdgtL."</select></td></tr>
<tr><td>".$_SESSION['lang']['kodebarang']."</td><td>:</td><td><input type='text' class='myinputtext' id='kdBarangL' style='width:150px;' onkeypress='return angka_doang(event)' />&nbsp;<img src='images/skyblue/zoom.png' style='position:relative;top:2px;' class=\"resicon\" title='".$_SESSION['lang']['find']." ".$_SESSION['lang']['namabarang']."' onclick=\"searchBrgL('".$_SESSION['lang']['find']." ".$_SESSION['lang']['namabarang']."','<fieldset><legend>".$_SESSION['lang']['find']." ".$_SESSION['lang']['namabarang']."</legend>".$_SESSION['lang']['find']."&nbsp;<input type=text class=myinputtext id=nmBrgL><button class=mybutton onclick=findBrgL()>".$_SESSION['lang']['find']."</button></fieldset><div id=containerBarangL style=overflow=auto;height=380;width=485></div>',event);\">
    ...
    <tr><td>".$_SESSION['lang']['jumlah']." ".$_SESSION['lang']['setahun']."</td><td>:</td><td><input type='text' class='myinputtextnumber' id='jmlh_3' style='width:150px;' onkeypress='return angka_doang(event)' onkeyup='jumlahkan(3)' />&nbsp;<span id='satuanL'></span></td></tr>
...
<tr><td>".$_SESSION['lang']['kodeanggaran']."</td><td>:</td><td>
<select id='kdBudgetK' style='width:155px;' disabled>".$optKdbdgt_B."</select></td></tr>
...
<tr><td>".$_SESSION['lang']['satuan']."</td><td>:</td><td><input type='text' disabled id='satKontrak' class='myinputtext' onkeypress='return tanpa_kutip(event)' style='width:150px;' /></td></tr>
<tr><td>".$_SESSION['lang']['totalbiaya']." ".$_SESSION['lang']['setahun']."</td><td>:</td><td><input type='text' class='myinputtextnumber' id='totBiayaK' style='width:150px;' onkeypress='return angka_doang(event)' value='0' /></td></tr>
<tr><td></td><td></td><td colspan=3>
...
<tr><td>".$_SESSION['lang']['jmlhJam']." ".$_SESSION['lang']['setahun']."</td><td>:</td><td><input type='text' class='myinputtextnumber' id='jmlhJam' style='width:150px;' onkeypress='return angka_doang(event)'   onkeyup='ambil_biaya()' /></td></tr>
