...
#tipekaryawan
$sTipe="select distinct b.tipekaryawan from  ".$dbname.".sdm_5gajipokok a left join ".$dbname.".datakaryawan_hist b on (a.karyawanid=b.karyawanid and a.tahun=b.periodegaji and b.version_type = 'B' and b.approval_status = '8') where left(a.tahun,4)>='2021' order by b.tipekaryawan asc";
...
OPEN_BOX('','<span class=judul>'.getMenu('sdm_2rekapkomponengajikaryawan').'</span>');


echo"<br>";
$arr="##unit##per##tpKary##jabatan";	
echo"<fieldset style='float:left;'>
        <legend>Form</legend>
            <table border=0 cellpadding=1 cellspacing=1>
                ...
                <tr>
                    <td><td><td>
                    <button onclick=zPreview('sdm_2rekapkomponengajikaryawan_slave','".$arr."','printContainer') class=mybutton name=preview id=preview>".$_SESSION['lang']['preview']."</button>
                    <button onclick=zExcel(event,'sdm_2rekapkomponengajikaryawan_slave.php','".$arr."') class=mybutton name=preview id=preview>".$_SESSION['lang']['excel']."</button>
                    </td>
                </tr>
            </table>
</fieldset>";
