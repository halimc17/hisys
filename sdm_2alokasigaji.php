...
OPEN_BOX('','<span class=judul>'.getMenu('sdm_2alokasigaji').'</span><br>');
...
echo"<fieldset style=float:left>
	 ...
	 ".$_SESSION['lang']['unit']." : <select id=unit style='width:200px;' onchange=ambilPeriode2(this.options[this.selectedIndex].value)>".$optunit."</select>
