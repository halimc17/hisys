...
?>
<script language=javascript src='js/kebun_2penjualantbs.js?v=<?php echo time(); ?>'></script>
<script language="javascript" src="js/zSelect2.js?ver=1"></script>
<?
include('master_mainMenu.php');
OPEN_BOX("","<span class=judul>".getMenu('kebun_2penjualantbs')."<br></span>");
...
echo"<fieldset style='float:left;'>
     ...
     <table>
        ...
        <td>:</td>
        <td><select class='select2' id=kodecustomer style='width:150px;'>".$optcustomer."</select></td>
