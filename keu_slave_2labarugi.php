	...
	if($data['tipe']=='Total'){
		...
		if($isitotal!=''){
			switch ($data['nourut']) {
				...
				case'2999':#OPERATING PROFIT/(LOSS) BEFORE TAX=(GROSS OPERATING PROFIT/(LOSS)+Total Pendapatan (Biaya) Lainnya-HQ)
				...
				case'3099':#NET PROFIT/(LOSS) AFTER TAX	=(OPERATING PROFIT/(LOSS) BEFORE TAX+TAXATION)
					$dtRupiah[$data['nourut']][$bulan]=$dtRupiah[$isitotal[0]][$bulan]-$dtRupiah[$isitotal[1]][$bulan];
					$totalRealisasiSd[$data['nourut']]['sd']=$totalRealisasiSd[$isitotal[0]]['sd']-$totalRealisasiSd[$isitotal[1]]['sd'];
    ...
    foreach($dzArr as $row=>$data){
        switch($data['tipe']){
            ...
            case'Total':
                ...
                $stream.="<td align=right>".number_format($dtRupiah[$data['nourut']][$bulan],2)."</td>";
                $stream.="<td align=right>".number_format($totalRealisasiSd[$data['nourut']]['sd'],2)."</td>"; 
				 $stream.="<td align=right>".number_format($dtRupiahpembanding[$data['nourut']][$bulanpembanding],2)."</td>";
                $stream.="<td align=right>".number_format($totalRealisasiSdpembanding[$data['nourut']]['sd'],2)."</td>"; 
            ...
            case'Detail':
			 $stream.="
				...
				// $stream.="<tr class=rowcontent title='".$data['keterangan']."' >";
                          ...
                          $stream.="<td width='415px;'>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;".$data['keterangan']."</td>"; 
                $stream.="<td align=right width='150px;'>".number_format($dtRupiah[$data['nourut']][$bulan],2)."</td>";
                $stream.="<td align=right width='150px;'>".number_format($dtRupiah[$data['nourut']]['sd'],2)."</td>";
				$stream.="<td align=right width='150px;'>".number_format($dtRupiahpembanding[$data['nourut']][$bulanpembanding],2)."</td>";
                $stream.="<td align=right width='150px;'>".number_format($dtRupiahpembanding[$data['nourut']]['sd'],2)."</td>";
                $stream.="</tr>";
            break;
        }
    }
