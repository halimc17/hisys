...
$optshow="<option value='0'>ADA STOK</option>";
$optshow.="<option value='1'>SELURUH BARANG</option>";
...
//     $str="select kodeorganisasi,namaorganisasi from ".$dbname.".organisasi where tipe='PT' order by induk";
// 	$res=$owlPDO->query($str) or die(print " Gagal: ".PDOException::getMessage());
// 	$res->setFetchMode(PDO::FETCH_OBJ);
//     while($bar=$res->fetch()){
...
// 	 where tipe='PT' and kodeorganisasi in (select induk from ".$dbname.".bgt_regional_assignment a left join ".$dbname.".organisasi b on a.kodeunit = b.kodeorganisasi where a.regional='".$_SESSION['empl']['regional']."')
...
echo"<br /><fieldset style=float:left;>
     <legend>".$_SESSION['lang']['laporanstok']." Per ".$_SESSION['lang']['pt']."</legend>
         ...
         <tr><td>
	 ".$_SESSION['lang']['pt']."</td><td><select class='select2' id=pt style='width:150px;' onchange=hideById('printPanel')>".$optpt."</select></td></tr><!--<tr><td>
	 ".$_SESSION['lang']['sloc']."</td><td><select class='select2' id=gudang style='width:150px;' onchange=hideById('printPanel')>".$optgudang."</select></td></tr>--><tr><td>
	 ".$_SESSION['lang']['periode']."</td><td><select class='select2' id=periode style='width:150px;' onchange=hideById('printPanel')>".$optper."</select></td></tr><tr><td><td>
    ...
    <fieldset style=float:left;>
	 ...
	 <tr><td>".$_SESSION['lang']['tampilkan']."</td><td><select class='select2' style='width:150px;' id=optshow onchange=hideById('printPanel2')>".$optshow."</select></td></tr>
	 <tr><td><td><button class=mybutton onclick=getLaporanFisik2()>".$_SESSION['lang']['proses']."</button></td></tr></table>
	 </fieldset>
      <fieldset style=float:left;>
     <legend>".$_SESSION['lang']['persediaanfisik'].' Per '.$_SESSION['lang']['unit']."</legend>
         <table cellpadding=1 cellspacing=1 border=0>
         <tr><td>
	 ".$_SESSION['lang']['unit']."</td><td><select class='select2' id=unitDt2 style='width:150px;' onchange=hideById('printPanel3')>".$optUnit2."</select></td></tr>
	 <tr><td>".$_SESSION['lang']['periode']."</td><td><select style='width:150px;' class='select2' id=periode3 onchange=hideById('printPanel3')>".$optper."</select></td></tr>
	 <tr><td><td><button class=mybutton onclick=getLaporanFisik3()>".$_SESSION['lang']['proses']."</button></td></tr></table>
	 </fieldset>
      <fieldset style=float:left;>
...
<div id=printPanel style='display:none;'>
	...
	<div id=printPanel2 style='display:none;width:100%'>
		<table style='width:100%'>
			<tr>
				<td>
					 <img style='display:none' onclick=fisikKeExcel2(event,'log_slaveLaporanPersediaanFisikUnit.php') src=images/excel.jpg class=resicon title='MS.Excel'>
