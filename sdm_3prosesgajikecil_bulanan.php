...
echo open_body();
?>
<script languange=javascript1.2 src='js/sdm_3prosesgajikecil_bulanan.js?v=<?php echo time();?>'></script>
<link rel=stylesheet type=text/css href='style/zTable.css'>
<?php
include('master_mainMenu.php');

//OPEN_BOX('','<span class=judul>'.strtoupper($_SESSION['lang']['prosesgjharian']).'</span><br>');
OPEN_BOX('','<span class=judul>'.getMenu('sdm_3prosesgajikecil_bulanan').'</span><br>');
echo $form;
CLOSE_BOX();
