...
<script language=javascript src='js/lm_2luasanarea.js?v=<?php echo time(); ?>'></script>

<?php

OPEN_BOX('','<span class=judul>'.getMenu('lm_2luasanarea').'</span><br>');
...
## GET UNIT
$optUnit="<option value='all'>".$_SESSION['lang']['pilihdata']."</option>";
$unit='';
...
<fieldset style=float:left>
	<table cellspacing=1 cellpadding=2>
		...
		<tr>
			...
			<td>:</td>
			<td>
				<select class=select2 id='unit' style='width:246px' multiple onchange=\"getDivisi()\">".$optUnit."</select>
			</td>
		</tr>
		<tr>
			...
			<td>:</td>
			<td>
				<select class=select2 id='divisi' style='width:246px' multiple><option value='all'>".$_SESSION['lang']['all']."</option></select>
			</td>
		</tr>
		<tr>
