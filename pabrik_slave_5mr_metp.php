...
switch ($method) {
    ...
    case 'insert':
        $str = "insert into " . $dbname . ".pabrik_5mr_metp (kode,nama,nilai,updateby)
            values ('" . $kode . "','" . $ket . "','".$nilai."','" . $_SESSION['standard']['userid'] . "')";
		try{
			$owlPDO->exec($str); 
    ...
    case 'update':
        $str = "update " . $dbname . ".pabrik_5mr_metp set updateby='" . $_SESSION['standard']['userid'] . "',
			nama='" . $ket . "',nilai='".$nilai."'
             where kode='" . $kode . "'";
        try{
			$owlPDO->exec($str); 
		}catch(PDOException $e){
    ...
    case'loadData':
        ...
        $ql2 = "select count(*) as jmlhrow from " . $dbname . ".pabrik_5mr_metp"; // echo $ql2;notran
		...
		//  limit " . $offset . "," . $limit . "
        $i = "select * from " . $dbname . ".pabrik_5mr_metp";
    ...
    case 'delete':
        $str = "delete from " . $dbname . ".a where kode='" . $kode . "'";
        try{
			$owlPDO->exec($str); 
		}catch(PDOException $e){
			echo " Gagal," . addslashes($e->getMessage());
