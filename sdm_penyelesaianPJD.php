...
OPEN_BOX('','<span class=judul>'.strtoupper($_SESSION['lang']['penyelesaianpjd']).'</span>');
		
//=====================================
echo"<fieldset style=height:500px>
	  ...
	  <button class=mybutton onclick=cariPJD(0)>".$_SESSION['lang']['find']."</button><br><br>
	  ...
	  <td align=center>".$_SESSION['lang']['saldo']."</td>
                      <td align=center>".$_SESSION['lang']['biaya']." ".$_SESSION['lang']['ticket']."(PP)</td>
...
//==================
  ...
  while($bar=$res->fetch())
  {
   ...
   $str1="select frekuensi,jumlahhrd from ".$dbname.".sdm_pjdinasdt
   ...
   {
   	 $usage+=$bar1->frekuensi*$bar1->jumlahhrd;
   }
	/*
	$str2="select jumlahhrd from ".$dbname.".sdm_pjdinasdt
         where notransaksi='".$bar->notransaksi."' and sumber=1";
