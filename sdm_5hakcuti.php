...
?>
<script language=javascript src='js/sdm_5hakcuti.js?v=<?php echo time(); ?>'></script>
<?php
...
$optMasaBerlaku="";
$typecuti1 = getEnum($dbname,"sdm_5hakcuti","masaberlaku");
foreach($typecuti1 as $val){
	$optMasaBerlaku .= "<option value='".$val."'>".$val."</option>";
}
...
OPEN_BOX('','<span class=judul>'.getMenu('sdm_5hakcuti').'</span>');
echo"<br>";
    ...
    echo"<legend>".$_SESSION['lang']['form']."</legend>";
        echo"<table border=0 cellpadding=2 cellspacing=1>
                ...
                <tr>
                    ...
                    <td>:</td>
                    <td><select id=type style='width:155px;' >".$optType."</select></td>
                </tr>
                <tr>
                    <td>Mulai Berlaku</td> 
                    <td>:</td>
                    <td><select id=bulanmulai style='width:155px;' >".$optBulanmulai."</select></td>
                </tr>
                <tr>
                ...
                <tr>
                    ...
                    <td>:</td>
                    <td><input type=number  id=masaberlaku onkeypress=\"return angka_doang(event)\"  class=myinputtextnumber style=\"width:150px;\"></td>
                </tr>
                <tr>
                    <td colspan=2></td>
                    <td>
                        ...
                        <button class=mybutton onclick=cekcronjob()>Proses (CJ)</button>
                    </td>
                </tr>
            </table></fieldset>
...
echo"<td align=center>".$_SESSION['lang']['nourut']."</td>
     ...
     <td align=center>Bulan Mulai</td>
     <td align=center>".$_SESSION['lang']['hakcuti']."</td>
     <td align=center>".$_SESSION['lang']['masaberlaku']." ( Bulan )</td>
