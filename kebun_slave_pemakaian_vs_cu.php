...
$query_b=$owlPDO->query($str_b) or die(print " Gagal: ".PDOException::getMessage());
$query_b->setFetchMode(PDO::FETCH_ASSOC);
while($res_b=$query_b->fetch())
{
...
$query1=$owlPDO->query($str1) or die(print " Gagal: ".PDOException::getMessage());
$query1->setFetchMode(PDO::FETCH_ASSOC);
while($res1=$query1->fetch())
{
...
$str2="select left(kodeblok,4) as kodeorg,kodebarang,sum(kwantitas) as kwantitas,tanggal 
       ...
       group by kodebarang order by kodebarang";
$query2=$owlPDO->query($str2) or die(print " Gagal: ".PDOException::getMessage());
...
switch($proses)
{
      ...
      case'getForm':
        ...
        $qAplikasi=$owlPDO->query($sAplikasi) or die(print " Gagal: ".PDOException::getMessage());
        $qAplikasi->setFetchMode(PDO::FETCH_ASSOC);
        while($rAplikasi=$qAplikasi->fetch())
        { 
          ...
          echo"<fieldset>
           ...
           <table class=sortable cellspacing=1 cellpadding=2  border=0>
              <thead>
                ...
                $qCu=$owlPDO->query($sCu) or die(print " Gagal: ".PDOException::getMessage());
                $qCu->setFetchMode(PDO::FETCH_ASSOC);    
                while($rCu=$qCu->fetch()){
                                $tab.="<tr class=rowcontent>
