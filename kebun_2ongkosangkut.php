...
<script language=javascript src='js/kebun_2ongkosangkut.js'></script>

<?php
OPEN_BOX('','<span class=judul>'.getMenu('kebun_2ongkosangkut').'</span>');
...
<div id='printContainer' style='overflow:auto; height:380px;width:100%;'>
