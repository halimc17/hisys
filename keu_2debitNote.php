...
<?php
OPEN_BOX('','<span class=judul>'.getMenu('keu_2debitNote').'</span>');
...
<table cellspacing="1" border="0">
    <tr>
        ...
        <td colspan="4"><select class='select2' id='pt' style="width:200px;" onchange="load_unit_kpd()"><?php echo $opt_pt?></select></td>
    </tr>
    <tr>
        <td><?php echo $_SESSION['lang']['unitkerja']?></td><td>:</td>
        <td colspan="4"><select class='select2' id='unit' style="width:200px;" onchange="load_kpd()"><?php echo $opt_unit?></select></td>
    </tr>
    <tr>
        <td><?php echo $_SESSION['lang']['kepada']?></td><td>:</td>
        <td colspan="4"><select class='select2' id='kepada' style="width:200px;" ><?php echo $opt_kepada?></select></td>
    </tr>
    <tr>
    ...
    <tr hidden>
        ...
        <td colspan="4">
            <select class='select2' id='tipe' style="width:200px;">
    ...
    <td id="tombol" align="center"><td><td>
        ...
        <button hidden onclick=\"zPdf('keu_slave_2debitNote','".$array."','reportcontainer')\" class=\"mybutton\" 
...
<?php CLOSE_BOX();
OPEN_BOX('','');
echo"<div id='reportcontainer' style='width:100%;height:400px;overflow:auto;'></div> "; 
CLOSE_BOX();
?>