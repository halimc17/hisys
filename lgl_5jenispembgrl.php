...
<script language=javascript1.2 src='js/lgl_5jenispembgrl.js'></script>
<?
include('master_mainMenu.php');
OPEN_BOX('','<span class=judul>'.getMenu('lgl_5jenispembgrl').'</span>');
...
$arragama=getEnum($dbname,'lgl_kodepemby','jenis');
