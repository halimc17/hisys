...
<script language=javascript1.2 src='js/setup_kelaslahan.js?v=<?php echo time(); ?>'></script>
...
OPEN_BOX('','<span class=judul>'.getMenu('setup_kelaslahan').'</span>');
...
echo"<div><fieldset>
	...
	<table border=0 cellpadding=1 cellspacing=1 style='display: inline-block;vertical-align:top'>
		<tr>
			...
			<td>:</td>
			<td><input type=text onkeydown=\"upperCaseF(this)\" id=kode nkeypress=\"return_tanpa_kutip(event);\"  class=myinputtext style=\"width:100px;\" maxlength=4></td>
		</tr>
		<tr>
			<td>".$_SESSION['lang']['nama']."</td> 
			<td>:</td>
			<td><input type=text onkeydown=\"upperCaseF(this)\" id=nama nkeypress=\"return_tanpa_kutip(event);\"   class=myinputtext style=\"width:100px;\" maxlength=100></td>
		</tr>
		<tr>
