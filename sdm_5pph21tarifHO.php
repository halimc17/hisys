...
OPEN_BOX('','<span class=judul>'.strtoupper('PPh21 FORMULA').'</span>');
echo"<div id=EList>";
// $hfrm[0]='PTKP/Tahun Form';
$hfrm[0]='Kontribusi/Tahun';
$hfrm[1]='Biaya Jabatan';
...
$frm[1]="<fieldset>
           <legend>PPh21 Biaya Jabatan</legend>
                   ...
                   Porsi <input type=text id=persen  onblur=change_number(this) value=".$persen." size=5 maxlength=4 class=myinputtextnumber onkeypress=\"return angka_doang(event);\">% <br>
                   Max.<input type=text id=max  onblur=change_number(this) size=15 value=".$max." maxlength=15 class=myinputtextnumber onkeypress=\"return angka_doang(event);\">(Rp.)/tahun
