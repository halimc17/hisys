...
$pdf->Cell(70, 5, $_SESSION['lang']['namabarang'], 1, 0, 'C', 1);
...
$pdf->Cell(25, 5, $_SESSION['lang']['total'], 1, 1, 'C', 1);
...
while ($bar = $res->fetch()) {
    ...
    $total = $bar->hargasatuan*$bar->jumlah;
    $namabarang = '';
    ...
    $pdf->Cell(70, 5, $namabarang, 1, 0, 'L', 1);
    $pdf->Cell(15, 5, $satuan, 1, 0, 'L', 1);
    $pdf->Cell(20, 5, number_format($jumlah, 2, '.', ','), 1, 0, 'R', 1);
    $pdf->Cell(25, 5, number_format($hargasatuan, 2, '.', ','), 1, 0, 'R', 1);
