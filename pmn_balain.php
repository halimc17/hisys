...
<script language=javascript src='js/pmn_balain.js?v=<?php echo time(); ?>'></script>
...
$str = "select * from ".$dbname.".organisasi where length(kodeorganisasi)=4 and tipe='PABRIK'";
$res=fetchdata($str);
foreach($res as $bar){ 
...
echo"<div>";//buka div
OPEN_BOX('','<span class=judul>'.getMenu('pmn_balain').'</span>');
echo"<table>
     <tr valign=middle>
