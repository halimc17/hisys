...
$sListUnit = "select distinct kodeorg from " . $dbname . ".lgl_pengajuanfee";
...
$sPeriodeCari = "select distinct substr(tanggal,1,7) as periode from " . $dbname . ".lgl_pengajuanfee where tanggal!='' order by substr(tanggal,1,7) desc";
...
<?
OPEN_BOX('','<span class=judul>'.getMenu('lgl_2pengajuanfee').'</span>');
?>
<div>
    <fieldset style="float: left;">
        ...
        <table cellspacing="1" border="0" >
            ...
            <tr><td><td><td colspan="2"><button onclick="zPreview('lgl_2slave_pengajuanfee', '<?php echo $arr ?>', 'printContainer')" class="mybutton" name="preview" id="preview">Preview</button><button onclick="zExcel(event, 'lgl_2slave_pengajuanfee.php', '<?php echo $arr ?>')" class="mybutton" name="preview" id="preview">Excel</button></td></tr>
