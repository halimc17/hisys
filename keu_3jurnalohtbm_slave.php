...
# Laporan
$namalaporan = "ALOKASI GC TBM UNIT";
$kodeJurnal = "OHTBM";
...
switch($method){
	...
	case'preview':
		...
		foreach($arrlistjudul as $lsjudul):
			...
			$stream.="<td align=right id=rpdb1>".number_format($proporsinilaijurnaltbm[$lsjudul],2)."</td>";
			$stream.="<td align=right></td>";
			$stream.="</tr>"; 
			...
			$stream.="<td align=right></td>";
			$stream.="<td align=right id=rpkr1>".number_format($proporsinilaijurnaltbm[$lsjudul],2)."</td>";
			$stream.="</tr>"; 
