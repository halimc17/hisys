...
<?
OPEN_BOX('','<span class=judul>'.strtoupper($_SESSION['lang']['list']." ".$_SESSION['lang']['pembebasan']." ".$_SESSION['lang']['lahan']).'</span>');
?>
<div style="margin-bottom: 30px;">
<fieldset style="float: left;">
<legend><b><?php echo $_SESSION['lang']['pembebasan']." ".$_SESSION['lang']['lahan']?></b></legend>
<table cellspacing="1" border="0" >
<tr><td><label><?php echo $_SESSION['lang']['kodebagian']?></label></td><td><select id="kdUnit" name="kdUnit" style="width:150px">
<?php echo $optKodeorg?></select></td></tr>
<tr><td></td><td><button onclick="zPreview('pad_2slave_pembebasanLahan','<?php echo $arr?>','printContainer')" class="mybutton" name="preview" id="preview">Preview</button><button onclick="zExcel(event,'pad_2slave_pembebasanLahan.php','<?php echo $arr?>')" class="mybutton" name="preview" id="preview">Excel</button></td></tr>
</table>
</fieldset>
</div>
