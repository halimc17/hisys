...
if($notran!=''){
	$where.=" and notransaksi like '%".$notran."%' ";
}
if($kdvhc!=''){
      ...
      $stream.="<thead class=rowheader>
        <tr>
            <td align=center>No</td>
				...
				<td align=center>Posisi Roda</td>
				<td align=center>Km/Hm Pasang</td>
				<td align=center>Tekanan Angin</td>
                <td align=center>".$_SESSION['lang']['keterangan']."</td>
        </tr></thead>
      <tbody>";
	  
		$str="select * from ".$dbname.".vhc_tyre where kodeorg='".$_SESSION['empl']['lokasitugas']."' ".$where." ";
		...
		while($bar=$res->fetch()){
			...
			$stream.= "<td align=left>".$arrtipe[$bar['tipetransaksi']]."</td>";
			$stream.= "<td align=left>".$bar['kodevhc']."</td>";
			$stream.= "<td align=left>".$nmBrg[$bar['kodebarang']]."</td>";
			$stream.= "<td align=left>".$bar['posisiroda']."</td>";
			$stream.= "<td align=right>".number_format($bar['kmhm'])."</td>";
			$stream.= "<td align=right>".number_format($bar['tekanan'])."</td>";
