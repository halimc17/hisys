...
?>
    <script language=JavaScript1.2 src=js/log_slaveChatPO.js?ver=1.6></script>
...
echo "<fieldset><div id=container  style=min-height:145px>
	...
	$str="select a.*,b.namauser from ".$dbname.".log_po_chat a left join ".$dbname.".user b
         ...
         where 1=1 and a.nopo='".$nopo."' order by a.nopo asc, tanggal asc";
...
echo"
       ...
       <br><button class=mybutton onclick=\"savePOChat('".$nopo."');\">".$_SESSION['lang']['chat']."</button>
	   </fieldset>"; 	
