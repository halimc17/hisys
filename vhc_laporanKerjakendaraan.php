...
?>
<script type="text/javascript" src="js/vhc_laporanKerjaKendaraan.js" />
</script>
<script>
...
<div id="action_list">
    ...
    OPEN_BOX('', '<span class=judul>' . getMenu('vhc_laporanKerjakendaraan') . '</span><br>');
    ...
    echo "
        ...
        <td>
			...
			<button class=mybutton onclick=dataKeExcel(event,'vhc_slave_laporanKerjaKendaraan.php')>" . $_SESSION['lang']['excel'] . "</button>
...
<div id="contain" class='table-scroll' style='overflow:auto;height:350px;max-width:100%'></div>
<?php
CLOSE_BOX();
?>
<?php
