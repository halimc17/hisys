...
OPEN_BOX('', '<span class=judul>' . getMenu('lm_2persediaan') . '</span><br>');
?>
<script language="javascript" src="js/zSelect2.js?ver=1"></script>
<script language=javascript src=js/zTools.js></script>
<script language=javascript src='js/zReport.js'></script>
<script language=javascript src='js/option.js?v=<?php echo time(); ?>'></script>
<script language=javascript src='js/lm_2persediaan.js?v=<?php echo time(); ?>'></script>
            ...
            <table border=0 cellpadding=1 cellspacing=1>
                ...
                <tr>
                    <td colspan=16 align=center>
                        <hr>
                        <button onclick=zPreview('lm_slave_2persediaan','" . $arr1 . "','printContainer');showheader();cekpt(); class=mybutton name=preview id=preview>" . $_SESSION['lang']['preview'] . "</button>
                        <button onclick=zExcel(event,'lm_slave_2persediaan.php','" . $arr1 . "');cekpt(); class=mybutton name=preview id=preview>" . $_SESSION['lang']['excel'] . "</button>
                    </td>
                </tr>
            </table>
</fieldset>";
