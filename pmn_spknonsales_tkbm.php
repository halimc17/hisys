...
<script language=javascript src='js/pmn_spknonsales_tkbm.js?v=<?php echo time(); ?>'></script>
...
$optbuyer=$optpelayaran=$optbongkarmuat=$optfranco=$optttd=$optsurveyor=$optbarang=$optpt="<option value=''>".$_SESSION['lang']['pilihdata']."</option>";
    ...
    echo"<legend>".$_SESSION['lang']['form']."</legend>";
        echo"<table border=0 cellpadding=1 cellspacing=1>
				...
				<tr>
					...
					<td>:</td>		
					<td>
						<input type='text' class='myinputtext' id='tanggalkedatangan1' onmousemove='setCalendar(this.id)' onkeypress='return false;'  maxlength='10' style='width:60px;' />
						s/d
						<input type='text' class='myinputtext' id='tanggalkedatangan2' onmousemove='setCalendar(this.id)' onkeypress='return false;'  maxlength='10' style='width:60px;' />
					</td>
					
					<td>".$_SESSION['lang']['bongkarmuat']."</td>
					<td>:</td>		
					<td>
						<select id=bongkarmuat style=\"width:155px;\">'".$optbongkarmuat."'</select>
						<img id='bongkarmuat' onclick=z.elSearch('bongkarmuat',event) class='resicon' src='images/skyblue/zoom.png' style='position:relative;top:3px;left:3px;'>
					</td>
...
echo "<fieldset style='width:1180px;'>
		...
		<tr>
			...
			<tr class=rowheader>
				...
				<td align=center>".$_SESSION['lang']['bongkarmuat']."</td>
				<td align=center>".$_SESSION['lang']['kuantitas']."<br>(Kg)</td>
				<td align=center>Asal Cargo</td>
				<td align=center>".$_SESSION['lang']['namakapal']."</td>
				<td align=center width=70px colspan=2>Tgl Kapal Datang</td>
