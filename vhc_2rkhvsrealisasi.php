...
OPEN_BOX('','<span class=judul>'.strtoupper('Daily work program vs Realisation').'</span><br>');
}else{
OPEN_BOX('','<span class=judul>'.strtoupper('Rencana Kerja Harian vs Realisasi').'</span><br>');	
}
...
<table>
	...
	<tr>
		<td></td><td></td><td>
		<button onclick=zPreview('vhc_slave_2rkhvsrealisasi','".$arr."','printContainer') class=mybutton name=preview id=preview>".$_SESSION['lang']['preview']."</button>
		<button onclick=zExcel(event,'vhc_slave_2rkhvsrealisasi.php','".$arr."') class=mybutton name=preview id=preview>".$_SESSION['lang']['excel']."</button>
...
OPEN_BOX();
echo "
<fieldset style='clear:both;max-width:100%''><legend><b>".$_SESSION['lang']['printArea']."</b></legend>
