...
<script language=javascript1.2 src='js/sdm_5periodegajiunit.js?v=<?php echo time(); ?>'></script>
<?
include('master_mainMenu.php');
OPEN_BOX('','<span class=judul>'.getMenu('sdm_5periodegaji').'</span><br>');
...
<tr>
	...
	<td><select id=metodepenggajian style='width:200px;'>".$metodepenggajian."</select></td>
</tr>
<tr>
...
<tr hidden>
	<td>".$_SESSION['lang']['kg']."/".$_SESSION['lang']['bulan']."</td>
	<td><input type=text id=kg size=3 onkeypress=\"return angka_doang(event);\" class=myinputtextnumber style=\"width:195px;\"></td>	
</tr>
<tr hidden>		
	 <td>".$_SESSION['lang']['harga']."</td>	
	<td><input type=text id=harga size=3 onkeypress=\"return angka_doang(event);\" class=myinputtextnumber style=\"width:195px;\"></td>	
</tr>		
<tr hidden>
	<td>".$_SESSION['lang']['tutup']."</td>
	<td><input type=checkbox id=tutup>".$_SESSION['lang']['yes']."/".$_SESSION['lang']['no']."</td>
</tr>
<tr hidden>
<td>".$_SESSION['lang']['natura']."</td><td><input type=checkbox id=natura>".$_SESSION['lang']['yes']."/".$_SESSION['lang']['no']."</td></tr>
		<tr><td></td><td>
             ...
             <thead>
                 <tr class=rowheader>
                    <th style='width:50px;'>".$_SESSION['lang']['kodeorg']."</th>
                        <th>".$_SESSION['lang']['metodepanggajian']."</th>
                        <th>".$_SESSION['lang']['periode']."</th>
                        <th>".$_SESSION['lang']['tanggalmulai']."</th>
                        <th>".$_SESSION['lang']['tanggalsampai']."</th>
                        <th hidden>".$_SESSION['lang']['kg']."/".$_SESSION['lang']['bulan']."</th>
                        <th hidden>".$_SESSION['lang']['harga']."</th>
                        <th>".$_SESSION['lang']['tutup']."</th>
                        <th hidden>".$_SESSION['lang']['natura']."</th>
