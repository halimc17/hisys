...
$query = $owlPDO->query($kegiatan) or die(print " Gagal: " . PDOException::getMessage());
...
$query->setFetchMode(PDO::FETCH_ASSOC);
while ($res = $query->fetch()) {
    @$dzArr[$res['kodekegiatan']]['fisangsdb'] = $res['volume'];
}
...
$query->setFetchMode(PDO::FETCH_ASSOC);
while ($res = $query->fetch()) {
    @$dzArr[$res['kegiatan']]['fisangsdb'] = $res['hkhm'];
}
...
$nfPtaThn = $owlPDO->query($ifPtaThn) or die(print " Gagal: " . PDOException::getMessage());
$nfPtaThn->setFetchMode(PDO::FETCH_ASSOC);
while ($dfPtaThn = $nfPtaThn->fetch()) {
...
$nfPtaBln = $owlPDO->query($ifPtaBln) or die(print " Gagal: " . PDOException::getMessage());
$nfPtaBln->setFetchMode(PDO::FETCH_ASSOC);
while ($dfPtaBln = $nfPtaBln->fetch()) {
...
$nfPtaSdBln = $owlPDO->query($ifPtaSdBln) or die(print " Gagal: " . PDOException::getMessage());
$nfPtaSdBln->setFetchMode(PDO::FETCH_ASSOC);
while ($dfPtaSdBln = $nfPtaSdBln->fetch()) {
