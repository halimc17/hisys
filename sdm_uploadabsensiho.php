...
<script language=javascript src=js/sdm_uploadabsensiho.js></script>
...
OPEN_BOX('','<span class=judul>'.getMenu('sdm_uploadabsensiho').'</span>');
$frm[1].="<fieldset>
	<legend>Form</legend>
		<div id=uForm>
        <span id=sample>
		...
		<iframe frameborder=0 width=800px height=400px name=frame></iframe>
	</div>
</fieldset>";
...
$str="select a.karyawanid, b.namajabatan, a.namakaryawan, c.nama from ".$dbname.".datakaryawan a 
...
$frm['xx'] = "<fieldset><table cellspacing='1' border='0'>
            <tr style='display:none'>
            ...
            <tr>
                ...
                <td>:</td>
                <td>
                    <input type='text' class='myinputtext' id='tglAbsen' name='tglAbsen' onmousemove='setCalendar(this.id)' onkeypress='return false;' value='".date('d-m-Y')."'  maxlength='10' style='width:145px;' onchange='getkaryawan()' readonly/>
                </td>
            </tr>
			<tr>
			...
			<table class='sortable' cellspacing='1' cellpadding='3' border='0'>
				<thead>
					<tr class=rowheader>
						...
						<td style='display:none'>".$_SESSION['lang']['kodeorg']."</td>
						<td>".$_SESSION['lang']['nomor']." BA</td>
						<td>".$_SESSION['lang']['tanggal']."</td>
						<td>".$_SESSION['lang']['namakaryawan']."</td>
						<td>".$_SESSION['lang']['absensi']."</td>
...
$frm[0] = "<fieldset><table cellspacing='1' border='0'>
            <tr>
                ...
                <td>:</td>
                <td>
                    <input type='text' class='myinputtext' id='tglAbsen2' onmousemove='setCalendar(this.id)' onkeypress='return false;' value='".date('d-m-Y')."'  maxlength='10' style='width:100px;' readonly/>
                </td>
