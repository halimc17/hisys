		...
		$tampilan="<div id='' class='x-box-blue' style='clear: both;'>
			...
			<div class='x-box-ml'>
				<div class='x-box-mr'>
					...
					<span class='judul'>DETAIL FORM PENERIMAAN BARANG</span><br>

					<input type=hidden id=methoddt value='upload'>


                  <fieldset style='float:left'>
						<legend>Form Upload Bukti Penerimaan Barang</legend>
			...
			<legend>".$_SESSION['lang']['list']."</legend>
				 ...
				 <div id=containerAkundetail1> 
		            <script>loadfiles1(0)</script>
		        </div>
		    </fieldset>
