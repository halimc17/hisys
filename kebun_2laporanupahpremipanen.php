...
?>
	...
	<script language=javascript1.2 src='js/kebun_2laporanupahpremipanen.js?v=<?php echo time(); ?>'></script>
...
<?
	...
	OPEN_BOX('','<span class=judul>'.getMenu('kebun_2laporanupahpremipanen').'</span>');
...
?>
	<fieldset>
		...
		<table border=0 cellpadding=1 cellspacing=1>
	        ...
	        <tr>
	            <td><td><td>
	            <button onclick="zPreview('kebun_2laporanupahpremipanen_slave','<?= $arr; ?>','printContainer')" class=mybutton name=preview id=preview><?=$_SESSION['lang']['preview'];?></button>
	            <button onclick="zExcel('event','kebun_2laporanupahpremipanen_slave.php','<?= $arr; ?>')" class=mybutton name=preview id=preview><?=$_SESSION['lang']['excel'];?></button>
	            </td>
	        </tr>
        </table>
	</fieldset>
