...
?>
<script language=javascript1.2 src='js/kebun_5premibmtbs_v2.js?v=<?php echo time(); ?>'></script>
...
$optjenishari="<option value='KERJA'>KERJA</option>";
$optjenishari.="<option value='LIBUR'>LIBUR</option>";

OPEN_BOX('','<span class=judul>'.getMenu('kebun_5premibmtbs_v2').'</span>');
echo"<div><fieldset>
    <legend>".$_SESSION['lang']['form']."</legend>
		<table style=font-weight:bold>
			<tr>
				...
				<td>:</td>
				<td><select id=jenishari  style=\"width:150px;\">" . $optjenishari . "</select></td>
