...
$blokStatus=array();
$_SESSION['tmp']['kebun']['tipeTrans'] = 'SPL';
...
?>
<script language=javascript1.2 src='js/vhc_sipil_v2.js?v=<?php echo time(); ?>'></script>
...
OPEN_BOX('','<span class=judul>'.getMenu('vhc_sipil_v2').'</span>','judul_header');	
...
echo "<fieldset style=float:left>
		...
		<table cellspacing=1 border=0>
			...
			<tr>
				...
				<td>:</td>
				<td><select class='select2' style=\"width:150px;\" id=asst>" . $optAsst . "</select>
				<td>Kontanan <font style='font-size:10px;color:blue;'>(8)</font></td><td> :</td><td> <input type='checkbox' id='kontanan' style='vertical-align:middle'/>( &nbsp;&#10004;&nbsp;&nbsp;	 (Ya) &nbsp;&nbsp;&#9634;&nbsp;&nbsp;    (Tidak))</td>
