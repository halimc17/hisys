...
?>
<script language=javascript src='js/keu_2laporankeuangankonsollabarugi.js?v=<?php echo time(); ?>'></script>
<script language="javascript" src="js/zSelect2.js?ver=1"></script>
<?
include('master_mainMenu.php');
OPEN_BOX('','<span class=judul><b>'.getMenu('keu_2laporankeuangankonsollabarugi').'</b></span><br>');
