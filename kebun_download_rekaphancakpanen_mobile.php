...
<script language=javascript1.2 src='js/kebun_download_rekaphancakpanen_mobile.js?v=<?php echo time(); ?>'></script>
...
OPEN_BOX('', '<span class=judul>' . getMenu('kebun_download_rekaphancakpanen_mobile') . '</span>');
