...
<script language=javascript1.2 src='js/pmn_spk_ipk.js?v=<?php echo time(); ?>'></script>
...
$optbuyer = $optpelayaran = $optfranco = $optttd = $optsurveyor = $optkapal = $optponton = $optbarang = "<option value=''>" . $_SESSION['lang']['pilihdata'] . "</option>";
...
echo "<table border=0 cellpadding=1 cellspacing=1>
				...
				<tr>
					...
					<td>:</td>		
					<td>
						<input type=text class=myinputtext  style=\"width:61px;\" readonly id=tanggalmuat1 size=12 onmousemove=setCalendar(this.id) maxlength=10 onkeypress=\"return false;\">
						s/d
						<input type=text class=myinputtext  style=\"width:61px;\" readonly id=tanggalmuat2 size=12 onmousemove=setCalendar(this.id) maxlength=10 onkeypress=\"return false;\">
					</td>
