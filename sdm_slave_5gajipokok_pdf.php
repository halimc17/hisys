...
$optKary = makeOption($dbname,'datakaryawan','karyawanid,namakaryawan',
    "lokasitugas='".$_SESSION['empl']['lokasitugas']."' and tipekaryawan in(1,2,3,4,5,6,7,8)");
...
foreach($dataShow as $key=>$row) {
    $dataShow[$key]['karyawanid'] = (isset($optKary[$row['karyawanid']]) ? $optKary[$row['karyawanid']] : "");
    $dataShow[$key]['idkomponen'] = (isset($optComp[$row['idkomponen']]) ? $optComp[$row['idkomponen']] : "");
