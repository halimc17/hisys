...
calendar = {
	...
	//weekdays: ["Min", "Sen", "Sel", "Rab", "Kam", "Jum", "Sat"],
	...
	makeCalendar:function(year, month, day) {
		...
		this.wrt("<table border=0 cellspacing=1px>");
		this.wrt("<tr><th class=lt onclick='javascript:calendar.makeCalendar("+(previous_month_year)+","+(previous_month)+");' title='"+this.month_names[previous_month]+" "+(previous_month_year)+"'>&lt;</th>");
		...
		this.wrt("</select></th>");
		this.wrt("<th class=gt onclick='javascript:calendar.makeCalendar("+(next_month_year)+","+(next_month)+");' title='"+this.month_names[next_month]+" "+(next_month_year)+"'>&gt;</th></tr>");
		...
		this.wrt("</table>");
		this.wrt("<input type='button' value='Close' class='calendar-btn' onclick='calendar.hideCalendar();' />");
