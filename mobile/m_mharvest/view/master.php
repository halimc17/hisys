...
echo" 
    ...
    <script language=JavaScript1.2 src=".$this->base_template()."assets/js/owlproject.js".$version."&m=master></script>
	...
	<link rel=stylesheet type=text/css href=".$this->base_template()."../ochart/assets/css/queryGenerator.css".$version.">
...
$list = $this->Menuharvest->loadMenu($_SESSION['standard']['username'],'0'); 
...
<?php include(VIEWPATH.'master_footer.php'); ?>
</body>
</html>