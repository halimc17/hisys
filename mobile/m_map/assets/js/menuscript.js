...
function getStyle(el,styleProp){
 ...
 function loadChildMenu(idmenu){
	if(document.getElementById('childmenuutama_'+idmenu)){
		...
		$.get(menuutama,site_url('master/load_childmenu?parent='+idmenu),function(responseText){
...
function checkPriviledge(menuId,callback){
   ...
   $.get(bd,site_url('master/checkPriviledge?id='+menuId),function(responseText){
		try{
