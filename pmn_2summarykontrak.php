...
echo open_body();
?>
<script language=javascript1.2 src=js/pmn_2summarykontrak.js></script>
<?
include('master_mainMenu.php');
OPEN_BOX("","<span class=judul>".getMenu('pmn_2summarykontrak')."<br></span>");


$optkodebarang="<option value=''>". $_SESSION['lang']['all']."</option>";
