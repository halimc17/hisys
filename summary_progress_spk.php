...
OPEN_BOX('','<span class=judul>'.strtoupper($_SESSION['lang']['summaryprogress']).'</span><br>');
?>
<fieldset style="float:left;height:100px">
    <legend><b><?php echo $_SESSION['lang']['summaryprogress'] ?></b></legend>
    <table cellspacing="1" border="0" >
        
        <tr><td><label><?php echo $_SESSION['lang']['regional'] ?></label></td><td>:</td>
            <td><select id=regional style='width:200px;' onchange="getUnit()"><?php echo $optregional; ?></select></td>
        </tr>
        <tr><td><label><?php echo $_SESSION['lang']['unit'] ?></label></td><td>:</td>
            <td><select id=unit style='width:200px;'><?php echo $optUnit; ?></select></td>
        </tr>
		<tr><td><label><?php echo $_SESSION['lang']['periode'] ?></label></td><td>:</td>
            <td><select id=periode style='width:75px;'><?php echo $optperiode; ?></select></td>
        </tr>
        <tr>
            <td><td><td>
...
<fieldset style="float:left;height:100px;">
    ...
    <table cellspacing="1" border="0" >
        <tr><td><label><?php echo $_SESSION['lang']['tahun'] ?></label></td><td>:</td>
            <td><select id=tahun style='width:200px;' onchange="getUnit2()"><?php echo $optthn; ?></select></td>
        </tr>
        <tr><td><label><?php echo $_SESSION['lang']['kontraktor'] ?></label></td><td>:</td>
