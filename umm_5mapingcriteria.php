...
<script language=javascript1.2 src='js/umm_5mapingcriteria.js'></script>
...
//LIST Tagihan
$optTipe = "";
$str="select * from ".$dbname.".keu_5jenistagihan order by namajenis";
$res=fetchData($str);
foreach($res as $key=>$val)
{
...
OPEN_BOX('','<span class=judul>'.getMenu('umm_5mapingcriteria').'</span>');
...
echo"<div><fieldset>
	...
	<table border=0 cellpadding=1 cellspacing=1 style='display: inline-block;vertical-align:top'>
		<tr>
			...
			<td>:</td>
			<td>
				<input type=text id=id onkeypress=\"return tanpa_kutip(event);\"   class=myinputtext style=\"width:200px;\" maxlength=100>
			</td>
		</tr>
		<tr>
		...
		<tr>
			...
			<td>:</td>
			<td>
				<select id='modul'>".$optmodul."</select>
			</td>
		</tr>
		<tr>
