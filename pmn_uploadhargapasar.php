...
OPEN_BOX('','<span class=judul>'.getMenu('pmn_uploadhargapasar').'</span>');
echo"  <fieldset><legend>Form</legend>
                     <div id=uForm>
                     	<span id=sample><b>".$_SESSION['lang']['harga']." ".$_SESSION['lang']['pasar']." Uploader. This form must be preceded by a header on the first line</b> <a href=tool_slave_getExample.php?form=HARGAHARIANPASAR target=frame>Click here for example</a></span><br><br>
