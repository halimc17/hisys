...
if($proses=='excel'||$proses=='preview')
{
    ...
    $qEstate=$owlPDO->query($sEstate) or die(print " Gagal: ".PDOException::getMessage());
	$qEstate->setFetchMode(PDO::FETCH_ASSOC);
	$rowData=owlBaris($qEstate);
	if($rowData==0)
    {
