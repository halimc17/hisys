...
OPEN_BOX('','<span class=judul>'.getMenu('pabrik_2mr_roa').'</span><br><br>');
$optOrg="";
...
echo"<fieldset style='float:left;'>
        <legend>Form</legend>
            <table border=0 cellpadding=1 cellspacing=1>
                ...
                <tr>
                    <td><td><td>
                    <button onclick=zPreview('pabrik_slave_2mr_roa','".$arr."','printContainer') class=mybutton name=preview id=preview>".$_SESSION['lang']['preview']."</button>
                    <button onclick=zExcel(event,'pabrik_slave_2mr_roa.php','".$arr."') class=mybutton name=preview id=preview>".$_SESSION['lang']['excel']."</button>
                    </td>
                </tr>
            </table>
</fieldset>";
