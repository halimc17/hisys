...
OPEN_BOX('','<span class=judul>'.strtoupper('FILING SYSTEM REPORT').'</span>');
#ambil kode
...
echo"<fieldset><legend>Form</legend><select style='width:175px;' name='kodeorg1'  id='kodeorg1'>".$optOrg."</select>
