...
{
	$str="select
		  sum(tbsdiolahnetto)/1000 as tbsdiolah, sum(sisahariininetto)/1000  as sisahariini from ".$dbname.".pabrik_produksi
...
$graph->SetShadow();
$graph->title->Set(strtoupper($pabrik)." FFB PROCESSED and REMAINS ".$periode);
...
$p1->SetLegend($_SESSION['lang']['tbsdiolah']);
$p2->SetLegend($_SESSION['lang']['sisa']);
...
{
	$str="select
		  sum(tbsdiolahnetto) as tbsdiolah, sum(sisahariininetto)  as sisahariini  from ".$dbname.".pabrik_produksi
