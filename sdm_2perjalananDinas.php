...
<?
OPEN_BOX('','<span class=judul>'.strtoupper($_SESSION['lang']['lapPjd']).'</span>');
?>
<div>
...
<tr><td colspan="2" align='right'><button onclick="zPreview('sdm_slave_2perjalananDinas','<?php echo $arr?>','printContainer')" class="mybutton" name="preview" id="preview">Preview</button>
