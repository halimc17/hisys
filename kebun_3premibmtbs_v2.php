...
<script language=javascript src='js/kebun_3premibmtbs_v2.js?v=<?php echo time(); ?>'></script>
<?
...
OPEN_BOX('','<span class=judul>'.getMenu('kebun_3premibmtbs_v2').'</span><br>');
...
$frm[0].= "<tr>
		...
		<button onclick=zPreview('kebun_slave_3premibmtbs_v2','".$arr."','printContainer') class=mybutton name=preview id=preview>".$_SESSION['lang']['preview']."</button>
		<button onclick=zExcel(event,'kebun_slave_3premibmtbs_v2.php','".$arr."') class=mybutton name=preview id=preview>".$_SESSION['lang']['excel']."</button>
