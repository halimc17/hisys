...
echo open_body();
?>
<script language=javascript1.2 src=js/keu_2prepaidexpense.js></script>
<?
include('master_mainMenu.php');
OPEN_BOX("","<span class=judul>".getMenu('keu_2prepaidexpense')."</span>");
     ...
     <table>
      ...
      <tr>
        ...
        <td><button class=mybutton onclick=getLaporan()>".$_SESSION['lang']['preview']."</button>
            <button class=mybutton onclick=getExcel(event,'keu_slave_2prepaidexpense.php')>".$_SESSION['lang']['excel']."</button></td>
      <tr>
     </table>
