...
$str=$owlPDO->query("select karyawanid,namakaryawan from ".$dbname.".datakaryawan order by namakaryawan");
...
OPEN_BOX('','<span class=judul>'.strtoupper($_SESSION['lang']['resetuserpassword']).'</span>');
echo OPEN_THEME($_SESSION['lang']['resetuserpassword'].':');
echo"<fieldset>
     <legend><img src='images/vista_icons_03.png' height=40px style='vertical-align:middle;'><b>".$_SESSION['lang']['resetuserpassword'].":</b></legend> 
