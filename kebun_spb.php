...
<script language="javascript" src="js/kebun_spb.js?v=<?php echo time(); ?>"></script>
<input type="hidden" id="proses" name="proses" value="insert"  />

<?php 
OPEN_BOX('','<span class=judul>'.getMenu('kebun_spb').'</span>');
?>
<div id="action_list">
<?php
$optPeriode="";
...
<tr class="rowheader">
		...
		<th align=center ><?php echo $_SESSION['lang']['pemanen'] ?></th>
