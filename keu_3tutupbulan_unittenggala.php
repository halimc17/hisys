...
<script language=javascript1.2 src=js/keu_3tutupbulan_unittenggala.js?ver=1.3></script>
...
$optOrg2= array(""=>$_SESSION['lang']['pilihdata']);
...
# Form
OPEN_BOX('','<span class=judul>'.getMenu('keu_3tutupbulan_unittenggala').'</span><br>');
