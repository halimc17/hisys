...
OPEN_BOX('','<span class=judul>'.getMenu('kebun_2alkbyyupah').'</span><br>');
?>
...
$arr1 = "##pt##kdorg##tglawal##tglakhir##klbyy##akun##keg##divisi##sts##prd##prd2##blok";
        ...
        <legend>Form</legend>
            <table border=0 cellpadding=1 cellspacing=1>
                <tr>
                    ...
                    <td>:</td>
                    <td><select id=pt onchange=getUnitThnTnm(this,'kdorg','divisi','".$_SESSION['lang']['all']."')  style=\"width:164px;\">" .$optPT . "</select></td>
                </tr>
				<tr>
                    <td>" . $_SESSION['lang']['unit'] . "</td>
                    <td>:</td>
                    <td><select onchange=getAfdThnTnm(this,'divisi','".$_SESSION['lang']['all']."') id=kdorg style=\"width:164px;\">" . $optorg . "</select></td>
                </tr>
				<tr>
				...
				<tr>
                    ...
                    <td>:</td>
                    <td><select id=blok style=\"width:164px;\">" . $optblok . "</select></td>
                </tr>
				<tr>
				...
				<tr id=idtgl hidden>
                    ...
                    <td>:</td>
                    <td>
						<input type='text' class='myinputtext' id='tglawal' onmousemove='setCalendar(this.id)' onkeypress='return false;'  maxlength='10' style='width:77px;' value='".date('01-m-Y')."' /> 
						
						<input type='text' class='myinputtext' id='tglakhir' onmousemove='setCalendar(this.id)' onkeypress='return false;'  maxlength='10' style='width:77px;' value='".date('d-m-Y')."' /></td>
                </tr>
				<tr id=idprd>
                    <td >" . $_SESSION['lang']['periode'] . "</td>
                    <td>:</td>
                    <td><select id=prd   style=\"width:80px;\">" .$optper . "</select>
						<select id=prd2  style=\"width:79px;\">" .$optper . "</select></td>
                </tr>
				<tr>
                ...
                <tr>
                    ...
                    <td>:</td>
                    <td><select id=akun onchange=getdata('getkeg','akun','keg',this.value) style=\"width:164px;\"><option value=''>".$_SESSION['lang']['all']."</option></select>
                ...
                <tr>
                    <td colspan=2></td>
                    <td colspan=4>
                    <button onclick=zPreview('kebun_slave_2alkbyyupah','" . $arr1 . "','printContainer') class=mybutton name=preview id=preview>" . $_SESSION['lang']['preview'] . "</button>
                    <button onclick=zExcel(event,'kebun_slave_2alkbyyupah.php','" . $arr1 . "') class=mybutton name=preview id=preview>" . $_SESSION['lang']['excel'] . "</button>
                    </td>
                </tr>
            </table>
</fieldset>";
