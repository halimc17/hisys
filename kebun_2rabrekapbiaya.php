...
<script language=javascript src=js/kebun_2rabrekapbiaya.js?v=<?php echo time(); ?>></script>
...
OPEN_BOX('','<span class=judul>'.getMenu ('kebun_2rabrekapbiaya').'</span><br>');
...
echo"<tr>	
		...
		<td>:</td>
		<td><select id='pt' style='width:170px' >".$optpt."</select></td>
</tr>";
// echo"<tr>	
// 		<td>".$_SESSION['lang']['unit']."</td>
// 		<td>:</td>
// 		<td><select id='unit' style='width:170px'>".$optregional."</select></td>
// </tr>";
...
OPEN_BOX('','<span class=judul>List Data</span><br>');
echo "<fieldset style='float: left;'>";
