...
//    $hkef.="<span id=printPanel style='display:none;'>
    ...
    $hkef.="<table id=container00 class=sortable cellspacing=1 cellpadding=5 border=0 >
     <thead>
        <tr>
            ...
            <th align=center>".$_SESSION['lang']['hargabudget']."</th>
            <th align=center>".$_SESSION['lang']['hargatahunlalu']."</th>
       </tr>  
     </thead>
     <tbody>";
...
//    $hkef.="<span id=printPanel style='display:none;'>
    ...
    $hkef.="<table id=container00 class=sortable cellspacing=1 border=0 cellpadding=5>
     <thead>
        <tr>
            <th align=center>".substr($_SESSION['lang']['nomor'],0,2)."</th>
            <th align=center>".$_SESSION['lang']['kodebarang']."</th>
