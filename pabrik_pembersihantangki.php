...
<script language=javascript src='js/pabrik_pembersihantangki.js?v=<?php echo time(); ?>'></script>
<!--deklarasi untuk option-->
<?php
$optunit=$opttangki=$optbarang="<option value=''>".$_SESSION['lang']['pilihdata']."</option>";
...
$str="select distinct(kodetangki) as kodetangki,keterangan from ".$dbname.".pabrik_5tangki";
$res=fetchdata($str);
foreach($res as $bar){
	$opttangki.="<option value=".$bar['kodetangki'].">".$bar['keterangan']."</option>";
}
$str="select distinct(komoditi) as komoditi from ".$dbname.".pabrik_5tangki";
$res=fetchdata($str);
foreach($res as $bar){
	$optbarang.="<option value=".$arrkodebarang[$bar['komoditi']]." ".$select.">".$arrnamabarang[$bar['komoditi']]."</option>";
}
...
echo"<div>";//buka div
OPEN_BOX('','<span class=judul>'.getMenu('pabrik_pembersihantangki').'</span>');
echo"<table border=0>
     <tr >
	...
	echo"
			<tr>
				...
				<td>:</td>		
				<td>
					<input type=text id=nobasch size=50 class=myinputtext style=\"width:150px;\">
				</td>
           ...
           echo " <table cellpading=1 cellspacing=1 border=0 class=sortable >
            <thead>
                <tr class=rowheader>
					...
					<th  align=center>".$_SESSION['lang']['noberitaacara']."</th>
					<th  align=center>".$_SESSION['lang']['notransaksi']." ".$_SESSION['lang']['pengajuan']."</th>
                    <th  align=center>".$_SESSION['lang']['tanggal']." ".$_SESSION['lang']['pengajuan']."</th>
                    <th  align=center>".$_SESSION['lang']['tanggal']." ".$_SESSION['lang']['noberitaacara']."</th>
...
$arrht="###noba###tanggalba###jumlah###keteranganba###notransaksi###kodeorg";
...
<table cellspacing=1 border=0>
	<tr>
		<td style=\"width:150px;\">".$_SESSION['lang']['notransaksi']."</td>
		<td>:</td>		
		<td><input type=text id=notransaksi  size=20 disabled class=myinputtext style=\"width:150px;\"></td>
		<td><img id=buttonsearchnodok onclick=getnotransaksi() class=resicon src=images/onebit_02.png style='position:relative;top:3px;left:3px;'></td>
		
		<td>".$_SESSION['lang']['kodebarang']."</td>
		<td>:</td>
		<td><select id=kodebarang disabled style=\"width:155px;\">".$optbarang."</select></td>

	</tr>	
	<tr>
		<td>".$_SESSION['lang']['unit']."</td>
		<td>:</td>
		<td><select id=kodeorg style=\"width:155px;\" disabled>".$optunit."</select></td>
		<td></td>
		
		<td>".$_SESSION['lang']['tanggal']."</td>
		<td>:</td>
		<td><input type=text class=myinputtext disabled id=tanggal name=tanggal  readonly  onmousemove=setCalendar(this.id) onkeypress=return false;  maxlength=10 style=width:150px; />
	</tr>
	<tr>
		<td>".$_SESSION['lang']['tangki']."</td>
		<td>:</td>
		<td><select id=kodetangki style=\"width:155px;\" disabled>".$opttangki."</select></td>
		<td></td>
		<td>".$_SESSION['lang']['saldoawal']."</td>
		<td>:</td>
		<td><input type=text class=myinputtextnumber id=sawal disabled name=sawal style=\"width:150px;\" onkeypress=\"return angka_doang(event)\">
	</tr>
	</table>
	...
	<table cellspacing=1 border=0>
	<tr>
		<td style=\"width:150px;\">".$_SESSION['lang']['noberitaacara']."</td>
		<td>:</td>		
		<td><input type=text id=noba  size=20 disabled class=myinputtext style=\"width:150px;\"></td>
		<td>&nbsp;&nbsp;&nbsp;&nbsp;</td>
		<td  valign=top align=left>".$_SESSION['lang']['keterangan']."</td>
		<td  valign=top>:</td>
		<td  valign=top rowspan=3><textarea onkeypress=\"return tanpa_kutip(event)\" id=keteranganba style=\"width:150px;\" rows=3></textarea></td>

	</tr>	
	<tr>
		
		<td>".$_SESSION['lang']['tanggal']." ".$_SESSION['lang']['noberitaacara']."</td>
		<td>:</td>
		<td><input type=text class=myinputtext id=tanggalba name=tanggalba  readonly  onmousemove=setCalendar(this.id) onkeypress=return false;  maxlength=10 style=width:150px; />
		<td></td>
	</tr>
	<tr>
		<td>".$_SESSION['lang']['jumlah']."</td>
		<td>:</td>
		<td><input type=text class=myinputtextnumber id=jumlah name=jumlah onkeyup=z.numberFormat('jumlah',2);  style=\"width:150px;\" onkeypress=\"return angka_doang(event)\">
		<td></td>
	</tr>	
