...
<script language=javascript1.2 src=js/lgl_5jenissetipikat.js></script>
<?php

include('master_mainMenu.php');
OPEN_BOX('','<span class=judul>'.getMenu('lgl_5jenissetipikat').'</span>');
...
while ($bar1 = $res1->fetch()) {
    echo"
		<tr class=rowcontent>
			...
			<td>" . $bar1->nama . "</td>
			<td align=center><img src=images/application/application_edit.png class=resicon  caption='Edit' onclick=\"fillField('" . $bar1->kode . "','" . $bar1->nama . "');\"></td>
		</tr>";
}
echo"	 
		 </tbody>
