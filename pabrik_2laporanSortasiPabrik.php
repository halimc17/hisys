...
<?
OPEN_BOX('','<span class=judul>'.strtoupper($_SESSION['lang']['laporanSortasi']).'</span>');
?>
...
s/d
<input type="text" class="myinputtext" id="tglAkhir" name="tglAkhir" onmousemove="setCalendar(this.id)" onkeypress="return false; " size="10" maxlength="4" style="width:70px;" /></td>
<tr><td><td><button onclick="zPreview('pabrik_slave_2laporanSortasiPabrik','<?php echo $arr?>','printContainer')" class="mybutton" name="preview" id="preview">Preview</button><button onclick="zPdf('pabrik_slave_2laporanSortasiPabrik','<?php echo $arr?>','printContainer')" class="mybutton" name="preview" id="preview">PDF</button><button onclick="zExcel(event,'pabrik_slave_2laporanSortasiPabrik.php','<?php echo $arr?>')" class="mybutton" name="preview" id="preview">Excel</button></td></tr>
</table>
</fieldset>
</div>
<fieldset style='clear:both'><legend><b>Print Area</b></legend>
<div id='printContainer' style='overflow:scroll;height:350px;max-width:1220px'>
