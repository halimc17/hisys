...
<script language=javascript src='js/pabrik_produksi_v2.js?v=<?php echo time(); ?>'></script>
...
OPEN_BOX('', '<span class=judul>' . getMenu('pabrik_2produksiHarian_v2') . '</span><br>');
echo "<fieldset style='float:left'>
	<table>
		<tr>
			<td>".$_SESSION['lang']['kodeorganisasi']."</td>
			<td>:</td>
			<td><select id=pabrik>".$optpabrik."</select></td>
		</tr>
		<tr>
		...
		<tr>
			<td colspan=2></td>
			<td><button class=mybutton onclick=getLaporanPrdPabrik()>".$_SESSION['lang']['preview']."</button></td>
		</tr>
	</table>";
