...
switch ($method) {
    ...
    case 'getlaporan':
        ...
        $str="select a.kodeasset,a.tipeasset,a.posisiasset as lokasiasset,b.namasub as subkategori,c.namaharta as namaharta,a.jlhblnpenyusutan as usia_bln,c.jumlah_bulan as usia_pajak,
              a.tanggalperolehan as tanggal_pembelian,a.hargaperolehan as nilai_perolehan,a.namasset as nama_asset,a.bulanan,left(a.tanggalperolehan,7) as awalsusut,a.awalpenyusutan,a.tanggaldisposal,a.status 
              ...
              where ".$whr." and left(tanggalperolehan,7)<='".$periode."' order by a.kodeasset asc, a.posisiasset asc";
        //echo $str;
        $res=$owlPDO->query($str) or die(print " Gagal: ".PDOException::getMessage());
        $res->setFetchMode(PDO::FETCH_ASSOC);
        while($bar=$res->fetch()) {
            $listdt[$bar['kodeasset']]['tipeasset']=$bar['tipeasset'];
            $listdt[$bar['kodeasset']]['lokasiasset']=$bar['lokasiasset'];
            $listdt[$bar['kodeasset']]['subkategori']=$bar['subkategori'];
            $listdt[$bar['kodeasset']]['namaharta']=$bar['namaharta'];
            $listdt[$bar['kodeasset']]['usia_bln']=$bar['usia_bln'];
            $listdt[$bar['kodeasset']]['usia_pajak']=$bar['usia_pajak'];
            $listdt[$bar['kodeasset']]['tanggal_pembelian']=$bar['tanggal_pembelian'];
        ...
        <thead>
            <tr>
                <td ".$bgclr." align=center rowspan=2>".$_SESSION['lang']['nourut']."</td>
                <td ".$bgclr."  align=center rowspan=2>".$_SESSION['lang']['kodeasset']."</td>
                <td ".$bgclr."  align=center rowspan=2>".$_SESSION['lang']['unit']."</td>
                <td ".$bgclr."  align=center rowspan=2>".$_SESSION['lang']['subtipeasset']."</td>
                <td ".$bgclr."  align=center rowspan=2>".$_SESSION['lang']['nama']." Harta</td>
                <td ".$bgclr."  align=center colspan=3>Komersial</td>
                <td ".$bgclr."  align=center colspan=3>Fiskal</td>
                <td ".$bgclr."  align=center rowspan=2>".$_SESSION['lang']['tanggal']." Pembelian</td>
                <td ".$bgclr."  align=center rowspan=2>".$_SESSION['lang']['hargaperolehan']."</td>
                <td ".$bgclr."  align=center rowspan=2>".$_SESSION['lang']['akumulasipenyusutan']."</td>
                <td ".$bgclr."  align=center rowspan=2>".$_SESSION['lang']['noakun']." Akumulasi</td>
                <td ".$bgclr."  align=center rowspan=2>".$_SESSION['lang']['tanggaldisposal']."</td>
                <td ".$bgclr."  align=center rowspan=2>".$_SESSION['lang']['nilaibuku']."</td>
                <td ".$bgclr."  align=center rowspan=2>".$_SESSION['lang']['biaya']." Depresiasi</td>
                <td ".$bgclr."  align=center rowspan=2>".$_SESSION['lang']['noakun']." Depresiasi</td>
                <td ".$bgclr."  align=center rowspan=2>".$_SESSION['lang']['namaasset']."</td>
            </tr>
            <tr>
            <td ".$bgclr."  align=center>".$_SESSION['lang']['usia']." (".$_SESSION['lang']['bulan'].")</td>
            <td ".$bgclr."  align=center> YTD ".$_SESSION['lang']['bulan']." ".$_SESSION['lang']['depresiasi']."</td>
            <td ".$bgclr."  align=center>".$_SESSION['lang']['sisa']." (".$_SESSION['lang']['bulan'].")</td>
            <td ".$bgclr."  align=center>".$_SESSION['lang']['usia']." (".$_SESSION['lang']['bulan'].")</td>
            <td ".$bgclr."  align=center> YTD ".$_SESSION['lang']['bulan']." ".$_SESSION['lang']['depresiasi']."</td>
            <td ".$bgclr."  align=center>".$_SESSION['lang']['sisa']." (".$_SESSION['lang']['bulan'].")</td>
            </tr>
        ...
        foreach ($listdt as $kodeasset => $data) {
            ...
            $str="select noakundebet, noakunkredit from ".$dbname.".keu_5parameterjurnal where jurnalid='DEP".$data['tipeasset']."'";
            $res=$owlPDO->query($str) or die(print " Gagal: ".PDOException::getMessage());
            $res->setFetchMode(PDO::FETCH_ASSOC);
            $bar=$res->fetch();
            ...
            $tab.="<td>".$kodeasset."</td>";  
            $tab.="<td>".$data['lokasiasset']."</td>";  
            $tab.="<td>".$data['subkategori']."</td>";  
            $tab.="<td>".$data['namaharta']."</td>";  
            $tab.="<td align=right>".$data['usia_bln']."</td>";  
            $tab.="<td align=right>".$data['ytdkomersial']."</td>";  
            $tab.="<td align=right>".$data['sisakomersial']."</td>";  
            $tab.="<td align=right>".$data['usia_pajak']."</td>";  
            $tab.="<td align=right>".$data['ytdbulan']."</td>";  
            $tab.="<td align=right>".$data['sisabulan']."</td>";  
            
            if ($proses=='excel') {
                $tab.="<td align=center>".$data['tanggal_pembelian']."</td>";  
            }else{
                $tab.="<td align=center>".tanggalnormal($data['tanggal_pembelian'])."</td>";      
            }
            
            $tab.="<td align=right>".number_format($data['nilai_perolehan'],2)."</td>";  
            $tab.="<td align=right>".number_format($data['akumulasidep'],2)."</td>";  
            $tab.="<td align=center>".$bar['noakunkredit']."</td>";  
            $tab.="<td align=center>".$data['tanggaldisposal']."</td>";  
            if($data['tanggaldisposal']!="0000-00-00"){
                $data['nilaibuku']=0;   
            }
            $tab.="<td align=right>".number_format($data['nilaibuku'],2)."</td>";  
            $tab.="<td align=right>".number_format($data['biaya_dep'],2)."</td>";  
            $tab.="<td align=center>".$bar['noakundebet']."</td>";  
