...
<script language=javascript1.2 src='js/lgl_bansos.js?v=<?= time(); ?>'></script>
...
OPEN_BOX('','<span class=judul>'.getMenu('lgl_bansos').'</span>');
		...
		<fieldset><legend>" . $_SESSION['lang']['find'] . "</legend> 
         <table>
			<tr>
				...
				<td>:</td>
				<td><input id=namasrc class='myinputtext' style=\"width:100px;\"></td>
				</tr>
				<tr>
				
				<td>" . $_SESSION['lang']['tanggalmulai'] . "</td> 
				<td>:</td>
				<td><input id='tanggalmulai' type='text' style='width:95px;' class='myinputtext' onmousemove='setCalendar(this.id)' onkeypress='return false';  readonly/></td>
				
				<td>" . $_SESSION['lang']['tanggalsampai'] . "</td> 
				<td>:</td>
				<td><input id='tanggalsampai' type='text' style='width:95px;' class='myinputtext' onmousemove='setCalendar(this.id)' onkeypress='return false';  readonly/></td>
			...
			<tr hidden><td>" . $_SESSION['lang']['status'] . " " . $_SESSION['lang']['kasbank'] . "</td> 
				<td>:</td>
				<td><select id=kasbanksrc  style=\"width:100px;\">" . $optkas . "</select></td></tr>
			
			
			";

echo"<tr><td></td><td></td><td colspan=2><button class=mybutton onclick=loaddata(0)>" . $_SESSION['lang']['find'] . "</button><button class=mybutton onclick=\"loaddata(0, 'excel')\">" . $_SESSION['lang']['excel'] . "</button></td></tr></table>";
echo"</fieldset></td>
		<td>
...
echo "
	...
	<table cellspacing=1 border=0>
		<tr>
			...
			<td>" . $_SESSION['lang']['kategori'] . " ".$mandatory."</td> 
			<td>:</td>
			<td><select style=\"width:175px;\" id=kategori>" . $optkat . "</select></td>
		</tr>
		<tr>
			<td>" . $_SESSION['lang']['kodeorganisasi'] . " ".$mandatory."</td> 
			<td>:</td>
			<td><select style=\"width:175px;\" id=kodeorg>" . $optorg . "</select></td>
			
			<td>Nama Pemesan ".$mandatory."</td> 
			<td>:</td>
		...
		<tr>
			<td>" . $_SESSION['lang']['tanggal'] . " ".$mandatory."</td> 
			<td>:</td>
			<td><input type=text onchange=getnotransaksi() class=myinputtext style='width:170px;' id=tanggal onmousemove=setCalendar(this.id) onkeypress=return false; maxlength=10 readonly/>
			</td>
			
			<td>Lokasi Pemesan ".$mandatory."</td> 
			<td>:</td>
		...
		<tr>
			...
			<td>NPWP (Penerima)</td> 
			<td>:</td>
			<td><input id=npwp class=myinputtext nkeypress=\"return_tanpa_kutip(event);\" style='width:170px;'></td>
			
		</tr> 
		<tr>
			<td valign=top>Tujuan ".$mandatory."</td> 
			<td valign=top>:</td>
