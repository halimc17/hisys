...
$str=" select * from ".$dbname.".keu_5akun WHERE noakun LIKE '621%' AND namaakun NOT LIKE '%NON AKTIF%' order by noakun";
$res = fetchdata($str);
foreach($res as $bar){
    ...
    <thead>
        <tr class=rowheader>
			...
			foreach($headakun as $akun){				
				...
				$tab.="<th align=center colspan=".$colshead." id=head".$akun." ".$onclick." ".$title."><font ".$font.">(".$akun.") <br> ".$nmakun[$akun]."</font></th>";
			}
				...
				foreach($arrsubhead1 as $subhead => $nmsubhead){
					foreach($arrsubhead2 as $bln => $nmsubhead2){
						...
						if(in_array($akun,$headtnpasub)){
							...
							$tab.="<td align=right ".$class." ".$name." ".$style2." id=".$akun."_".$nocol."_".$no." ondblclick=getdetail('".$no."','".$blok."','".$akun."');><font ".$stylefontbln2.">".numb_format($rpperblok,2)."</font></td>";
						}
