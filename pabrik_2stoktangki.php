...
echo open_body();
?>
<script language=javascript src='js/pabrik_2stoktangki.js?v=<?php echo time(); ?>'></script>
<?
include('master_mainMenu.php');
OPEN_BOX("","<span class=judul>".getMenu('pabrik_2stoktangki')."<br></span>");


// $optunit=$optkodebarang="<option value=''>". $_SESSION['lang']['pilihdata']."</option>";
$optunit="<option value=''>KSP AGRO (". $_SESSION['lang']['all'].")</option>";
