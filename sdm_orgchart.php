...
OPEN_BOX('','<span class=judul>'.strtoupper('Functional Structure:').'</span>');
...
$qjbnt=$owlPDO->query($sjbtn) or die(print " Gagal: ".PDOException::getMessage());
$qjbnt->setFetchMode(PDO::FETCH_ASSOC);
while($rjbtn=$qjbnt->fetch()){
