...
switch($proses) {
    case 'pdf':
        ...
        {        
            $no++;
            $pdf->Cell(5/100*$width,$height,$no,1,0,'C',1);
            $pdf->Cell(20/100*$width,$height,$optNIKary[$rKhdrn['nik']]." - ".$optNamaKary[$rKhdrn['nik']],1,0,'L',1);
            $pdf->Cell(10/100*$width,$height,$rKhdrn['absensi'],1,0,'C',1);
            $pdf->Cell(10/100*$width,$height,$rKhdrn['jhk'],1,0,'C',1);
            $pdf->Cell(10/100*$width,$height,number_format($rKhdrn['umr'],2),1,0,'R',1);
			$pdf->Cell(10/100*$width,$height,number_format($rKhdrn['hasilkerja'],2),1,0,'R',1);
            $pdf->Cell(10/100*$width,$height,number_format($rKhdrn['insentif'],2),1,1,'R',1);
            $totHk+=$rKhdrn['jhk'];
            $totUmr+=$rKhdrn['umr'];
        ...
        $pdf->Cell(10/100*$width,$height,number_format($totUmr,2),1,0,'R',1);
		 $pdf->Cell(10/100*$width,$height,number_format($tothslkrj,2),1,0,'R',1);
        $pdf->Cell(10/100*$width,$height,number_format($totIns,2),1,1,'R',1);
    ...
    case'html':
        ...
        $tab.="<fieldset style=min-height:95%><legend>".$title."</legend>";
        ...
        $tab.="<td align=center>".$_SESSION['lang']['kwantitasha']."</td>";
        ...
        while($rMat=$qMat->fetch())
        {
            ...
            $tab.="<td align=right>".$rMat['kwantitas']."</td>";
