...
?>
<script language=javascript src='js/sdm_pjdinastamu.js'></script>
<?
OPEN_BOX("","<span class=judul>".getMenu('sdm_pjdinastamu')."</span>");
...
//persetujuan1
$str="select distinct karyawanid from ".$dbname.".setup_approval where jenispersetujuan='PJDTAMU' and level=1 and kodeunit='".$_SESSION['empl']['lokasitugas']."'";
$res=$owlPDO->query($str) or die(print " Gagal: ".PDOException::getMessage());
...
$frm[0]="
	 ...
	 <tr>
	   ...
	   <input type=hidden value='' id=notransaksi>
		...
		<td>
		<input type=text id=karyawanid class=myinputtext style='width:150px'>
		</td>
	 </tr>
	 <tr hidden>
	 ...
	 <tr> 
		 ...
		 <td>:</td>
	     <td><select id='tujuan2' style='width:150px'>".$optpt."</select></td>
...
$frm[1]="<fieldset>
	  ...
	  <button class=mybutton onclick=loadList(0)>".$_SESSION['lang']['find']."</button>
	  </fieldset>
