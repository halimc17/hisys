...
switch($proses)
{
    ...
    class PDF extends FPDF
    {
        ...
        global $owlPDO;
            ...
            $this->Image($path,$this->lMargin,$this->tMargin-15,0,50);
            ...
            $this->Cell($width,$height,strtoupper($_SESSION['lang']['rPenerimaanTbs']." / ".$_SESSION['lang']['afdeling']." / ".$_SESSION['lang']['tanggal']),0,1,'C');	
        ...
        while($rData=$qData->fetch())
        {
            ...
            $bgwarna="";
             if($rData['nospb']!=''){
                ...
                $qcek=$owlPDO->query($sData) or die(print " Gagal: ".PDOException::getMessage());
                $rcek=owlBaris($qcek);
                if($rcek==1){
