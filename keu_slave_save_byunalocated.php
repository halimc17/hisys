...
case 'post':
        ...
        $str="select tanggalmulai,tanggalsampai from ".$dbname.".sdm_5periodegaji 
         ...
         $rex=$owlPDO->query($str) or die(print " Gagal: ".PDOException::getMessage());
         $rex->setFetchMode(PDO::FETCH_OBJ);
        if(owlBaris($rex)>0)
        {
           while($bax=$rex->fetch())
           {
        ...
        $str1="SELECT distinct b.kodekegiatan,b.kodeorg,c.noakun FROM ".$dbname.".kebun_kehadiran_vw a
            ...
            and unit='".$kodeorg."'";
         $resu=$owlPDO->query($str1) or die(print " Gagal: ".PDOException::getMessage());
        ...
        # Prep Header
               ...
               foreach($blok['blok'] as $key=>$val){
                ...
                try{
                    ...
                    $headErr = "Insert Header unalocated Error :" . $e->getMessage();
                }                
                ...
                if($headErr=='') {
                    ...
                    foreach($dataRes['detail'] as $row) {
                        ...
                        try{
                            ...
                            $detailErr .= "Insert Detail Unalocated Error :" . $e->getMessage();
                            break;
                        } 
                    }
