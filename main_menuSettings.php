...
OPEN_BOX('','<span class=judul>'.getMenu('main_menuSettings').'</span>');

// $str = "select * from " . $dbname . ".admin_list where username='" . $_SESSION['standard']['username'] . "' and superuser='1'";
// $res = fetchdata($str);
// if(count($res)==0){
	// echo"<br><br>";
	// exit("<span class=judul style=color:black;font-weight:bold;font-size:25px;>Warning : Diperlukan akses superuser untuk membuka menu ini.</span>");
// }
