...
OPEN_BOX('','<span class=judul>'.getMenu('kebun_2analisabyytm').'</span><br>');
?>
<script language="javascript" src="js/zSelect2.js?ver=1"></script>
<script language=javascript src=js/zTools.js></script>
<script language=javascript src='js/zReport.js'></script>
<script language=javascript src='js/option.js?v=<?php echo time(); ?>'></script>
<script language=javascript src='js/kebun_2analisabyytm.js?v=<?php echo time(); ?>'></script>
...
$arrtipe=array("group"=>"Per Group Akun","code"=>"Per Nomor Akun","keg"=>"Per Kegiatan","summary"=>"Per Summary","detail"=>"Per Detail");
foreach($arrtipe as $res => $bar){
	@$opttipe.="<option value=".$res.">".$bar."</option>";
}

$arr1 = "##pt##kdorg##prd##divisi##tt##ip##tipe##depre";
        ...
        <legend>Form</legend>
            <table border=0 cellpadding=1 cellspacing=1>
				...
				<tr>
                    ...
                    <td>Depresiasi</td>
                    <td>:</td>
                    <td><select class=select2 id=depre style=\"width:164px;\">
				...
				<tr>
                    <td colspan=2></td>
                    <td colspan=4>
                    <button onclick=zPreview('kebun_slave_2analisabyytm','" . $arr1 . "','printContainer');showheader(); class=mybutton name=preview id=preview>" . $_SESSION['lang']['preview'] . "</button>
                    <button onclick=zExcel(event,'kebun_slave_2analisabyytm.php','" . $arr1 . "') class=mybutton name=preview id=preview>" . $_SESSION['lang']['excel'] . "</button>
                    </td>
                </tr>
            </table>
</fieldset>";
