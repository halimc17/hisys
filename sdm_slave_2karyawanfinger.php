	...
	case'preview':
		...
		foreach($arrkary as $val){
			...
			$tab.="<tr class='rowcontent'>
					...
					<td align='center'>".$val['karyawanid']."</td>
					<td align='center'>".$val['nik']."</td>
					<td>".$val['namakaryawan']." - ".getJabatanKaryawan($val['karyawanid'])."</td>
					";
					...
					foreach($rangetgl as $tgl){				
                        ...
                        // }else{
                            $tab.="<td align='center' ".$style." >".$jamshift[$val['karyawanid']][$tgl]['ke']."-".$jamshift[$val['karyawanid']][$tgl]['namashift']."</td>";
