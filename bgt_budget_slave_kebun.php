...
switch($proses){
    ...
    break;
          ...
          if($rCek<1)
          {
             $volume=$volKeg*$rotThn;
              $sIns="insert into ".$dbname.".bgt_budget (tahunbudget,kodeorg, tipebudget, kodebudget, kegiatan, noakun, volume, satuanv, rupiah,rotasi,updateby,jumlah,satuanj,aruskas) values
                  ('".$thnBudget."','".$kdBlok."','".$tpBudget."','".$kdGol."','".$kegId."','".$noAkun."','".$volume."','".$satuan."','".$totBiaya."','".$rotThn."','".$_SESSION['standard']['userid']."','".$jmlhPerson."','HK','".$param['aruskas']."')";
             try{$owlPDO->exec($sIns); }catch (PDOException $e) {print " Gagal  !: " . $e->getMessage() . "\n"; die(); }
          }
          else
          {
        ...
        case'saveMat':
          ...
          if($rCek<1)
          {
                ...
                $volume=$volKeg*$rotThn;
                $sIns="insert into ".$dbname.".bgt_budget (tahunbudget,kodeorg, tipebudget, kodebudget, kegiatan, noakun, volume, satuanv,rupiah,rotasi, kodebarang, regional, updateby,jumlah,satuanj,aruskas) values
                  ('".$thnBudget."','".$kdBlok."','".$tpBudget."','".$kdBudget."','".$kegId."','".$noAkun."','".$volume."','".$satuan."','".$totHarga."','".$rotThn."','".$kdBrg."','".$rRegion['regional']."','".$_SESSION['standard']['userid']."','".$jmlhBrg."','".$satuanBrg."','".$param['aruskas']."')";
                try{$owlPDO->exec($sIns); }catch (PDOException $e) {print " Gagal  !: " . $e->getMessage() . "\n"; die(); }
          }
          else
          {
        ...
        case'saveKontrak':
          ...
          if($rCek<1)
          {
              $volume=$volKeg*$rotThn;
              $sIns="insert into ".$dbname.".bgt_budget (tahunbudget,kodeorg, tipebudget, kodebudget, kegiatan, noakun, volume, satuanv,rupiah,rotasi,  updateby,jumlah,satuanj,aruskas) values
                  ('".$thnBudget."','".$kdBlok."','".$tpBudget."','".$kdBudgetK."','".$kegId."','".$noAkun."','".$volume."','".$satuan."','".$totBiayaK."','".$rotThn."','".$_SESSION['standard']['userid']."','".$volKontrak."','".$satKontrak."','".$param['aruskas']."')";
              try{$owlPDO->exec($sIns); }catch (PDOException $e) {print " Gagal  !: " . $e->getMessage() . "\n"; die(); }
          }
          else
          {
        ...
        case'saveTool':
          ...
          if($rCek<1)
          {
              $volume=$volKeg*$rotThn;
              $sIns="insert into ".$dbname.".bgt_budget (tahunbudget,kodeorg, tipebudget, kodebudget, kegiatan, noakun, volume, satuanv,rupiah,rotasi, kodebarang, regional, updateby,jumlah,satuanj,aruskas) values
                  ('".$thnBudget."','".$kdBlok."','".$tpBudget."','".$kdBudgetL."','".$kegId."','".$noAkun."','".$volume."','".$satuan."','".$totHargaL."','".$rotThn."','".$kdBrgL."','".$rRegion['regional']."','".$_SESSION['standard']['userid']."','".$jmlhBrgL."','".$satuanBrgL."','".$param['aruskas']."')";
              try{$owlPDO->exec($sIns); }catch (PDOException $e) {print " Gagal  !: " . $e->getMessage() . "\n"; die(); }
          }
          else
          {
    ...
    case'saveKendaran':
        ...
        $qAlokasi=$owlPDO->query($sAlokasi) or die(print " Gagal: ".PDOException::getMessage());
        $qAlokasi->setFetchMode(PDO::FETCH_ASSOC);         
        $rAlokasi=$qAlokasi->fetch();
        ...
        setIt($rAlokasi['jumlah'],0);
          ...
          if($rCek<1)
          {
              ...
              $sIns="insert into ".$dbname.".bgt_budget (tahunbudget,kodeorg, tipebudget, kodebudget, kegiatan, noakun, volume, satuanv,rupiah,rotasi, kodevhc, updateby,jumlah,satuanj,aruskas) values
                  ('".$thnBudget."','".$kdBlok."','".$tpBudget."','".$kdBudgetV."','".$kegId."','".$noAkun."','".$volume."','".$satuan."','".$totBiayaKend."','".$rotThn."','".$kdVhc."','".$_SESSION['standard']['userid']."','".$jmlhJam."','".$satVhc."','".$param['aruskas']."')";
              try{$owlPDO->exec($sIns); }catch (PDOException $e) {print " Gagal  !: " . $e->getMessage() . "\n"; die(); }
          }
          else
          {
        ...
        break;
    case'loadDataSdm':
          $sLoad="select aruskas,tahunbudget,kodeorg, tipebudget, kodebudget, kegiatan, noakun, volume, satuanv, rupiah,rotasi,updateby,jumlah,satuanj,kunci from ".$dbname.".bgt_budget where 
	...
	break;
        ...
        break;
        case'loadDtLain':
          $sLoad="select aruskas,kunci,tahunbudget,kodeorg, tipebudget, kodebudget, kegiatan, noakun, volume, satuanv, rupiah,rotasi,jumlah, satuanj from ".$dbname.".bgt_budget where 
      ...
      case'loadDataTool':
        ...
        while($res=$qLoad->fetch())
        {
            ...
            $tab.="<td  align='center'>".$res['satuanv']."</td>";
            $tab.="<td align='right'>".number_format($res['rupiah'],2)."</td>";
            $tab.="<td align='center'>".$res['kodebarang']." - ".$optNmBrg[$res['kodebarang']]."</td>";
            $tab.="<td  align='right'>".$res['jumlah']."</td>";
            $tab.="<td  align='center'>".$res['satuanj']."</td>";           
	...
	$tab.="<table cellpadding=1 cellspacing=1 border=0 class=sortable width=100%>
        ...
        if ($page == '0') {
            ...
            $tab.="<button class=mybutton onclick=loadDetailTotal(" . ($page - 1) . ");>Prev</button>";
        }
