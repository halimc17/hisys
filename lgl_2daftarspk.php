...
<script language=javascript src='js/lgl_2daftarspk.js?v=<?php echo time(); ?>'></script>
<script language="javascript" src="js/zSelect2.js?ver=1"></script>

<?php
	OPEN_BOX('','<span class=judul><b>'.getMenu('lgl_2daftarspk').'</b><br><br></span>');
	...
	<table>
		...
		<tr>
			...
			<td>:</td>
			<td><input id=notransaksi onkeypress='enterkey(event,loaddata)' class=myinputtext onkeydown=\"upperCaseF(this)\" style=\"width:178px;\"></td>
