...
OPEN_BOX('','<span class=judul>'.getMenu('log_penggunaansolarv2').'</span><br>');
?>
<script>
...
<script language=javascript src='js/log_penggunaansolarv2.js?v=<?php echo time(); ?>'></script>
<?
        ...
        <legend>Form</legend>
            <table border=0 cellpadding=1 cellspacing=1>
				...
				<tr>
                    <td colspan=2></td>
                    <td colspan=4>
                    <button onclick=\"zPreview('log_slave_penggunaansolarv2','" . $arr1 . "','printContainer');showheader();\" class=mybutton name=preview id=preview>" . $_SESSION['lang']['preview'] . "</button>
                    <button onclick=zExcel(event,'log_slave_penggunaansolarv2.php','" . $arr1 . "') class=mybutton name=preview id=preview>" . $_SESSION['lang']['excel'] . "</button>
                    </td>
                </tr>
            </table>
</fieldset>";
