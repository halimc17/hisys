...
<script language=javascript src='js/pabrik_produksiTahunan.js?v=<?php echo time(); ?>'></script>
...
$optper="";
$sPeriode="select distinct substring(tanggal,1,4) as periode from ".$dbname.".pabrik_produksi order by tanggal desc ";
...
OPEN_BOX('', '<span class=judul>' . getMenu('pabrik_2produksiTahunan') . '</span><br>');
