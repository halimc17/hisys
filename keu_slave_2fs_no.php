...
$pt = checkPostGet('pt6', '');
$kdorg = checkPostGet('kdorg6', '');
$tahun  = checkPostGet('tahun60', '');
$tahun1 = checkPostGet('tahun61', '');
$tahun2 = checkPostGet('tahun62', '');
$tahun3 = checkPostGet('tahun63', '');
$bulan  = checkPostGet('bulan60', '');
$bulan1 = checkPostGet('bulan61', '');
$bulan2 = checkPostGet('bulan62', '');
$bulan3 = checkPostGet('bulan63', '');


$tahunsd1 = checkPostGet('tahunsd61', '');
$tahunsd2 = checkPostGet('tahunsd62', '');
$tahunsd3 = checkPostGet('tahunsd63', '');
$bulansd1 = checkPostGet('bulansd61', '');
$bulansd2 = checkPostGet('bulansd62', '');
$bulansd3 = checkPostGet('bulansd63', '');

$tahun4 = checkPostGet('tahun64', '');
$tahunsd4 = checkPostGet('tahunsd64', '');
$bulan4 = checkPostGet('bulan64', '');
$bulansd4 = checkPostGet('bulansd64', '');

$tahunytd = checkPostGet('tahunytd6', '');
$tahunsdytd = checkPostGet('tahunsdytd6', '');
$bulanytd = checkPostGet('bulanytd6', '');
$bulansdytd = checkPostGet('bulansdytd6', '');
...
if(!empty($dataArray))foreach($dataArray as $data){
    if($data['tipe']=='Header'){
		...
		$stream.="
		<tr class=rowcontent style=cursor:pointer title='Click untuk melihat detail' onclick=\"viewdetail('".$data['nourut']."','".$pt."','".$kdorg."','".$periode1."','".$periode2."','".$periode3."','".$periodesd1."','".$periodesd2."','".$periodesd3."','html','no','".$periode4."','".$periodesd4."','".$periodeytd."','".$periodesdytd."');\">
			<td colspan=".strlen($data['nourut']).">&nbsp;</td>
...
######PREVIEW
	...
	case'pdf':
		...
		$dompdf->render();
		$dompdf->stream("NO",array("Attachment"=>0));
	break;
######EXCEL	
    case 'excel':
        $tglSkrg = date("Ymd");
