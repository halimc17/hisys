...
OPEN_BOX('', '<span class=judul>' . getMenu('lm_2kemitraan') . '</span><br>');
?>
<script language="javascript" src="js/zSelect2.js?ver=1"></script>
<script language=javascript src=js/zTools.js></script>
<script language=javascript src='js/zReport.js'></script>
<script language=javascript src='js/option.js?v=<?php echo time(); ?>'></script>
<script language=javascript src='js/lm_2kemitraan.js?v=<?php echo time(); ?>'></script>
        ...
        <legend>Form</legend>
            <table border=0 cellpadding=1 cellspacing=1>
                <tr>
                    ...
                    <td>:</td>
                    <td><select class=select2 id=pt multiple onchange=getUnitThnTnm(this,'kdorg,tt','divisi','" . $_SESSION['lang']['all'] . "')  style=\"width:164px;\">" . $optPT . "</select></td>
                ...
                <tr>
                    ...
                    <td>:</td>
                    <td><select id=prd1 style=\"width:164px;\">" . $optper . "</select></td>
                    <td colspan=3></td>
                </tr>";
?>
<?php
echo "          <tr>
                    <td colspan=16 align=center>
                        <hr>
                        <button onclick=zPreview('lm_slave_2kemitraan','" . $arr1 . "','printContainer');showheader();cekpt(); class=mybutton name=preview id=preview>" . $_SESSION['lang']['preview'] . "</button>
                        <button onclick=zExcel(event,'lm_slave_2kemitraan.php','" . $arr1 . "');cekpt(); class=mybutton name=preview id=preview>" . $_SESSION['lang']['excel'] . "</button>
                    </td>
                </tr>
            </table>
</fieldset>";
