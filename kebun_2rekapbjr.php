...
<script language=javascript src='js/kebun_2rekapbjr.js?v=<?php echo time(); ?>'></script>

<?php

OPEN_BOX('','<span class=judul>'.getMenu('kebun_2rekapbjr').'</span><br>');
...
<fieldset style=float:left>
	<table cellspacing=1 cellpadding=2>
		<tr>
			...
			<td>:</td>
			<td>
				<select class=select2 id='unit' style='min-width:150px' >".$optUnit."</select>
			</td>
		</tr>
		<tr>
