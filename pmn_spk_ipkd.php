...
<script language=javascript1.2 src='js/pmn_spk_ipkd.js?v=<?php echo time(); ?>'></script>
...
echo "<table border=0 cellpadding=1 cellspacing=1>
				...
				<tr>
					...
					<td>
						...
						<img id='transportir' onclick=z.elSearch('transportir',event) class='resicon' src='images/skyblue/zoom.png' style='position:relative;top:3px;'></td>
					</td>
					
					<td>" . $_SESSION['lang']['transportir'] . " " . $_SESSION['lang']['darat'] . "</td>
					<td>:</td>		
					<td>
						<select id=transportirdarat style=\"width:154px;\">'" . $opttransportirdarat . "'</select>
						<img id='transportirdarat' onclick=z.elSearch('transportirdarat',event) class='resicon' src='images/skyblue/zoom.png' style='position:relative;top:3px;left:3px;'></td>
					</td>
				...
				<tr>
					...
					<td>
						...
						<img id='pelabuhanmuat' onclick=z.elSearch('pelabuhanmuat',event) class='resicon' src='images/skyblue/zoom.png' style='position:relative;top:3px;'></td>
					</td>
				...
				<tr>
					...
					<td>
						...
						<img id='pelabuhantujuan' onclick=z.elSearch('pelabuhantujuan',event) class='resicon' src='images/skyblue/zoom.png' style='position:relative;top:3px;'></td>
					</td>
					
					<td>" . $_SESSION['lang']['tanggalmuat'] . "</td>
					<td>:</td>		
					<td>
						<input type=text class=myinputtext  style=\"width:61px;\" value='" . tanggalnormal($tanggalmuat1) . "' readonly id=tanggalmuat1 size=12 onmousemove=setCalendar(this.id) maxlength=10 onkeypress=\"return false;\">
						s/d
						<input type=text class=myinputtext  style=\"width:61px;\" value='" . tanggalnormal($tanggalmuat2) . "'  readonly id=tanggalmuat2 size=12 onmousemove=setCalendar(this.id) maxlength=10 onkeypress=\"return false;\">
					</td>
				...
				<tr>
					...
					<td>
						...
						<img id='namakapal' onclick=z.elSearch('namakapal',event) class='resicon' src='images/skyblue/zoom.png' style='position:relative;top:3px;'></td>
					</td>
					...
					<td>
						...
						<img id='namaponton' onclick=z.elSearch('namaponton',event) class='resicon' src='images/skyblue/zoom.png' style='position:relative;top:3px;'></td>
					</td>
