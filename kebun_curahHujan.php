...
OPEN_BOX('','<span class=judul>'.getMenu('kebun_curahHujan').'</span>');
?>

<link rel=stylesheet type=text/css href="style/zTable.css">
<script language="javascript" src="js/zMaster.js"></script>
<script language="javascript" src="js/kebun_curahHujan.js?v=<?php echo time(); ?>"></script>
        ...
        <table cellspacing="1" cellpadding=5 border="0" class="sortable">
            <thead>
                <tr class="rowheader">
                    ...
                    <th align='center'><?php echo $_SESSION['lang']['pagi']; ?></th>
                    <th align='center'><?php echo $_SESSION['lang']['jam']." ".$_SESSION['lang']['pagi']; ?></th>
                    <th align='center'><?php echo $_SESSION['lang']['siang']; ?></th>
                    <th align='center'><?php echo $_SESSION['lang']['jam']." ".$_SESSION['lang']['siang']; ?></th>
                    <th align='center'><?php echo $_SESSION['lang']['malam']; ?></th>	
                    <th align='center' style='display:none'><?php echo $_SESSION['lang']['malam']; ?></th>	 
                    <th align='center'><?php echo $_SESSION['lang']['jam']." ".$_SESSION['lang']['malam']; ?></th> 
...
while ($bar = $res->fetch()) {
	...
	<td align=right id='mlm_" . $no . "' style='display:none'>" . $bar->malam . "</td>
        ...
        <table cellspacing="1" border="0">
            <tr>
                ...
                <td>
					...
					<td><?php echo $_SESSION['lang']['pagi'] ?>  (mm) (06.00 - 12.00)</td>
                <td>:</td>
                <td>
                ...
                <td><?php echo $_SESSION['lang']['jam'].' '.$_SESSION['lang']['pagi']?></td>
                <td>:</td>
                <td>
                    <select class=select2 style=width:50px id='jampagi'><?php echo $optjam ?></select> : <select style=width:50px class=select2 id='mntpagi'><?php echo $optmenit ?></select>
                </td>
            ...
            <tr>
				...
				<td><?php echo $_SESSION['lang']['siang'] ?>  (mm) (12.00 - 18.00)</td>
                <td>:</td>
                <td>
                    <input type="text" class="myinputtextnumber" id="sg"  onkeypress="return angka_doang(event)" size="10" maxlength="10" value="0" style="width:50px;" />
                </td>

                <td><?php echo $_SESSION['lang']['jam'] ." ".$_SESSION['lang']['siang']?></td>
                <td>:</td>
                <td>
                    <select class=select2 style=width:50px id='jamsiang'><?php echo $optjam ?></select> : <select style=width:50px class=select2 id='mntsiang'><?php echo $optmenit ?></select>
                </td>
            ...
            <tr>
                ...
                <td><?php echo $_SESSION['lang']['malam'] ?> (mm) (18.00 - 06.00)</td>
                <td>:</td>
                <td>
                    <input type="text" class="myinputtextnumber" id="sr"  onkeypress="return angka_doang(event)" size="10" maxlength="10" value="0" style="width:50px;" />
                </td>
                ...
                <td style='display:none'>
                    <input type="text" class="myinputtextnumber" id="ml"  onkeypress="return angka_doang(event)" size="10" maxlength="10" value="0" style="width:50px;" />
                </td>

                <td><?php echo $_SESSION['lang']['jam'] ." ".$_SESSION['lang']['malam']?></td>
                <td>:</td>
                <td>
                    <select class=select2 style=width:50px id='jamsore'><?php echo $optjam ?></select> : <select style=width:50px class=select2 id='mntsore'><?php echo $optmenit ?></select>
                </td>
