...
switch($proses)
{
	...
	case'update1':
		...
		$sInsert="update ".$dbname.".kebun_restan set  jjgpanen='".$jjgPanen."', jjgkirim='".$jjgKrm."', umurrestan='".$umrRestan."',catatan='".$cttn."' where kodeorg='".$kdBlokRestan."' and  tanggal='".$tglRestan."'";
		try{
			$owlPDO->exec($sInsert); 
		}catch (PDOException $e){
			echo "DB Error : ".$sInsert."\n".$e->getMessage();
