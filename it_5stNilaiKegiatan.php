...
echo"<fieldset style='width:500px;'><table>
	 ...
	 <tr><td>".$_SESSION['lang']['satuan']."</td><td><input type=text id=satuan size=8  maxlength=4 onkeypress=\"return tanpa_kutip_dan_sepasi(event);\" class=myinputtext></td></tr>
             <tr><td>Sangat Baik</td><td><input type=text id=nilsngtbaik size=9  maxlength=4 onkeypress=\"return angka_doang(event);\" class=myinputtextnumber value=0 ></td></tr>
                 <tr><td>Baik</td><td><input type=text id=nilbaik size=9  maxlength=4 onkeypress=\"return angka_doang(event);\" class=myinputtextnumber value=0 ></td></tr>
                     <tr><td>Cukup</td><td><input type=text id=nilckp size=9  maxlength=4 onkeypress=\"return angka_doang(event);\" class=myinputtextnumber value=0 ></td></tr>
                         <tr><td>Kurang</td><td><input type=text id=nilkrg size=9  maxlength=12 onkeypress=\"return angka_doang(event);\" class=myinputtextnumber value=0 ></td></tr>
     </table>
