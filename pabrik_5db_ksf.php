...
echo open_body();
?>
<script language=javascript1.2 src=js/pabrik_5db_ksf.js></script>
<?
include('master_mainMenu.php');

OPEN_BOX('','<span class=judul>'.getMenu('pabrik_5db_ksf').'</span>');
?>
...
<table border="0" cellspacing="0">
  <tr>
    ...
    <td colspan=4><input type="text" id="kode" size="3" maxlength="2"  class="myinputtext" style="width:100px"></td>
  </tr>
  <tr>
    <td><?echo $_SESSION['lang']['nama'];?></td><td> : </td>
    <td colspan=4><input type="text" id="nama" size="40" class="myinputtext" style="width:100px"></td>
  </tr>
