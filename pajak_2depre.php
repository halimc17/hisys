...
echo open_body();
?>
<script language=javascript1.2 src=js/pajak_2depre.js></script>
<?
include('master_mainMenu.php');
OPEN_BOX('','<span class=judul>'.getMenu('pajak_2depre').'</span><br>');
...
$str="select distinct left(periode,4) as periode from ".$dbname.".setup_periodeakuntansi where char_length(kodeorg)='4' order by periode desc";
