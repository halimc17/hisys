...
<script language=javascript src='js/pmn_kontrakjual_versi2.js?v=<?php echo time(); ?>'></script>
...
$str="select * from ".$dbname.".log_5masterbarang where kelompokbarang='400' and inisial!=''";
$res=fetchdata($str);
foreach($res as $bar){
...
echo"<div>";//buka div
OPEN_BOX('','<span class=judul>'.getMenu('pmn_kontrakjual_versi2').'</span>');
echo"<table>
     <tr valign=middle>
...
/*
	<td>".$_SESSION['lang']['kodeunit']."</td>
				<td> : </td>
				<td><select  name=millcode id=millcode style='width:204px'>".$optmillcode."</select></td>
*/
echo "<fieldset>
          ...
          <fieldset>
			...
			<tr>
				<td hidden> <font style='font-size:10px;color:red;'> * </font>".$_SESSION['lang']['NoKontrak']."</td>
				<td hidden> : </td>
				<td hidden>
					<input type=text class=myinputtext id=noKtrk name=noKtrk maxlength=50 onkeypress=\"return tanpa_kutip(event)\" style=\"width:200px;\" disabled />
				</td>

				<td> <font style='font-size:10px;color:red;'> * </font>".$_SESSION['lang']['NoKontrak']."</td>
				<td> : </td>
				<td>
					<input type=text class=myinputtext id=noKtrk_M name=noKtrk_M maxlength=50 onkeypress=\"return tanpa_kutip(event)\" style=\"width:200px;\" />
				</td>
				
				<td hidden> <font style='font-size:10px;color:red;'> * </font>".$_SESSION['lang']['pabrik']."</td>
				<td hidden> : </td>
				<td hidden>
					<select style=\"width: 200px;\" name=millcode id=millcode >".$optmillcode."</select>
				</td>
				
				<td>  <font style='font-size:10px;color:red;'> * </font> ".$_SESSION['lang']['pt']."</td>
				<td> : </td>
				<td><select style=\"width:200px;\" id=kdPt name=kdPt onchange='getRek()'>".$optPt."</select></td>
				
				<td>  <font style='font-size:10px;color:red;'> * </font>".$_SESSION['lang']['tglKontrak']."</td>
				<td> : </td>
				...
				<td>  <font style='font-size:10px;color:red;'> * </font>Tanggal Berlaku Kontrak</td>
				<td> : </td>
				<td><input type=text style=\"width: 200px;\" id=tglberlaku size=10 maxlength=10 class=myinputtext onkeypress=\"return false;\" onmouseover=setCalendar(this)  readonly/></td>
            </tr>
			
            <tr>

				
				<td> <font style='font-size:10px;color:red;'> * </font>".$_SESSION['lang']['nmcust']."</td>
				<td> : </td>
				<td><select id=custId name=custId style=\"width:200px;\" onchange=\"getDataCust(0)\">".$optCust."</select></td>
             
				<td>  <font style='font-size:10px;color:red;'> * </font>Tempat Pembuatan Kontrak</td><td> : </td>
				<td><select style=\"width:200px;\" id=daerahctr name=daerahctr >".$optDaerahCtr."</select></td>
				
				<td>  <font style='font-size:10px;color:red;'> * </font> ".$_SESSION['lang']['komoditi']." </td><td> : </td>
				<td><select style=\"width:200px;\" id=kdBrg name=kdBrg >".$optkodebarang."</select></td>
				
				<td>  <font style='font-size:10px;color:red;'> * </font> ".$_SESSION['lang']['tipe']." ".$_SESSION['lang']['kontrak']."</td><td> : </td>
				<td><select style=\"width:200px;\" id=tpkontrak name=tpkontrak >".$opttipe."</select></td>
			...
			<tr> 	 
				...
				<td hidden>Berikat</td>
				<td hidden> : </td>
				<td hidden><input type=checkbox id=berikat >".$_SESSION['lang']['yes']."/".$_SESSION['lang']['no']."</td>
				
				<td hidden>% PPN</td>
				<td hidden> : </td>
				<td hidden><input type=text class=myinputtextnumber  name=persenppn id=persenppn onkeypress=\"return angka_doang(event);\"  onkeyup=\"z.numberFormat('persenppn',2);\"   style=\"width:200px;\" />
				</td>
		  ...
		  <br/>";
		  #= HIDE karena tidak di perlukan detail untuk kontrak TBS
          echo"<fieldset hidden>
			<legend>".$_SESSION['lang']['orderInfor']."</legend>
				...
				<tbody>
					<td><select id=kdBrg2 name=kdBrg2 onchange=\"getSatuan(0,0,0)\" style=\"width:150px;\"><option value=''>".$_SESSION['lang']['pilihdata']."</option></select></td>
					...
					<td><select id=kurs name=kurs style=\"width:60px;\">".$optKurs."</select></td>
        ...
        <td>&nbsp;<td valign=top>            
				<table cellspacing=1 border=0 style=display:none>
					<thead>
                        ...
                        <tr><td valign=top>".$_SESSION['lang']['toleransi']."</td><td valign=top>:</td><td colspan=5><textarea name=tlransi id=tlransi style=\"width:210px;\" onkeypress=\"return tanpa_kutip(event);\" rows='2' cols='20'></textarea></td></tr>
					</tbody>
				</table>
		...
		<td>&nbsp;<td valign=top>	
				<table cellspacing=1 border=0>
					...
					<tbody>
						<tr>
							<td>".$_SESSION['lang']['tempatpenyerahan']."</td><td>:</td><td colspan=5><select name=tmbngn id=tmbngn style=\"width: 230px;\" >".$optFranco."</select></td>
						</tr>
                        <tr>
						...
						<tr>
							...
							<td>:</td>
							<td>
								<select style=\"width: 120px;\" name=tppenjualan id=tppenjualan >".$opttppembayaran."</select>
							</td>
						</tr>
						<tr>
