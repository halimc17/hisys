...
$query=$owlPDO->query($qwery) or die(print " Gagal: ".PDOException::getMessage());
...
while($res=$query->fetch())
{
    ...
    if($res['statusblok']=='TM'){
        $luastm[$res['kodeorg']][$res['tahuntanam']]=isset($luastm[$res['kodeorg']][$res['tahuntanam']])?$luastm[$res['kodeorg']][$res['tahuntanam']]:'';
        $pokoktm[$res['kodeorg']][$res['tahuntanam']]=isset($pokoktm[$res['kodeorg']][$res['tahuntanam']])?$pokoktm[$res['kodeorg']][$res['tahuntanam']]:'';
    ...
    $luascada[$res['kodeorg']]=isset($luascada[$res['kodeorg']])?$luascada[$res['kodeorg']]:'';
    $luasokup[$res['kodeorg']]=isset($luasokup[$res['kodeorg']])?$luasokup[$res['kodeorg']]:'';
    $luasrend[$res['kodeorg']]=isset($luasrend[$res['kodeorg']])?$luasrend[$res['kodeorg']]:'';
    $luassung[$res['kodeorg']]=isset($luassung[$res['kodeorg']])?$luassung[$res['kodeorg']]:'';
    $luasruma[$res['kodeorg']]=isset($luasruma[$res['kodeorg']])?$luasruma[$res['kodeorg']]:'';
    
    $luaskant[$res['kodeorg']]=isset($luaskant[$res['kodeorg']])?$luaskant[$res['kodeorg']]:'';
    $luaspabr[$res['kodeorg']]=isset($luaspabr[$res['kodeorg']])?$luaspabr[$res['kodeorg']]:'';
    $luasjala[$res['kodeorg']]=isset($luasjala[$res['kodeorg']])?$luasjala[$res['kodeorg']]:'';
    $luaskola[$res['kodeorg']]=isset($luaskola[$res['kodeorg']])?$luaskola[$res['kodeorg']]:'';
    $luasumum[$res['kodeorg']]=isset($luasumum[$res['kodeorg']])?$luasumum[$res['kodeorg']]:'';
...
$tab.="</tr>";
$totalha_tm_tt=$totalha_tm_af=$totalha_af=$totalpk_tm_tt=$totalpk_tm_af=$totalpk_af=array();
if(!empty($tttm))foreach($tttm as $tahuntanam){
    $tab.="<tr class=rowcontent>";
        $tab.="<td align=center>".$tahuntanam."</td>";        
        if(!empty($af))foreach($af as $afdeling){
            $luastm[$afdeling][$tahuntanam]=isset($luastm[$afdeling][$tahuntanam])?$luastm[$afdeling][$tahuntanam]:'0';
            $pokoktm[$afdeling][$tahuntanam]=isset($pokoktm[$afdeling][$tahuntanam])?$pokoktm[$afdeling][$tahuntanam]:'0';
            ...
            $totalha_tm_tt[$tahuntanam]=isset($totalha_tm_tt[$tahuntanam])?$totalha_tm_tt[$tahuntanam]:'';
            $totalha_tm_af[$afdeling]=isset($totalha_tm_af[$afdeling])?$totalha_tm_af[$afdeling]:'';
            $totalha_af[$afdeling]=isset($totalha_af[$afdeling])?$totalha_af[$afdeling]:'';
            $totalpk_tm_tt[$tahuntanam]=isset($totalpk_tm_tt[$tahuntanam])?$totalpk_tm_tt[$tahuntanam]:'';
            $totalpk_tm_af[$afdeling]=isset($totalpk_tm_af[$afdeling])?$totalpk_tm_af[$afdeling]:'';
            $totalpk_af[$afdeling]=isset($totalpk_af[$afdeling])?$totalpk_af[$afdeling]:'';
...
$tab.="<tr class=rowcontent>";
$tab.="<td align=center>Subtotal</td>";   
$totalha_tbm=$totalpk_tbm=0;
if(!empty($af))foreach($af as $afdeling){
    $totalha_tbm_af[$afdeling]=isset($totalha_tbm_af[$afdeling])?$totalha_tbm_af[$afdeling]:'0';
    $totalpk_tbm_af[$afdeling]=isset($totalpk_tbm_af[$afdeling])?$totalpk_tbm_af[$afdeling]:'0';
...
$tab.="<tr class=rowcontent>";
    ...
    $totalha_tb=$totalpk_tb=0;
    
    if(!empty($af))foreach($af as $afdeling){
        $pokoktb[$afdeling]=isset($pokoktb[$afdeling])?$pokoktb[$afdeling]:'0';
...
$tab.="<tr class=rowcontent>";
    ...
    $totalha_bt=$totalpk_bt=0;
    
    if(!empty($af))foreach($af as $afdeling){
        $luasbt[$afdeling]=isset($luasbt[$afdeling])?$luasbt[$afdeling]:'0';
        $pokokbt[$afdeling]=isset($pokokbt[$afdeling])?$pokokbt[$afdeling]:'0';
...
$tab.="<tr class=rowcontent>";
    ...
    if(!empty($af))foreach($af as $afdeling){
        ...
        $totalha_pr[$afdeling]=isset($totalha_pr[$afdeling])?$totalha_pr[$afdeling]:'';
...
$tab.="<tr class=rowcontent>";
    ...
    $totalha_okup=0;$totalha_ok=array();
    if(!empty($af))foreach($af as $afdeling){
        $totalha_ok[$afdeling]=isset($totalha_ok[$afdeling])?$totalha_ok[$afdeling]:'';
