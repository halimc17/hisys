...
<?
OPEN_BOX('','<span class=judul>'.getMenu('kebun_2spbvspenerimaan').'</span><br>');
?>
...
<tr><td colspan="2"><td colspan="2" align=left ><button onclick="zPreview('kebun_slave_2spbvspenerimaan','<?php echo $arr?>','printContainer')" class="mybutton" name="preview" id="preview">Preview</button>
