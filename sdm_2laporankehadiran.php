...
<script language=javascript src='js/sdm_2laporankehadiran.js?v=<?php echo time(); ?>'></script>

<?php

OPEN_BOX('','<span class=judul>'.getMenu('sdm_2laporankehadiran').'</span><br>');
...
<fieldset style=float:left>
	<table cellspacing=1 cellpadding=2>
		<tr>
			...
			<td>:</td>
			<td>
				<select class=select2 id='unit' style='width:246px' onchange=\"getsubunit()\">".$optUnit."</select>
			</td>
		</tr>
		<tr>
			...
			<td>:</td>
			<td>
				<select class=select2 id='subunit' style='width:246px'>".$optSubUnit."</select>
			</td>
		</tr>
		<tr>
			...
			<td>:</td>
			<td>
				<select class=select2 id='tipekaryawan' style='width:246px'>".$optTipe."</select>
			</td>
		</tr>
		<tr>
...
echo"<fieldset style=width:450px;>
	...
	<div style=height:120px;float:left;overflow:auto>

	<table  cellpadding=5 cellspacing=1 border=0 style='font-weight:bold'>
		<tr>
			<td style='width:10px;background:yellow'>&nbsp;</td>
			<td style='background-color:#d1e3fa !important; color:black;border:unset !important'>:</td>
			<td style='background-color:#d1e3fa !important; color:black;border:unset !important'>Kegiatan dan jam finger kosong</td>
		</tr>
		<tr>
			<td style='width:10px;background:red'>&nbsp;</td>
			<td style='background-color:#d1e3fa !important; color:black;border:unset !important'>:</td>
			<td style='background-color:#d1e3fa !important; color:black;border:unset !important'>Jam finger ada , Kegiatan tidak ada</td>
		</tr>
	</table>
	<hr>
